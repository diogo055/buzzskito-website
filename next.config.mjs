...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── Old reversed-slug format redirects ──────────────────────────────────
      { source: '/mosquito-control-mississauga', destination: '/mississauga-mosquito-control', permanent: true },
      { source: '/mosquito-control-toronto',     destination: '/toronto-mosquito-control',     permanent: true },
      { source: '/mosquito-control-brampton',    destination: '/brampton-mosquito-control',    permanent: true },
      { source: '/mosquito-control-oakville',    destination: '/oakville-mosquito-control',    permanent: true },
      { source: '/tick-control-mississauga',     destination: '/mississauga-tick-spray',       permanent: true },

      // ── Remaining neighbourhood tick spray redirects ────────────────────────
      { source: '/ajax-tick-spray',           destination: '/toronto-tick-spray',     permanent: true },
      { source: '/ancaster-tick-spray',       destination: '/hamilton-tick-spray',    permanent: true },
      { source: '/baby-point-tick-spray',     destination: '/toronto-tick-spray',     permanent: true },
      { source: '/bolton-tick-spray',         destination: '/vaughan-tick-spray',     permanent: true },
      { source: '/bram-west-tick-spray',      destination: '/brampton-tick-spray',    permanent: true },
      { source: '/bramalea-tick-spray',       destination: '/brampton-tick-spray',    permanent: true },
      { source: '/bridle-path-tick-spray',    destination: '/toronto-tick-spray',     permanent: true },
      { source: '/caledon-east-tick-spray',   destination: '/caledon-tick-spray',     permanent: true },
      { source: '/casa-loma-tick-spray',      destination: '/toronto-tick-spray',     permanent: true },
      { source: '/clearview-tick-spray',      destination: '/oakville-tick-spray',    permanent: true },
      { source: '/college-park-tick-spray',   destination: '/toronto-tick-spray',     permanent: true },
      { source: '/credit-valley-tick-spray',  destination: '/mississauga-tick-spray', permanent: true },
      { source: '/danforth-tick-spray',       destination: '/toronto-tick-spray',     permanent: true },
      { source: '/davisville-tick-spray',     destination: '/toronto-tick-spray',     permanent: true },
      { source: '/dundas-tick-spray',         destination: '/hamilton-tick-spray',    permanent: true },
      { source: '/eastlake-tick-spray',       destination: '/oakville-tick-spray',    permanent: true },
      { source: '/falgarwood-tick-spray',     destination: '/oakville-tick-spray',    permanent: true },
      { source: '/flamborough-tick-spray',    destination: '/hamilton-tick-spray',    permanent: true },
      { source: '/high-park-tick-spray',      destination: '/toronto-tick-spray',     permanent: true },
      { source: '/joshua-creek-tick-spray',   destination: '/oakville-tick-spray',    permanent: true },
      { source: '/lawrence-park-tick-spray',  destination: '/toronto-tick-spray',     permanent: true },
      { source: '/leslieville-tick-spray',    destination: '/toronto-tick-spray',     permanent: true },
      { source: '/millcroft-tick-spray',      destination: '/burlington-tick-spray',  permanent: true },
      { source: '/moore-park-tick-spray',     destination: '/toronto-tick-spray',     permanent: true },
      { source: '/mount-pleasant-tick-spray', destination: '/brampton-tick-spray',    permanent: true },
      { source: '/orchard-tick-spray',        destination: '/burlington-tick-spray',  permanent: true },
      { source: '/palmer-tick-spray',         destination: '/burlington-tick-spray',  permanent: true },
      { source: '/pickering-tick-spray',      destination: '/toronto-tick-spray',     permanent: true },
      { source: '/river-oaks-tick-spray',     destination: '/oakville-tick-spray',    permanent: true },
      { source: '/riverdale-tick-spray',      destination: '/toronto-tick-spray',     permanent: true },
      { source: '/sandalwood-tick-spray',     destination: '/brampton-tick-spray',    permanent: true },
      { source: '/snelgrove-tick-spray',      destination: '/brampton-tick-spray',    permanent: true },
      { source: '/stoney-creek-tick-spray',   destination: '/hamilton-tick-spray',    permanent: true },
      { source: '/summerhill-tick-spray',     destination: '/toronto-tick-spray',     permanent: true },
      { source: '/sunnybrook-tick-spray',     destination: '/toronto-tick-spray',     permanent: true },
      { source: '/the-annex-tick-spray',      destination: '/toronto-tick-spray',     permanent: true },
      { source: '/the-kingsway-tick-spray',   destination: '/toronto-tick-spray',     permanent: true },
