...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'LawnSavers has 500+ Google reviews accumulated across all their services (lawn care + mosquito + irrigation). BuzzSkito has 150+ reviews — all for mosquito and tick control specifically, with a perfect 5.0 rating. LawnSavers wins on review volume; BuzzSkito wins on rating and specialty-specific feedback.',
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'BuzzSkito vs LawnSavers' },
        ]}
        title={<>BuzzSkito vs LawnSavers</>}
