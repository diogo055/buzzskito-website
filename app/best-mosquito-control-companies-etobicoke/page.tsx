...
const FAQS = [
  {
    ...
    answer: 'BuzzSkito is the GTA-based mosquito and tick specialist with the lowest entry price ($99 single treatment), 150+ perfect five-star Google reviews (zero negatives), and the BuzzSkito Bite-Free Guarantee — free re-treatment if pests return. Mosquito Man has higher review volume across all of Ontario but operates as a general pest control company covering 10+ pest types. LawnSavers serves Etobicoke as part of their broader lawn-care offering. The right choice depends on whether you prioritize specialist depth, lowest price, or bundled services.',
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Honest 2026 comparison of mosquito control providers serving Etobicoke — Mimico, Long Branch, The Kingsway, Humber Valley, Richview, Islington Village, Alderwood. Pricing, reviews, contracts.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Etobicoke homeowners have several professional mosquito control options. Here&rsquo;s an honest comparison based on publicly available pricing, Google reviews, and Etobicoke-specific service offerings as of July 2026.</p>
