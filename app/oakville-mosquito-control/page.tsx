...
const NEIGHBOURHOODS: { name: string; href?: string; postalCodes?: string }[] = [
  ...
  { name: 'Joshua Creek', href: '/joshua-creek-mosquito-control', postalCodes: 'L6H' },
  { name: 'West Oak Trails', href: '/west-oak-trails-mosquito-control', postalCodes: 'L6M' },
  { name: 'Clearview', href: '/clearview-mosquito-control', postalCodes: 'L6J' },
  { name: 'Palermo', postalCodes: 'L6H' },
  { name: 'River Oaks', href: '/river-oaks-mosquito-control', postalCodes: 'L6H, L6L' },
  ...
  { name: 'Eastlake', href: '/eastlake-mosquito-control', postalCodes: 'L6J, L6K' },
  { name: 'College Park', href: '/college-park-mosquito-control', postalCodes: 'L6H' },
  { name: 'Falgarwood', href: '/falgarwood-mosquito-control', postalCodes: 'L6H' },
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Yes. BuzzSkito is the no-contract option in Oakville — most other providers serving the area sell seasonal programs that ask you to commit before you have seen any results. With BuzzSkito you can book a single treatment from $99, judge the difference in your own yard, and only then decide on a partial or full-season program. There are no cancellation fees.",
  },
  {
...
export default function OakvilleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/oakville-mosquito-control', '2026-07-01')) }} />
      ...
      <section className="py-10 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-extrabold text-brand-900 mb-4">Oakville Mosquito Control Key Facts</h2>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>There are no contracts and no cancellation fees. Call <a href={BUSINESS.phoneHref} className="text-brand-700 font-semibold hover:underline">{BUSINESS.phone}</a> or use our <Link href="/free-yard-assessment" className="text-brand-700 hover:underline">contact form</Link> for a free quote specific to your address. See our <Link href="/mosquito-control-cost" className="text-brand-700 hover:underline">2026 mosquito control pricing guide</Link> for a full Ontario breakdown.</p>
      ...
      <section className="py-14 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="h2-display text-brand-900 mb-2 text-center">What Oakville Homeowners Say</h2>
