...
const FAQS = [
  {
    ...
    answer: 'BuzzSkito mosquito treatments in Oakville start from $99 per application. A 5-treatment seasonal program covering May through September starts from $399. Properties near Bronte Creek, the Sixteen Mile Creek, or the Lake Ontario waterfront typically need the full seasonal program for continuous protection. No contracts. Call (289) 216-5030 for a free Oakville quote.',
  },
  {
