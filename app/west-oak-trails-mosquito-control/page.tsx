  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>West Oak Trails' location along the Bronte Creek Provincial Park boundary creates sustained season-long mosquito pressure. BuzzSkito provides professional barrier spray so West Oak Trails families can enjoy their outdoor spaces.</>}
