...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control West Oak Trails | From $99',
  description:
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Park-adjacent or creek-proximate West Oak Trails properties typically benefit from Standard's two-week spacing. Properties further from the park boundary may be well-served by Basic. Call (289) 216-5030 for a free assessment at your specific address.",
  },
  {
...
export default function WestOakTrailsMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/west-oak-trails-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator treating West Oak Trails yards along the Bronte Creek Provincial Park boundary, where mosquito pressure lasts all season. Treatments applied according to label directions.</>}
