...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in College Park, Oakville. Barrier spray near Fourteen Mile Creek from $99. Licensed Ontario operator. Call (289) 216-5030.',
  canonical: '/college-park-mosquito-control',
})

const NEIGHBOURHOOD = 'College Park'
const CITY = 'Oakville'
const SLUG = '/college-park-mosquito-control'

const FAQS = [
  {
    question: 'Why does College Park in Oakville have mosquito problems?',
    answer: "College Park's mosquito pressure is driven primarily by Fourteen Mile Creek, which runs through the neighbourhood's eastern section. The creek corridor provides permanent water flow, standing pools, and dense riparian vegetation — ideal conditions for continuous mosquito breeding from spring through fall. The neighbourhood's proximity to the Sheridan College campus, with its landscaped grounds and retention ponds, adds additional breeding habitat.",
  },
  {
    question: 'How does Fourteen Mile Creek affect mosquitoes in College Park?',
    answer: "Fourteen Mile Creek flows south through College Park toward Lake Ontario. Its ravine corridor retains standing water in floodplain depressions and bankside pools after every rainfall, creating persistent mosquito breeding habitat. The dense tree canopy and undergrowth along the creek banks shelter adult mosquitoes during the day, and they disperse into College Park properties each evening. Properties within 500 metres of the creek see the highest activity.",
  },
  {
    question: 'How many treatments does a College Park home need?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). College Park properties near Fourteen Mile Creek typically benefit from Standard's two-week spacing; properties farther from the creek or the Sheridan College area may do well with Basic. Call (289) 216-5030 for a free property assessment.",
  },
  {
    question: 'When does mosquito season start in College Park?',
    answer: "Mosquito season in College Park typically begins in late April or early May, coinciding with consistent 10°C temperatures that activate larvae in Fourteen Mile Creek's standing water. Peak activity runs from late May through July. The season can extend into September or early October, particularly for properties near the creek corridor where water and vegetation sustain late-season breeding.",
  },
  {
    question: 'Does BuzzSkito serve all of College Park in Oakville?',
    answer: "Yes. We serve all College Park streets including properties adjacent to Fourteen Mile Creek and near the Sheridan College area. We also serve all surrounding Oakville neighbourhoods. Call (289) 216-5030 to confirm service at your specific College Park address.",
  },
]

export default function CollegeParkMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/college-park-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>College Park's Fourteen Mile Creek corridor and Sheridan College greenspace generate steady mosquito pressure. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>College Park's Creek-Side Mosquito Pressure</h2>
          <p>College Park is a family-oriented neighbourhood in southeast Oakville, anchored by the <strong>Fourteen Mile Creek</strong> corridor that runs through its eastern section. This creek provides a permanent source of mosquito breeding habitat — standing pools along its banks, saturated floodplain soils, and dense riparian vegetation that shelters adult mosquitoes through the day. After sunset, these populations disperse into adjacent College Park properties.</p>
          <p>The <strong>Sheridan College</strong> campus area adds another dimension to the neighbourhood's mosquito environment. The campus grounds include landscaped areas, stormwater management features, and naturalized vegetation that can accumulate standing water after rainfall. BuzzSkito's barrier spray addresses both pressure sources by creating a treated perimeter on your property — targeting leaf undersides, shrub interiors, and fence lines where arriving mosquitoes rest — and repeating the treatment on a schedule through the season.</p>

          <h2>Part of Our Oakville Mosquito Control Network</h2>
          <p>We serve all of College Park and surrounding Oakville. See our <Link href="/oakville-mosquito-control" className="text-brand-700 hover:underline">Oakville mosquito control</Link> page for city-wide coverage.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting College Park properties from Fourteen Mile Creek mosquitoes. No contracts." />
    </>
  )
}
