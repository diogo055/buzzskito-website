...
const FAQS = [
  ...
  },
  {
    ...
    answer: "College Park properties near Fourteen Mile Creek typically benefit from 4-5 barrier spray treatments spaced 21-28 days apart from May through September. Properties farther from the creek or the Sheridan College area may do well with 3-4 treatments. Call (289) 216-5030 for a free property assessment.",
  },
  {
...
export default function CollegeParkMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/college-park-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            College Park's Fourteen Mile Creek corridor and Sheridan College greenspace generate steady mosquito pressure. BuzzSkito's barrier spray gives College Park families up to 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/college-park-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
