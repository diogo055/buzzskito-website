...
const CITY = 'Caledon'
const SLUG = '/pest-control-caledon'

export const metadata: Metadata = buildMetadata({
  title: `Pest Control ${CITY} 2026 · Mosquito & Tick Specialists · From $99`,
  description: `Caledon pest control specialist focused on mosquitoes and ticks — the two pests that drive backyard misery in the GTA. Health Canada-approved barrier spray from $99, BuzzSkito Bite-Free Guarantee, no contracts. 129 five-star reviews. Call (289) 216-5030.`,
  canonical: SLUG,
})
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `General pest control companies offer 10–20 services — ants, mice, wasps, spiders, mosquitoes, ticks, etc. They train technicians on a wide catalogue and rotate between treatment types. A specialist (like BuzzSkito for mosquitoes and ticks) does one thing repeatedly. Our technicians know exactly where mosquitoes and ticks rest in ${CITY} backyards (Oak Ridges Moraine, Humber headwaters, rural ponds) and apply targeted barrier spray to those specific zones. The result: better kills, longer protection, fewer return visits.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Oak Ridges Moraine, Humber headwaters, rural ponds. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Oak Ridges Moraine, Humber headwaters, rural ponds benefit from an early-May start. Tick treatments should target late May (nymph emergence) and again in August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
...
export default function PestControlCaledonPage() {
  return (
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-gray-800 leading-relaxed">
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Oak Ridges Moraine, Humber headwaters, rural ponds). Single treatments start at <strong>$99</strong>, with seasonal programs available on quote. With <strong>129 five-star Google reviews</strong> (zero negative), no contracts, a 30-minute re-entry window, and the <strong>BuzzSkito Bite-Free Guarantee</strong>, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [`${CITY} pressure zones`, "Oak Ridges Moraine, Humber headwaters, rural ponds"],
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Oak Ridges Moraine, Humber headwaters, rural ponds:</p>
          <ul>
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — Health Canada-approved residual formula applied to all vegetation, shrub interiors, and resting sites. Up to 30-day protection. <Link href="/caledon-mosquito-control">See {CITY} mosquito control →</Link></li>
            <li><strong>Tick barrier spray</strong> — targeted treatment of the 1–3 metre lawn-to-woods transition zone where blacklegged ticks and dog ticks concentrate. <Link href="/caledon-tick-spray">See {CITY} tick control →</Link></li>
          ...
          <p>Most {CITY} backyards in the Oak Ridges Moraine, Humber headwaters, rural ponds exposure zone are squarely in the "call BuzzSkito" category. Mosquitoes and ticks are the dominant pests in residential GTA properties — everything else is rarer or seasonal.</p>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            <li>→ <Link href="/caledon-mosquito-control" className="text-brand-700 hover:underline font-semibold">{CITY} Mosquito Control</Link> — our specialty barrier spray for mosquitoes</li>
            <li>→ <Link href="/caledon-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — Lyme disease prevention and yard tick spray</li>
