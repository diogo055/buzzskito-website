...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Yes. Mosquito Man has 900+ Google reviews accumulated across multiple GTA cities and many years of operation, with an approximate 4.8-star average. BuzzSkito has 150+ Google reviews — all five stars (perfect 5.0 rating). Mosquito Man wins on review volume and tenure; BuzzSkito wins on rating consistency and zero-negative-review record.',
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'BuzzSkito vs Mosquito Man' },
        ]}
        title={<>BuzzSkito vs Mosquito Man</>}
        subtitle={<>An honest 2026 side-by-side comparison for GTA homeowners deciding between the two. Pricing, contracts, reviews, service areas — facts only.</>}
