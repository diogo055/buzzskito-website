...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Yes. Mosquito Man has 900+ Google reviews accumulated across multiple GTA cities and many years of operation, with an approximate 4.8-star average. BuzzSkito has 137 Google reviews — all five stars (perfect 5.0 rating). Mosquito Man wins on review volume and tenure; BuzzSkito wins on rating consistency and zero-negative-review record.',
  },
  {
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <ul>
            ...
            <li><strong>Perfect review record.</strong> 137 reviews, every one is 5 stars. No negative reviews.</li>
