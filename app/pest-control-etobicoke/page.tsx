...
const FAQS = [
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Humber River, Centennial Park, Lake Ontario shoreline. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Humber River, Centennial Park, Lake Ontario shoreline benefit from an early-May start. Tick treatments should target late May (nymph emergence) and again in August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito services every ${CITY} neighbourhood, including The Kingsway, Mimico, Long Branch, New Toronto, Islington, Humber Bay, Humber Valley, Edenbridge, Markland Wood, Eringate, Rexdale, and Richview. Waterfront and ravine-adjacent areas — The Kingsway, Mimico, Long Branch, and Humber Bay — carry the heaviest mosquito and tick pressure because of lakefront humidity and mature ravine habitat. Call (289) 216-5030 to confirm same-week service at your ${CITY} address.`,
  },
]

export default function PestControlEtobicokePage() {
  return (
    <>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Humber River, Centennial Park, Lake Ontario shoreline:</p>
          <ul>
