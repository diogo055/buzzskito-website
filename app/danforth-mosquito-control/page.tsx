...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Danforth | From $99',
  description:
    'Professional mosquito control on the Danforth, Toronto. Barrier spray near Taylor Creek Park from $99. Licensed operator. Call (289) 216-5030.',
  canonical: '/danforth-mosquito-control',
})

const NEIGHBOURHOOD = 'The Danforth'
const CITY = 'Toronto'
const SLUG = '/danforth-mosquito-control'

const FAQS = [
  {
    question: 'Why does the Danforth area have significant mosquito pressure?',
    answer: "The Danforth corridor is flanked by two of Toronto's most active mosquito breeding zones. Taylor Creek Park — a deep, forested ravine corridor — runs along the north side, with its permanent creek, dense understory, and naturalized vegetation generating substantial mosquito populations. The Don Valley lies to the west, adding a second major source. Monarch Park and smaller neighbourhood green spaces add local breeding habitat. This combination makes the Danforth one of east Toronto's most consistently mosquito-affected areas.",
  },
  {
    question: 'How does Taylor Creek Park affect mosquitoes on the Danforth?',
    answer: "Taylor Creek Park is a 15-kilometre ravine corridor running east from the Don Valley through the heart of east Toronto. Its permanent creek flow, extensive wetland areas, and dense forest canopy create continuous mosquito breeding habitat that cannot be treated at the source. Properties on streets backing onto or near Taylor Creek — including those off Woodbine Avenue, Coxwell Avenue, and Greenwood Avenue — experience direct evening dispersal from this population throughout the season.",
  },
  {
    question: 'How many treatments do Danforth area homes need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties near Taylor Creek Park or the Don Valley typically benefit from Standard's two-week spacing; properties on Danforth Avenue itself or on interior streets further from the ravine edges may do well with Basic. Call (289) 216-5030 for a free assessment tailored to your specific property.",
  },
  {
    question: 'When does mosquito season start on the Danforth?',
    answer: "Mosquito season on the Danforth runs from late April through September. Taylor Creek Park's sheltered ravine microclimate retains warmth and moisture earlier in spring than exposed areas, enabling earlier emergence. Peak activity is from late May through July, with sustained pressure through August for properties adjacent to the ravine corridor and Monarch Park.",
  },
  {
    question: 'Does BuzzSkito serve all of the Danforth neighbourhood?',
    answer: "Yes. We serve all streets in the Danforth area from the Don Valley east to Victoria Park, including properties adjacent to Taylor Creek Park and Monarch Park. We also serve all surrounding Toronto neighbourhoods including East York and Riverdale. Call (289) 216-5030 to confirm service at your specific address.",
  },
]

export default function DanforthMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/danforth-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        title={<>Mosquito Control on {NEIGHBOURHOOD}, Toronto</>}
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. The Danforth's proximity to Taylor Creek Park, the Don Valley, and Monarch Park creates persistent mosquito pressure across east Toronto.</>}
      ...
      <TypicalPrices service="mosquito" city="Danforth" />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>The Danforth's Ravine-Driven Mosquito Problem</h2>
          <p>The Danforth corridor runs along the top of a ridge that drops into two of Toronto's most significant mosquito breeding zones. <strong>Taylor Creek Park</strong> — a 15-kilometre forested ravine — stretches along the north side with its permanent creek, dense understory, and protected wetland habitat generating substantial mosquito populations throughout the season. The <strong>Don Valley</strong> to the west adds a second major corridor.</p>
          <p><strong>Monarch Park</strong> and smaller neighbourhood green spaces provide local moisture zones and resting habitat for mosquitoes dispersing from the larger corridors. BuzzSkito's barrier spray creates a treated zone around your property — targeting all resting vegetation where these mosquitoes settle — knocking down what is resting there and leaving a residual behind. New mosquitoes keep arriving from the larger corridors, so the treatment is repeated through the season rather than done once.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of the Danforth and surrounding areas. See our <Link href="/toronto-mosquito-control" className="text-brand-700 hover:underline">Toronto mosquito control</Link> page for city-wide coverage, or our pages for <Link href="/east-york-mosquito-control" className="text-brand-700 hover:underline">East York</Link> and <Link href="/riverdale-mosquito-control" className="text-brand-700 hover:underline">Riverdale</Link>.</p>


          <CityPriceCard city="Danforth" service="mosquito" location="price_card_mid" />
      ...
      <div className="max-w-4xl mx-auto px-4">
        <CityPriceCard city="Danforth" service="mosquito" />
      </div>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote on ${NEIGHBOURHOOD}`} subtext="Protecting Danforth properties from Taylor Creek and Don Valley mosquitoes. No contracts." />
    </>
  )
}
