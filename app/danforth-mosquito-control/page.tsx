  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>The Danforth's proximity to Taylor Creek Park, the Don Valley, and Monarch Park creates persistent mosquito pressure across east Toronto. BuzzSkito's barrier spray gives Danforth families 30-day protection per treatment.</>}
