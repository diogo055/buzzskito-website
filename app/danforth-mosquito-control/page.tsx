...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Danforth | From $99 · 5★ Rated',
  description:
    'Professional mosquito control on the Danforth, Toronto. Barrier spray near Taylor Creek Park from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Properties near Taylor Creek Park or the Don Valley typically benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties on Danforth Avenue itself or on interior streets further from the ravine edges may do well with 3–4 treatments. Call (289) 216-5030 for a free assessment tailored to your specific property.",
  },
  {
...
export default function DanforthMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/danforth-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-5">Mosquito Control on {NEIGHBOURHOOD}, Toronto</h1>
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            The Danforth's proximity to Taylor Creek Park, the Don Valley, and Monarch Park creates persistent mosquito pressure across east Toronto. BuzzSkito's barrier spray gives Danforth families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/danforth-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
