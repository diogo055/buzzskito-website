...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Davisville | From $99 · 5★ Rated',
  description:
...
const NEIGHBOURHOOD = 'Davisville Village'
const CITY = 'Toronto'
const SLUG = '/davisville-mosquito-control'

const FAQS = [
  {
    question: 'Why does Davisville Village have notable mosquito activity?',
    answer: "Davisville Village is flanked by two major greenspace corridors that sustain mosquito populations. The Kay Gardner Beltline Trail — a linear park built on a former rail corridor — runs along the neighbourhood's northern edge, with dense vegetation, low-lying areas that collect rainwater, and shaded sections that retain humidity. Mount Pleasant Cemetery, one of Toronto's largest urban green spaces at over 80 hectares, borders Davisville to the east, with its mature tree canopy, ornamental ponds, and naturalized areas providing additional mosquito habitat.",
  },
  {
    question: 'How does the Kay Gardner Beltline Trail affect mosquitoes in my yard?',
    answer: "The Kay Gardner Beltline Trail occupies a depressed former rail corridor that collects and retains rainwater in low-lying sections. The trail's dense vegetation, mature tree canopy, and sheltered position create a humid microclimate that sustains mosquito populations from spring through fall. Properties on streets adjacent to the Beltline — particularly near the Yonge Street and Mount Pleasant Road sections — experience elevated evening mosquito pressure as populations disperse from the trail corridor into surrounding residential areas.",
  },
  {
  ...
  },
  {
    ...
    answer: "Davisville's mosquito season begins in early to mid May, slightly later than ravine-adjacent neighbourhoods due to the area's more urban character. However, the Kay Gardner Beltline Trail's depressed corridor warms quickly in spring, and Mount Pleasant Cemetery's ponds enable early breeding. Peak activity runs from June through July, with sustained pressure into September on properties near the Beltline or the cemetery.",
  },
  {
    question: 'Does BuzzSkito serve all of Davisville Village?',
    answer: "Yes. We serve all of Davisville Village including streets near the Kay Gardner Beltline Trail, Mount Pleasant Cemetery, and the Yonge and Eglinton area. We also serve adjacent neighbourhoods including Leaside, Lawrence Park, and Chaplin Estates. Call (289) 216-5030 to confirm service at your address.",
  },
]

export default function DavisvilleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/davisville-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Davisville Village borders the Kay Gardner Beltline Trail and Mount Pleasant Cemetery — two major greenspace corridors that sustain mosquito populations. BuzzSkito's barrier spray gives Davisville families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/davisville-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Davisville properties from Beltline and cemetery greenspace mosquitoes. No contracts." />
    </>
  )
}
