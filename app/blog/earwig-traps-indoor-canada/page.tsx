    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The second is the flat sticky trap, and its role is interception rather than attraction. Earwigs travel at floor level along the wall edge — the same baseboard highway as <Link href="/blog/best-silverfish-traps-canada">silverfish</Link> and <Link href="/blog/how-to-get-rid-of-centipedes-canada">house centipedes</Link> — and glue boards flush against that route, especially just inside every exterior door, catch the commuters. In the pattern reported across Ontario homes, the oil dish out-catches boards head-to-head for earwigs because it actively draws them, but boards cover ground the dish cannot: every threshold, the full basement perimeter, under both sinks. Run both, and read the boards as a census while you are at it — what else is stuck to them tells you what else is using your baseboards.</p>
          ...
          <ul>
            ...
            <li><Link href="/blog/best-silverfish-traps-canada">Silverfish Traps in Canada &mdash; The Other Baseboard Crawler</Link></li>
