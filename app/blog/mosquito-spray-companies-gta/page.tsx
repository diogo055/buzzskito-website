    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        ...
        <ul>
          ...
          <li>137 five-star Google reviews across the GTA</li>
      ...
      <CTASection heading="Get a Quote from a GTA Mosquito Spray Company You Can Trust" subtext="Health Canada–approved formula. Free re-spray guarantee. 137 five-star reviews." />
    </>
  )
}
