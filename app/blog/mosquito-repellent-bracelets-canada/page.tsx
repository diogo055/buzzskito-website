    ...
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl font-extrabold text-brand-900 mb-3">Do mosquito repellent bracelets actually work?</h2>
          <p className="speakable text-base text-gray-800 leading-relaxed">
            <strong>Barely — and only the skin right next to the band.</strong> Independent testing (New Mexico State University, 2017) found citronella and essential-oil bracelets provide little to no protection more than a few centimetres from the band, so your ankles, neck, and far arm still get bitten. They do not create a protective bubble the way a topical <Link href="/blog/mosquito-repellent-guide-ontario-2026" className="text-emerald-700 underline">DEET or icaridin spray</Link> does. Bracelets are worth it only as a low-risk supplement for kids, very short outdoor moments, or people who refuse sprays. For a real mosquito-free backyard, whole-yard <Link href="/mosquito-control" className="text-emerald-700 underline">barrier spray</Link> or a proper topical repellent wins every time.
          </p>
        </div>
      </section>
