    ...
    <>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="not-prose rounded-xl border-l-4 border-emerald-500 bg-emerald-50/60 p-5 mb-6">
            ...
            <ul className="mt-2 space-y-1.5 text-sm text-gray-800 list-disc pl-5">
              ...
              <li><Link href="/blog/advion-cockroach-gel-bait" className="text-emerald-700 underline font-semibold">Advion cockroach gel bait in Canada</Link> &mdash; the honest answer on the imported gel and the PCP-number check.</li>
            </ul>
          </div>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>We wrote a full standalone guide to the situation &mdash; what Advion is, why Americans swear by it, what the Pest Control Products Act actually says, and what the compliant Canadian alternatives are &mdash; in <Link href="/blog/advion-cockroach-gel-bait">Advion Cockroach Gel in Canada: the honest answer</Link>. The short version for this page: domestic-class enclosed bait stations are the registered, child-resistant, no-questions path for Canadian consumers, they run on the same carry-home-and-cascade mechanism, and a well-placed dozen of them ends most household infestations without importing anything.</p>
          ...
          <ul>
            <li><Link href="/blog/advion-cockroach-gel-bait">Advion Cockroach Gel in Canada — What the Rules Actually Say</Link></li>
            <li><Link href="/blog/how-to-get-rid-of-silverfish-canada">How to Get Rid of Silverfish in Canada</Link></li>
            <li><Link href="/blog/how-to-get-rid-of-fruit-flies">How to Get Rid of Fruit Flies in Canada</Link></li>
