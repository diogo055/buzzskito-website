    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The plan in one paragraph: identify your species, starve the kitchen (food sealed, dishes done, sink dried at night, garbage lidded), place enclosed bait stations tight along the wall edges and corners where roaches travel, lay glue-board monitors so you can measure instead of guess, and hold the line for two to three months while egg cases hatch into bait range. The rest of this guide unpacks each step &mdash; and covers the two situations where the plan changes: apartments, and the moment you should stop DIYing.</p>
