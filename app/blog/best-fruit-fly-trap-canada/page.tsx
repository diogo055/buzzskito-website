      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <ol>
            ...
            <li><strong>Trap and hunt at the same time.</strong> Trapping is interception; the breeding source is production. Our <Link href="/blog/how-to-get-rid-of-fruit-flies-canada">step-by-step fruit fly removal guide</Link> walks the drain, produce, and appliance sweep that ends the supply.</li>
          </ol>
