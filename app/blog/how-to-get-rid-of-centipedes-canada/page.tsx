    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The honest summary: chemicals are a symptom tool for a structural problem. If you use one anyway &mdash; and there are legitimate reasons to knock down a bad autumn migration while you get the sealing done &mdash; treat it as a stopgap running alongside the dehumidifier and the exclusion, not instead of them.</p>
