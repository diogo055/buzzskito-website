    ...
    <>
      ...
      <article className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>There is a second reason a sock line collects several marks at once. A mosquito brushed off mid-meal does not give up &mdash; she relands a short distance away and probes again until her abdomen is full, so a single insect can leave three or four welts through the same thin sock. We run the numbers in <Link href="/blog/how-many-times-can-a-mosquito-bite-you">how many bites one mosquito can actually leave in a night</Link>.</p>
          ...
          <aside aria-label="Professional mosquito control" className="not-prose my-8 rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-7 shadow-sm">
            ...
            <p className="text-sm text-gray-700 mb-4 leading-relaxed">If you are covering up just to sit in your own yard, the fix is fewer mosquitoes. BuzzSkito&rsquo;s professional barrier spray treats your whole yard from $99 — the residual sits on the leaves where mosquitoes rest and is renewed on your plan&rsquo;s schedule. Rain-back guarantee on every plan, and 150 five-star reviews across 19 GTA cities.</p>
      ...
      <CTASection heading="Dress smart — then let us clear the yard" subtext="Loose long sleeves help, but fewer mosquitoes helps more. Get a free quote for licensed barrier spray. From $99. Rain-back guarantee on every plan." variant="dark" />
    </>
  )
}
