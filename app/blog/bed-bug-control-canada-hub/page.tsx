...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Some are genuinely effective and some are marketing. The two methods that actually work without conventional insecticide sprays are heat and desiccant dusts: heat kills everything mechanically, and desiccants like diatomaceous earth and amorphous silica (CimeXa) kill by drying the insect out, a physical mechanism bugs cannot evolve around. Essential-oil sprays and "natural" botanical products are far weaker — a few can repel or kill on direct contact but leave no meaningful residual and never touch eggs. If you want to keep conventional sprays out of your home, build the plan on heat, steam, encasements, silica dust, and interceptors rather than on scented sprays. That gives you a protocol built mostly on physical methods that still hits every leg of the life cycle.',
  },
  {
            ...
            <table className="min-w-[560px] w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-navy-50 align-top">
                  ...
                  <td className="px-4 py-3"><BuyLink tag={AMZ_TAG} search="whole room bed bug heater" block>Check price on Amazon.ca →</BuyLink></td>
                </tr>
                <tr className="border-b border-navy-50 align-top">
                  ...
                  <td className="px-4 py-3"><BuyLink tag={AMZ_TAG} search="packtite bed bug heat chamber" block>Check price on Amazon.ca →</BuyLink></td>
                </tr>
                <tr className="border-b border-navy-50 align-top">
                ...
                <tr className="border-b border-navy-50 align-top">
                  ...
                  <td className="px-4 py-3"><BuyLink tag={AMZ_TAG} search="bed bug mattress encasement" block>Check price on Amazon.ca →</BuyLink></td>
                </tr>
                <tr className="border-b border-navy-50 align-top">
                ...
                <tr className="border-b border-navy-50 align-top">
                  ...
                  <td className="px-4 py-3"><BuyLink tag={AMZ_TAG} search="sealed hepa bagged canister vacuum" block>Check price on Amazon.ca →</BuyLink></td>
                </tr>
