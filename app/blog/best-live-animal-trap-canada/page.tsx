    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="not-prose text-sm text-gray-600 mb-1">If your case is the legal one — a groundhog on your own property, outside denning season — the trap we point to is the Havahart medium single-door cage:</p>
          <div className="not-prose mb-6">
            <BuyLink tag={AMZ_TAG} search="havahart live animal trap medium">Check price on Amazon.ca →</BuyLink>
          </div>
