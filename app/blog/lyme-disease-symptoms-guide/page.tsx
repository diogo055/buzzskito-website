    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>A third pattern confuses people more than either of those: a bite that neither grows nor disappears. For that in-between case, see <Link href="/blog/tick-bites-that-wont-heal-when-to-worry" className="text-brand-700 underline">tick bites that won&rsquo;t heal and when to worry</Link>.</p>
          ...
          <p>Exposure history is easier to give a doctor when you know what has actually been reported where you live. For the west GTA, <Link href="/blog/lyme-disease-cases-mississauga-oakville-2026" className="text-brand-700 underline">Lyme disease cases in Mississauga and Oakville</Link> lays out the published Peel and Halton counts behind that conversation.</p>
