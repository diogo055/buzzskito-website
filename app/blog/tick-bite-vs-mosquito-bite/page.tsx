  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14 prose-brand">
        ...
        <p>The mosquito half of the problem can also be attacked from the opposite direction. Barrier spray treats the shrubs and hedges where mosquitoes rest during the day; a CO&#8322; trap instead puts out carbon dioxide and heat to intercept host-seeking females on their way to you, which is a genuinely different mechanism rather than a second version of the same one — our <Link href="/blog/best-mosquito-trap-canada" className="text-brand-700 hover:underline">comparison of mosquito traps in Canada</Link> covers which designs actually reduce numbers in a suburban yard.</p>
