      ...
      <article className="py-10 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <ul>
            ...
            <li><strong>Treat the yard.</strong> A professional barrier spray targets the shaded vegetation and fence lines where adults rest between meals, so the resting population never rebuilds to the point where one persistent female becomes a nightly problem.</li>
          </ul>
