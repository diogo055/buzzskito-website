  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14 prose-brand">
        ...
        <p>One case sits between the two columns often enough to deserve its own guide: a bite that is not spreading but is not closing either. <Link href="/blog/tick-bites-that-wont-heal-when-to-worry" className="text-brand-700 underline">Tick bites that won&rsquo;t heal: when to worry</Link> works through the slow-healing timeline week by week.</p>
