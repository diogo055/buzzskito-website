    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>It also explains why a hot, sunny, open lawn at noon can feel bite-free even in peak season. The midday sun is too hot and dry for most mosquitoes, so they tuck into cool, shaded, humid resting spots — under your deck, inside dense shrubs, along the shady side of the fence — and wait for the evening. What makes a planting good resting habitat is its structure rather than its species, which is why a dense, untrimmed cedar hedge along a property line so often holds the daytime population — <Link href="/blog/do-cedar-trees-attract-mosquitoes">cedars do not chemically attract mosquitoes</Link>, they simply build the dark, damp, still interior mosquitoes wait out the day in.</p>
          ...
          <aside aria-label="Professional mosquito control" className="not-prose my-8 rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-7 shadow-sm">
            ...
            <p className="text-sm text-gray-700 mb-4 leading-relaxed">Whether they bite at dusk or midday, mosquitoes wait out the heat in shaded shrubs, under decks, and along fence lines. A professional barrier spray coats those resting surfaces so treatment reaches mosquitoes where they wait — not just during one bite window. BuzzSkito treats GTA yards with seasonal programs and single treatments from $99.</p>
          ...
          <TopPick tag={AMZ_TAG}
            ...
            score={8.7}
            pros={['Odourless and non-greasy', 'Won’t damage plastics, watches, or sunglasses', 'Long-lasting protection from one application']}
          ...
          <ul>
            ...
            <li><strong>Clothing</strong> &mdash; loose long sleeves and pants beat tight ones, because <em>Aedes</em> will bite straight through fabric stretched against skin. A mosquito&rsquo;s proboscis reaches roughly 2&nbsp;mm, so thin, tight synthetics like leggings offer almost nothing while denim and thick weaves genuinely stop the bite &mdash; <Link href="/blog/can-mosquitoes-bite-through-clothes">which fabrics mosquitoes can bite through</Link> comes down to that thickness and how flat the cloth sits against skin. Permethrin-treated clothing is widely sold in the United States and is applied to garments, never to skin; in Canada, consumer permethrin clothing sprays are not registered the way they are stateside, so factory-treated garments are the usual route &mdash; check the PMRA listing before buying.</li>
          ...
          <p>The American Mosquito Control Association describes the same three cues, and the practical consequence is that the &ldquo;mosquito magnet&rdquo; in your household is usually explained by something other than build. Anyone who has just exercised is exhaling more CO&#8322;, running hotter, and carrying more lactic acid on the skin &mdash; three signals raised at once. Pregnancy raises both CO&#8322; output and skin temperature. Skin microbiome composition varies a lot between people and appears to matter more than most single factors. Alcohol is commonly reported to increase attractiveness, though the evidence is modest. Blood-type claims circulate constantly online; the studies behind them are small and inconsistent, and it is not a finding to plan an evening around. The most-cited of them &mdash; Shirai and colleagues, 2004 &mdash; tested fewer than a hundred volunteers in a short lab trial, which is worth knowing before accepting the &ldquo;Type O gets bitten more&rdquo; line as settled &mdash; <Link href="/blog/what-blood-type-do-mosquitoes-bite">what the blood-type research actually shows</Link> walks through the study and what it can and cannot support.</p>
          <p>The useful takeaway is that none of these traits are worth worrying about, because all of them are overridden by the same intervention. Whatever your CO&#8322; output, a registered repellent on exposed skin (EPA number in the US, PCP number in Canada) closes the gap between the most-bitten person at the table and the least-bitten one.</p>
      ...
      <CTASection heading="Mosquito Control for Dawn, Dusk, and Every Hour Between" subtext="A residual barrier spray treats the shaded spots where mosquitoes rest, day and night. From $99." variant="dark" />
    </>
  )
}
