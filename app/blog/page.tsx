...
import { MOSQUITO_BLOGS, TICK_BLOGS, NEW_BLOGS, NEW_BLOGS_2, NEW_BLOGS_3, NEW_BLOGS_4, NEW_BLOGS_5, NEW_BLOGS_6, NEW_BLOGS_7, NEW_BLOGS_8, NEW_BLOGS_9, NEW_BLOGS_10, NEW_BLOGS_11, NEW_BLOGS_12, NEW_BLOGS_13, NEW_BLOGS_14, NEW_BLOGS_15, NEW_BLOGS_16, NEW_BLOGS_17, NEW_BLOGS_18, NEW_BLOGS_19, NEW_BLOGS_20, NEW_BLOGS_21, NEW_BLOGS_22, NEW_BLOGS_23, NEW_BLOGS_24, NEW_BLOGS_25, NEW_BLOGS_26, NEW_BLOGS_27, NEW_BLOGS_28, NEW_BLOGS_29, NEW_BLOGS_30, NEW_BLOGS_31 } from '@/lib/constants'
    ...
    <>
      ...
      <section aria-labelledby="city-guides" className="py-14 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...NEW_BLOGS, ...NEW_BLOGS_2, ...NEW_BLOGS_3, ...NEW_BLOGS_4, ...NEW_BLOGS_5, ...NEW_BLOGS_6, ...NEW_BLOGS_7, ...NEW_BLOGS_8, ...NEW_BLOGS_9, ...NEW_BLOGS_10, ...NEW_BLOGS_11, ...NEW_BLOGS_12, ...NEW_BLOGS_13, ...NEW_BLOGS_14, ...NEW_BLOGS_15, ...NEW_BLOGS_16, ...NEW_BLOGS_17, ...NEW_BLOGS_18, ...NEW_BLOGS_19, ...NEW_BLOGS_20, ...NEW_BLOGS_21, ...NEW_BLOGS_22, ...NEW_BLOGS_23, ...NEW_BLOGS_24, ...NEW_BLOGS_25, ...NEW_BLOGS_26, ...NEW_BLOGS_27, ...NEW_BLOGS_28, ...NEW_BLOGS_29, ...NEW_BLOGS_30, ...NEW_BLOGS_31].map((post) => (
