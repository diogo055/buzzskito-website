...
import { MOSQUITO_BLOGS, TICK_BLOGS, NEW_BLOGS, NEW_BLOGS_2, NEW_BLOGS_3, NEW_BLOGS_4, NEW_BLOGS_5, NEW_BLOGS_6, NEW_BLOGS_7, NEW_BLOGS_8, NEW_BLOGS_9, NEW_BLOGS_10, NEW_BLOGS_11 } from '@/lib/constants'
    ...
    <>
      ...
      <section aria-labelledby="city-guides" className="py-14 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...NEW_BLOGS, ...NEW_BLOGS_2, ...NEW_BLOGS_3, ...NEW_BLOGS_4, ...NEW_BLOGS_5, ...NEW_BLOGS_6, ...NEW_BLOGS_7, ...NEW_BLOGS_8, ...NEW_BLOGS_9, ...NEW_BLOGS_10, ...NEW_BLOGS_11].map((post) => (
