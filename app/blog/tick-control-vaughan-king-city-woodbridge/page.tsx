    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
          ...
          <p className="text-gray-800 text-[15px] leading-relaxed font-medium">Yes &mdash; Vaughan, Woodbridge, and King City face real, measurable tick risk. Boyd Conservation Area, the Humber River valley, and King Township&apos;s Oak Ridges Moraine lands are confirmed blacklegged tick habitat, and five barrier treatments spread roughly monthly from May through September &mdash; renewed as each application&apos;s residual wears down &mdash; cover the active season without leaving a gap.</p>
