...
const FAQS = [
  ...
  { question: `How do I keep mosquitoes away from my yard?`, answer: `To keep mosquitoes away long-term, remove the standing water they breed in, treat any water you can't drain with BTI mosquito dunks, and put down a professional barrier spray on shrubs and fence-line resting sites for up to 30 days of protection. Between treatments, run a fan where you sit, keep grass short, and re-check for refilled containers after every rain. The two layers cover different failure modes: source elimination removes the mosquitoes bred on your lot, and barrier spray treats the vegetation the ones flying in from elsewhere land on. Neither clears a yard on its own, and neither is permanent.` },
      ...
      <section className="bg-white px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <p className="text-gray-800 text-[15px] leading-relaxed font-medium">The most effective way to get rid of mosquitoes in your Ontario yard is a layered approach: eliminate every standing-water source, treat water you can&apos;t drain with BTI mosquito dunks, apply a professional barrier spray to shrubs and fence-line resting sites, and re-treat every 3&ndash;4 weeks from May through September. Each layer covers a different failure mode: source elimination removes what breeds on your lot, BTI kills larvae in water you can&apos;t drain, and barrier spray treats the vegetation adults rest on after flying in from elsewhere. Repellent-only tactics protect the person wearing them and do not lower the yard&apos;s mosquito population at all.</p>
