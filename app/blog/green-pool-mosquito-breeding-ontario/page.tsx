...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Bti — Bacillus thuringiensis israelensis, sold in Canada as mosquito dunks and mosquito bits. It is a bacterial larvicide that kills mosquito larvae in the water; the Canadian products carry a PCP registration number and are labelled for use in standing water. Bits give you knockdown within a day or two because the granules disperse immediately; dunks release slowly and hold the site for roughly 30 days per dunk at the labelled dose. Two things to know: Bti does not kill pupae, because pupae have stopped feeding, so the tumblers already in the water will still hatch over the following few days; and Bti is a stopgap, not a fix. It buys you the four weeks you need to get a cover on, get circulation running, or get the pool drained.',
  },
  {
    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Bti (<em>Bacillus thuringiensis israelensis</em>) is a naturally occurring soil bacterium producing a toxin that targets mosquito larvae specifically. Canadian Bti products carry a PCP registration number for use in standing water, and Bti is what municipal programs use in catch basins. Consumer form comes two ways, and the difference matters when you are shutting a pool down this week:</p>
          <ul>
