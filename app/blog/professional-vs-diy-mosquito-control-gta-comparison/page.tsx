...
const FAQS = [
  {
    ...
    answer: 'For GTA properties with mosquito pressure above background levels — which is most properties from late June through August — yes, the cost math favours professional control. A full DIY toolkit (Thermacell + refills, store-bought sprays applied weekly, citronella candles, BTi for standing water, head nets, repellents) runs $500-$725 per summer for materials alone, ignoring time. Professional barrier spray service for a standard lot starts at $549 for a five-spray season (a single visit is from $99). The difference is not just cost, it is coverage and persistence: a licensed applicator treats every shaded resting site across the lot with a residual that is renewed at every scheduled visit, whereas the DIY stack is a set of short-range, short-lived tools that have to be re-run constantly. For properties near water, ravines, or with heavy outdoor entertaining, professional is the better economic decision.',
  },
  {
    question: 'Can I really get rid of mosquitoes with DIY products?',
    answer: 'You can reduce mosquito pressure with DIY products. You cannot eliminate them. The honest accounting: BTi dunks in standing water genuinely break the breeding cycle in treated containers — but only if you find every standing-water source on the property. Thermacell creates a 4-metre repellent cloud while running — useful for patio dining, not for whole-yard protection. Store-bought hose-end sprays (Cutter, OFF! Yard, Repel) have minimal residual action; the active ingredient evaporates in 4-24 hours. Citronella candles work in a 1-2 metre radius and only in low wind. Applied diligently, that combination genuinely helps on a typical GTA lot. What it cannot do is treat the shaded vegetation across the whole property and keep treating it: a professional barrier spray with a residual pyrethroid leaves a residual on the leaf undersides and shrub interiors where adult mosquitoes spend the day, renewed on a schedule. You can do meaningful DIY work; you cannot reproduce that coverage or that persistence by hand.',
  },
  {
    question: 'How much does a season of DIY mosquito control cost?',
    answer: 'A serious DIY mosquito program for a GTA backyard costs $500-$725 per summer for materials alone. Breakdown: Thermacell unit ($40) plus 4-5 refill packs ($45), Bti mosquito dunks for standing water ($25), 4-6 bottles of hose-end perimeter spray applied biweekly ($60), a case of citronella candles ($35), 3-4 bottles of personal repellent ($45), factory permethrin-treated socks ($50), a Mosquito Magnet or Dynatrap unit if you go that route ($200-$400 plus replacement parts), and personal protection upgrades like head nets ($25). Time investment runs 30-40 hours over the May-September season. The professional alternative — a standard five-spray seasonal program — is $549, with the technician handling the work. The DIY-to-professional cost ratio is roughly comparable on materials; the real difference is coverage and persistence.',
  },
  {
    question: 'Are Mosquito Magnets effective?',
    answer: 'Mosquito Magnets and similar CO2-bait traps (Dynatrap, Skeetervac) have a mixed reputation backed by mixed research. Independent university studies show 30-60% reduction in mosquito populations within a treated area when units run continuously for 6+ weeks — but only for the specific species attracted to the bait profile. They do nothing for daytime biters like Asian tiger mosquitoes (which are establishing in southern Ontario), nothing for black flies, and nothing for ticks. The unit costs $300-$600. Propane fuel runs about $40/month per unit during operation. Attractant cartridges run $30/month. Total operating cost is $250-$400 per season on top of the equipment. For a single backyard, they are a harder case to make than a professional barrier spray at a comparable seasonal price point.',
  },
  {
    question: 'Is professional mosquito spray safer than store-bought?',
    answer: 'The honest answer is about application, not chemistry. Licensed applicators use PCP-registered products at the label rate, with calibrated equipment. Store-bought products are often misapplied: homeowners over-concentrate, spray on windy days, miss reentry intervals, or apply to surfaces (pollinator flowers, vegetable gardens) the label prohibits. The chemistry itself is comparable — most store-bought lawn perimeter sprays use the same pyrethroid family as professional treatments — but the application discipline is not. A licensed applicator is trained to follow the label: no spraying flowering plants or areas where bees are foraging, buffers around water, protective equipment, and controlled droplet size. Whatever product is used, stay off treated areas until the spray has dried, as the label directs.',
  },
  {
    question: 'When should I hire a professional vs DIY?',
    answer: 'Three thresholds favour professional: (1) you are within 1km of a major water feature (Credit River, Don Valley, 16 Mile Creek, Bronte Creek, RBG, Cootes Paradise, Lake Ontario shoreline) — mosquito pressure exceeds what DIY can manage; (2) you entertain outdoors more than 2-3 times per month during summer — the value of reliable coverage compounds; (3) you have young children who play outside daily, or someone with severe bite reactions — consistent, scheduled treatment matters more. DIY makes sense if your lot is small, urban, dry, well-screened, and you only occasionally use the yard during peak hours. For most GTA suburban properties, the combination — professional barrier spray as the spine, DIY as the supplement (Thermacell on the patio, BTi in any standing water, repellent for outings) — is the optimal stack.',
  },
  {
    question: 'What about pollinator safety with professional spray?',
    answer: 'This is a legitimate concern that deserves a real answer. Pyrethroid-based barrier sprays are toxic to bees, butterflies, and other pollinators, which is why their labels restrict where and when they can be applied. Three practices matter: (1) do not spray flowering plants or areas where pollinators are foraging; (2) follow the label\'s timing and weather directions; (3) target shrub interiors, fence lines, and the underside of leaves — not blossoms. The net pollinator impact is far smaller than the impact from agricultural neonicotinoids, ornamental insecticide misuse, or habitat loss — but it is not zero, and any responsible operator manages it actively.',
  },
]
    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        ...
        <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
          ...
          <p className="text-gray-800 text-[15px] leading-relaxed font-medium">On a typical GTA lot, professional barrier spray beats a DIY toolkit: a diligent DIY stack costs about $500&ndash;$725 a summer in materials alone and is built from short-range, short-lived tools you have to keep re-running, while a professional barrier-spray season treats the resting vegetation across the whole lot and renews a residual there on a schedule, with no labour on your part. The best strategy is professional spray as the foundation with targeted DIY as the supplement.</p>
          <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
            <li>A full DIY mosquito toolkit costs roughly $500&ndash;$725 per GTA summer plus 30&ndash;40 hours of labour.</li>
            <li>DIY tactics are short-range and short-lived; professional barrier spray covers the whole lot and leaves a residual that is renewed on a schedule.</li>
            <li>A professional single treatment starts at $99; a 5-spray basic season is $549 and a 10-spray standard season is $994.</li>
            <li>Professional barrier spray leaves a residual on treated vegetation and is re-applied on a schedule (monthly, every 2 weeks, or weekly).</li>
        ...
        <p>The single most effective DIY product. BTi is a naturally-occurring bacterium that produces toxins specific to mosquito, black fly, and fungus gnat larvae. It is not a broad-spectrum insecticide. Dunks ($1-$2 each) drop into standing water — birdbaths, rain barrels, plant saucers, ponds, French drains, retention basins — and the product label rates them to kill mosquito larvae within 24 hours. One dunk is labelled to treat 100 square feet of water for 30 days. Granules ($25 for a 32-oz container) work the same way for shallow water.</p>
        ...
        <TopPick tag={AMZ_TAG}
          ...
          blurb="The single most effective DIY product in this guide. Drop one into any standing water — birdbaths, rain barrels, plant saucers, ponds, French drains — and the label rates it to kill larvae within 24 hours and keep working for 30 days, breaking the breeding cycle. Its toxin targets mosquito, black fly, and fungus gnat larvae rather than acting as a broad-spectrum insecticide. It won't touch adult mosquitoes already biting, so pair it with yard treatment for full coverage."
          search="summit mosquito dunks"
          score={8.7}
          pros={['95%+ larval kill in treated water', 'One dunk lasts ~30 days per 100 sq ft', 'Larvae-specific, not broad-spectrum']}
        ...
        <p>This is the single most effective personal protection layer available — and one of the least known. Permethrin (a pyrethroid) is bonded to the fabric of factory pre-treated garments, which is the format permitted for Canadian consumers &mdash; a spray-on treatment you apply to clothing yourself is not approved here (our <Link href="/blog/permethrin-canada-yard-clothing-spray" className="text-brand-700 underline">permethrin Canada guide</Link> explains why). Mosquitoes, ticks, and black flies that contact treated fabric are knocked down within seconds. Cost: roughly $40-$120 per garment. Permethrin-treated pants, socks, and long sleeves are the gold standard for outdoor work, hiking, gardening near tick habitat, and outdoor evening activity.</p>
        ...
        <p>A professional yard treatment uses a PCP-registered residual pyrethroid (typically deltamethrin, lambda-cyhalothrin, or bifenthrin) applied at a label-specified concentration through a precision <Link href="/blog/backpack-sprayer-canada" className="text-brand-700 underline">backpack sprayer</Link>. The applicator targets the surfaces where mosquitoes rest between feeding bouts: shrub interiors, the underside of leaves, fence lines, dense ornamental beds, the lawn-to-bed transition, woodpiles, and shaded fence corners. The formulation dries on plant surfaces and leaves a residual that knocks down mosquitoes on contact with treated foliage, which is why it is re-applied on a schedule.</p>
        <p>We are not going to put a percentage on our own service without a study behind it. The structural advantage over DIY is coverage and persistence: a licensed applicator treats every shaded resting site across the lot — leaf undersides, shrub interiors, fence-line vegetation, under decks — with a residual product, renewed at each scheduled visit. No consumer-grade tactic covers that much surface area. What none of them do, ours included, is clear a yard: mosquitoes disperse in from neighbouring properties continuously.</p>
        ...
        <ul>
          ...
          <li><strong>Standard season (10 sprays, bi-weekly May-September):</strong> $994. Most popular. A treatment every 2 weeks through the mosquito-active window. Best fit for most GTA suburban properties.</li>
          <li><strong>Exclusive season (20+ sprays, weekly May-September):</strong> $2,049. Weekly treatment for high-pressure properties. Best fit for large lots, ravine-adjacent properties, frequent outdoor entertaining.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Permethrin-treated socks for 2 family members: $50</li>
        ...
        <p>The cost math is closer than most homeowners assume. The coverage gap is where the real difference lives — and on time-cost, the professional service is overwhelmingly more efficient.</p>
        ...
        <ul>
          ...
          <li>Professional barrier spray on yard: residual on treated resting vegetation, renewed at each scheduled visit</li>
        </ul>
        <p>The pattern is clear: the personal protection tactics (DEET, permethrin clothing) are highly effective on the body but do not protect the yard. The yard-protective DIY tactics are limited by range and by how fast their actives break down. Professional barrier spray is the only intervention here that treats the resting vegetation across an entire lot and renews a residual on it at each scheduled visit &mdash; though it too has a limit, since mosquitoes disperse in continuously from neighbouring properties.</p>
        ...
        <p>The real difference between professional and consumer-applied products is how they are applied. Three reasons. First, professional applicators are licensed by the Ontario Ministry of the Environment under the Ontario Pesticide Operator Licence — meaning they have passed training on application protocols, label compliance, and handling practices. Second, products are applied at the label rate with calibrated equipment; consumer products are routinely over-concentrated by homeowners. Third, the label&rsquo;s re-entry direction is followed and explained: stay off treated areas until the spray has dried. For more on pet and child safety specifically, see <Link href="/blog/is-mosquito-spray-safe-kids-pets" className="text-brand-700 underline">is mosquito spray safe for kids and pets</Link>.</p>

        <h3>Pollinator safety</h3>
        <p>This is the legitimate concern. Pyrethroid-based barrier sprays — both professional and consumer — are toxic to bees, butterflies, and beneficial insects on direct contact. Three protocols matter for responsible professional application: do not spray flowering plants or active pollinator zones; follow the label&rsquo;s timing and weather directions; target shrub interiors, fence lines, and the underside of leaves rather than blossoms.</p>
        ...
        <p>Professional barrier spray applied every two weeks across May-September renews the residual on schedule through the entire pressure window, so results do not hinge on any single application. This is the structural reason professional treatment suits a GTA suburban lot specifically — the climate generates pressure faster than weekend application can suppress.</p>
        ...
        <ul>
          ...
          <li>You have no young children playing outside daily, and no one with severe bite reactions</li>
          <li>You are comfortable with short-range, short-lived tools you re-run yourself rather than a residual maintained across the whole lot</li>
        </ul>
        ...
        <ul>
          ...
          <li>You want treatment on a predictable schedule rather than ad-hoc effort</li>
        </ul>
        ...
        <ul>
          <li><strong>Professional barrier spray every 2-3 weeks (May-September)</strong> — the foundation. It puts a residual on the shaded resting vegetation across the whole lot and the rolling re-treatments keep it there, but mosquitoes disperse back in continuously from neighbouring properties, which is why it is repeated rather than one-and-done.</li>
          <li><strong>BTi dunks in any standing water</strong> — treats breeding sources on your property at trivial cost.</li>
          <li><strong>Thermacell on the patio during peak hours</strong> — puts a repellent vapour cloud over the seating area itself, roughly 4 metres across. It does nothing outside that radius and nothing once the unit is switched off.</li>
      ...
      <CTASection heading="Cut the trial-and-error — get the professional foundation in place" subtext={`Free custom quote based on your address and lot. ${PROMISES.response} Same-week service across the GTA. ${PROMISES.visitWindow}`} />
    </>
  )
}
