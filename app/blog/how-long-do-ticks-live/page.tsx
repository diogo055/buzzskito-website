    ...
    <>
      ...
      <article className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          {/* source: https://www.canada.ca/en/public-health/services/diseases/ticks-tick-borne-diseases/prevent-tick-bites.html */}
          <p>Ticks can live in a house for only <strong>a few days to about two weeks</strong>, and that holds for both species you are likely to carry in from an Ontario yard, the blacklegged tick and the American dog tick. Neither species can breed in indoor air that sits near 30 to 50% humidity, so the ticks already inside cannot multiply; the one species that can live its whole life indoors is the brown dog tick, and it is uncommon in Canada. They arrive on pets, clothing and outdoor gear &mdash; the Public Health Agency of Canada advises inspecting your pets before you come in because they can bring ticks into your home, checking yourself, your clothing and gear such as backpacks, and putting dry clothes in a dryer on high heat for at least 10 minutes. The question that matters more than the calendar is whether a tick attached to someone and for how long, since the risk of Lyme disease transmission rises the longer a tick stays attached; our guide to <Link href="/blog/are-ticks-dangerous-ontario">whether ticks are dangerous in Ontario</Link> covers which species carry which illnesses.</p>
