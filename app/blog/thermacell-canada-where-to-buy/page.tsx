...
export default function ThermacellCanadaPage() {
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              ...
              <li>The Canadian label for the fuel-powered line (RD2019-03) claims mosquito repellency up to 4.5 metres from the device for up to 4 hours.</li>
              ...
              <li>Professional barrier spray treats the whole yard from $99 and is re-applied on a schedule.</li>
            </ul>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-gray-800 leading-relaxed">
            <strong>Yes — Thermacell works in still air. The Canadian fuel-powered line is registered (RD2019-03) to kill and repel mosquitoes up to 4.5 metres from the device for up to 4 hours, and published field trials of these heated-pyrethroid emanators report roughly 70–95% bite reduction in calm conditions.</strong> The vapour is allethrin or prallethrin in the fuel-powered models and metofluthrin in the rechargeable E-Series. Performance drops sharply in wind, on open lawns, or near stagnant water, and the Canadian registration covers mosquitoes — not blackflies. Best for patios, decks, and small gathering spots — NOT whole-yard protection. For a typical GTA 5,000 sq ft yard you&rsquo;d need something like seven units running simultaneously — which costs more than professional barrier spray that covers the entire yard.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['Canadian registration status', 'Products carry PCP registration numbers under the Pest Control Products Act (23 Thermacell products; Liv is not one of them)'],
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <ul>
            ...
            <li><strong>Tick protection</strong> — a Thermacell repeller does nothing for ticks (they don&rsquo;t fly). Thermacell&rsquo;s separate Tick Control Tubes are a different product entirely, which carry Canadian PCP registration number 33858</li>
            <li><strong>Daytime backyard use</strong> — pollinators are foraging; better to wait until evening</li>
          </ul>
          <p>The blackfly gap is the one that catches cottagers out. The Canadian label carries a mosquito claim, blackflies are not on it, and they fly aggressively into the zone rather than drifting through it — so in Muskoka, Haliburton or Algonquin during the May–June peak, the thing that reliably works is a head net over a hat brim. It weighs nothing, folds into a pocket, and costs less than a single pack of cartridges.</p>
          <div className="not-prose my-4">
            <BuyLink tag={AMZ_TAG} search="mosquito head net hat">Check head nets on Amazon.ca →</BuyLink>
          </div>
          ...
          <table className="min-w-[560px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Professional barrier spray</strong></td><td className="px-3 py-2">Entire property</td><td className="px-3 py-2">From $99 per treatment (BuzzSkito)</td><td className="px-3 py-2">Whole-yard, re-applied on a schedule</td></tr>
            </tbody>
          </table>
          ...
          <ol>
            ...
            <li><strong>Whole-yard barrier spray</strong> — <Link href="/mosquito-control">BuzzSkito&rsquo;s seasonal program</Link> applies a product with a Canadian PCP registration number to vegetation, according to label directions, under Ontario Pesticide Operator Licence L-240-2436835197, and re-applies it on a schedule across your entire property</li>
          ...
          <p>Layer one is the cheapest of the three and the one people skip. BTI is a naturally occurring soil bacterium registered in Canada as a larvicide; dropped into a rain barrel, an ornamental pond, or a blocked drain, it stops that water producing the next generation on your own property. Dunks are the slow-release format for water you leave alone for a month, granules clear a container within about a day — check the label for the water types each one is cleared for.</p>
          <div className="not-prose my-4">
            <BuyLink tag={AMZ_TAG} search="mosquito dunks bti larvicide">Check BTI dunks on Amazon.ca →</BuyLink>
          </div>
          <p>Layer three has a second half that a repeller cannot do. The vapour zone protects the chair you are sitting in; the moment you walk to the shed, the fire pit, or the far end of the yard at dusk, the only thing still with you is what is on your skin. Icaridin (the Canadian name for picaridin) and DEET are the two actives Health Canada&rsquo;s PMRA registers for on-skin use, and the concentration and age directions printed on the specific product label are the rule to follow.</p>
          <div className="not-prose my-4">
            <BuyLink tag={AMZ_TAG} search="icaridin insect repellent canada">Check icaridin and DEET repellents on Amazon.ca →</BuyLink>
          </div>
      ...
      <CTASection heading="Thermacell Covers the Patio · Barrier Spray Covers the Yard" subtext={`Get a free quote for whole-yard barrier spray. From $99. ${PROMISES.labelLine}. ${PROMISES.rainBackShort}.`} variant="dark" />
    </>
  )
}
