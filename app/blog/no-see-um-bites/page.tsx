    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-14 prose-brand">
        ...
        <ul>
          ...
          <li><strong>Wear factory permethrin-treated clothing</strong> for a fabric barrier repellent can&rsquo;t match. Health Canada states that permethrin liquids and sprays for consumers to treat their own clothing are not approved for use in Canada, so buy the protection already bonded into the garment rather than spraying your own. Our guide to <Link href="/blog/bug-protective-clothing-canada">bug-protective clothing</Link> covers what to look for.</li>
        ...
        <p>Treated clothing is the layer most people skip, and in Canada the format matters as much as the active ingredient. <strong>Permethrin goes on fabric, never on skin</strong> &mdash; but that does not mean treating the fabric yourself here. <strong>Health Canada states that permethrin liquids and sprays for consumers to treat their own clothing are not approved for use in Canada</strong>, so a spray-on clothing treatment is not the Canadian route, whatever a US product listing suggests. What Canada does approve is <strong>factory pre-treated permethrin clothing</strong> &mdash; shirts, pants, and socks with the permethrin bonded in during manufacture, which lasts up to 70 wash cycles. That is the layer to buy: the same fabric barrier, in a format Canada permits. Our guide to <Link href="/blog/bug-protective-clothing-canada">bug-protective clothing</Link> covers what to look for.</p>
        <p className="not-prose my-4">
          <BuyLink tag={AMZ_TAG} search="insect shield permethrin treated clothing">Check permethrin-treated clothing on Amazon &rarr;</BuyLink>
        </p>
