    ...
    <>
            ...
            awards={[
              {
                ...
                cons: ['Rated up to 5.7 m by SC Johnson — if the nest sits higher than the can reaches, call a pro rather than climb', 'Foam can drip on vertical surfaces'],
              },
              {
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The distance a manufacturer publishes is the number that sells the can, and it is measured in conditions you will never reproduce: a full, warm, freshly-shaken can, fired horizontally in still air. Against a real nest, on a real evening, plan on <strong>usable reach landing well short of the published claim &mdash; treat roughly 30 to 40 percent short as a working margin</strong> rather than a tested figure.</p>
