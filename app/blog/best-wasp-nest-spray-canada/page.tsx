    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>For forager pressure specifically, the levers that work are interception and exclusion rather than contact spray: bait traps hung at the property line to pull scavengers away from the seating area (our <Link href="/blog/best-wasp-trap-canada">wasp trap comparison</Link> and <Link href="/blog/best-yellow-jacket-trap-canada">yellowjacket trap guide</Link> cover placement, which matters more than brand), lidded bins, covered drinks and cans, and mesh over the space you actually sit in. A contact aerosol is the wrong instrument for a yard-wide problem and the right one for a nest.</p>
