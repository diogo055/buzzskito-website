    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Marketing photos show a timer; reality shows a thermometer. The kill standard is a sustained core temperature — we work to 49°C held with margin — and how long that takes depends almost entirely on load density:</p>
          <ul>
