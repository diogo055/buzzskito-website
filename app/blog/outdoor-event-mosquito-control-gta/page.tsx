...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Book pre-event barrier spray for GTA backyard weddings, graduations, parties. One treatment, timed 3–5 days out, targets resting mosquitoes. Timing guide.',
...
const FAQS = [
  {
    ...
    answer:
      'Book at least 5–7 days before your event. The ideal timing is 3–5 days prior — this allows the barrier spray to dry fully on the vegetation well before guests arrive. Booking same-day is sometimes possible but not guaranteed; early scheduling means you have time to re-treat if heavy rain falls immediately after the application.',
  },
  {
    question: 'How long does a pre-event mosquito spray last?',
    answer:
      'A single treatment leaves a temporary residual on the vegetation where mosquitoes rest, and that residual wears down within weeks; that is why season plans renew it on a schedule (monthly, every 2 weeks, or weekly). Timing the spray 3–5 days before the event means it is fully dry and freshly applied on event day. Heavy or sustained rain shortens how long the residual lasts, which is why early booking leaves time to re-treat.',
  },
  {
    question: 'Is the spray safe for wedding guests, children, and catered food?',
    answer:
      `BuzzSkito applies products according to label directions, under our ${PROMISES.licence}. Keep people and pets off treated areas until the spray has dried, as the label directs. For outdoor events with catering, we recommend treating the property at least 48 hours before food setup; the spray goes on vegetation, not on tables, chairs, or food areas.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      `Light rain after the spray has fully dried matters far less than heavy rain soon after application, which can wash residual off. ${PROMISES.rainBack} On Standard & Exclusive season plans, the Bite-Free Guarantee also covers a free re-treatment if mosquitoes come back between scheduled treatments.`,
  },
]
...
export default function OutdoorEventMosquitoPage() {
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema(`/blog/${POST.slug}`)) }}
      />
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
          ...
          <p className="text-gray-800 text-[15px] leading-relaxed font-medium">The simplest way to cut down mosquitoes at a GTA backyard wedding, graduation, or party is a single professional barrier spray applied 3&ndash;5 days before the event &mdash; one treatment covers the resting areas across the whole property, with no action needed from your guests.</p>
          <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
            <li>Book at least 5&ndash;7 days before the event; a spray applied 3&ndash;5 days out is fully dry well before event day.</li>
            <li>One professional barrier spray treats the mosquito resting areas across the whole property; season plans renew the residual on a schedule.</li>
            <li>Keep guests, children, and pets off treated areas until the spray has dried, as the label directs.</li>
            <li>For catered events, treat at least 48 hours before food setup so every surface is fully dry.</li>
            <li>{PROMISES.rainBack} The Bite-Free Guarantee applies to Standard &amp; Exclusive season plans.</li>
        ...
        <p className="text-lg text-gray-600 not-prose border-l-4 border-brand-400 pl-5 py-2 mb-8">
          You&apos;ve spent months planning your backyard wedding or party. The last thing you want is mosquitoes turning the evening into a disaster. A single professional barrier spray, timed correctly, cuts down the mosquitoes your guests will meet on the night. Here&apos;s exactly how it works.
        </p>
        ...
        <p>We&apos;ve treated backyards in Lorne Park hours before a wedding rehearsal dinner, sprayed Glen Abbey properties the week of graduation parties, and pre-treated commercial venues in Etobicoke before corporate outdoor events. The pattern is always the same: homeowners who plan ahead have fewer mosquitoes at their events. Those who don&apos;t often spend the evening watching guests retreat inside by 8 pm.</p>

        <h2>How Pre-Event Barrier Spray Works</h2>
        <p>Professional barrier spray is applied to the foliage, fence lines, tree trunks, shaded lawn edges, and perimeter vegetation of your property — the places where mosquitoes rest during the day before they become active at dusk. The formula leaves a residual on those leaf surfaces once it dries.</p>
        <p>Unlike the citronella candles and DEET sprays your guests would need to apply themselves, barrier spray treats the <em>environment</em> rather than individuals. It targets mosquitoes where they rest around your property. For an outdoor event, it treats the whole property without requiring any action from your guests.</p>
        ...
        <p>Companies hosting outdoor team events, client barbecues, or off-site meetings in properties with significant green space around the GTA use pre-event treatments to cut down on mosquitoes for attendees. BuzzSkito serves commercial properties and larger venues across the service area.</p>

        <h3>Cottage and Rural Property Events</h3>
        <p>Caledon, King City, Georgetown, and rural Halton Hills properties hosting summer events face heavy mosquito pressure from surrounding agricultural land, ponds, and creek systems. Rural event treatments often mean treating a much longer perimeter — call us with your property details for an accurate quote.</p>

        <h2>What to Tell Your Guests</h2>
        <p>After a BuzzSkito barrier spray, stay off treated areas until the spray has dried, as the product label directs. The spray is applied to vegetation &mdash; foliage, fence lines, and shaded edges &mdash; not to tables, chairs, or décor. You can honestly tell guests that the property was professionally treated for mosquitoes by a licensed operator a few days before the event.</p>

        <h2>Combining Pre-Event Treatment with Your Seasonal Package</h2>
        <p>The most cost-effective approach for GTA homeowners who host regular outdoor events is a full seasonal package. A season plan puts treatments on a schedule from May through September &mdash; Basic is 5 sprays, monthly ($549); Standard, the most popular, is 10 sprays every 2 weeks ($994), plus HST &mdash; so your summer parties, everyday evenings, and kids&apos; outdoor time fall inside the treatment schedule without separate event bookings. The per-visit cost drops when booked as a season.</p>
