    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
          ...
          <p className="text-gray-800 text-[15px] leading-relaxed font-medium">Stoney Creek properties face high mosquito and tick pressure from three directions &mdash; the Lake Ontario waterfront, the Red Hill Creek ravine corridor, and the Niagara Escarpment. Professional barrier spray leaves a temporary residual on the vegetation where mosquitoes rest, and a season of five mosquito treatments and five tick treatments covers May through September.</p>
          <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
            <li>Barrier spray is applied to the leaf surfaces where mosquitoes rest; its residual is temporary, so it is re-applied on a schedule.</li>
            ...
            <li>Nymphs peak May through July and drive most Lyme transmission; adults stay active into November in mild years, so treatments run monthly through the whole season.</li>
