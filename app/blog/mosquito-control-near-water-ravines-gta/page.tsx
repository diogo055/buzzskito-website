...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Near Water: Ravines, Ponds & Waterfront in the GTA | BuzzSkito',
  description:
