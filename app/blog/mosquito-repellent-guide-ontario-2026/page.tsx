...
const FAQS = [
  {
    ...
    answer: 'For personal skin protection, DEET (up to 30% for adults, per Health Canada) and icaridin/picaridin (20%) remain the gold standard. Canadian labels put 25% DEET at up to 8 hours and 20% icaridin at up to 12; the Canadian Paediatric Society is more conservative at 5–8 hours for DEET and 5–7 for icaridin. Oil of lemon eucalyptus is the best-evidenced natural option, but check which lemon-eucalyptus active the label names: every synthetic PMD product registered in Canada is 10% PMD (Health Canada re-evaluation decision RVD2022-11), which the Canadian Paediatric Society rates at about 2 hours against mosquitoes, while the naturally sourced form — oil of lemon eucalyptus, hydrated, cyclized, sold as Citriodiol — is separately registered here at up to 30% and claims around 6 hours. For the yard itself, professional barrier spray applied to vegetation works on a different principle from personal repellents: it targets the mosquito population where it rests in your space rather than just what lands on your skin.',
  },
  {
    question: 'Is DEET safe?',
    answer: 'DEET has been used for over 60 years and is the most extensively studied insect repellent. Health Canada\'s label rules allow DEET products for adults and children 6 months and older, with concentration limits by age (10% max for children 6 months–12 years, up to 30% for adults). The long-standing internet myths about DEET are not supported by the peer-reviewed research; the rule that matters is to follow the label directions for concentration, age and number of applications.',
  },
  {
  ...
  },
  {
    ...
    answer: 'For personal use, a bottle of 20% icaridin or 25–30% DEET spray runs roughly $12–$25 and lasts most households a season — check current retail, since prices move. For yard-level control, Bti mosquito dunks (Summit Mosquito Dunks carry a Canadian label registered under the Pest Control Products Act — the PCP registration number is printed on the package) treat standing water at the source for well under the cost of a season of sprays. For yard-level treatment without personal repellent, professional barrier spray starts from $99 per visit on a standard lot under 10,000 sq ft and is re-applied on a schedule through the season.',
  },
  {
        ...
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <div className="not-prose bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              <li>20% picaridin protects for 6–10 hours, is odourless, and won&rsquo;t damage gear or plastics.</li>
              ...
              <li>For whole-yard control, professional barrier spray starts from $99 per treatment.</li>
            </ul>
          ...
          <div className="not-prose my-8">
            <AwardRow tag={AMZ_TAG}
              ...
              awards={[
                {
                  ...
                  score: 9.1,
                  featured: true,
                  pros: ['Canadian label claims up to 12 hrs vs mosquitoes and ticks', 'Odourless and non-greasy', 'Won’t damage gear, plastics or fabrics'],
                ...
                },
                {
                  ...
                  why: 'Lemon eucalyptus is the one natural repellent family with Canadian PCP-registered products and real repellency evidence. Read the active before you buy: synthetic PMD is registered in Canada only at 10% (Health Canada RVD2022-11), while the naturally sourced Citriodiol form is registered here at up to 30%. Either way, check the label for a Canadian PCP number.',
              ...
              whichToBuy={
                <>
                  <strong>Everyday backyard and travel?</strong> The <em>Best Overall</em> picaridin is the easy call. <strong>Heading into heavy bush?</strong> Step up to the <em>Best for Heavy Bug Pressure</em> DEET. <strong>Want a still patio without spraying your skin?</strong> The <em>Best Device</em> Thermacell earns its spot — but to reach for repellent less often at home, <Link href="/mosquito-control">professional barrier spray</Link> treats the whole yard and is re-applied on a schedule.
                </>
              }
            />
          </div>
          ...
          <h3>🟢 Tier 1: Gold Standard (PCP-registered in Canada, peer-reviewed)</h3>
          <ul>
          ...
          <p className="text-sm text-gray-600"><strong>Correction (Sept 2026):</strong> this tier previously listed <strong>IR3535 (15–20%)</strong> as a registered Canadian option. It is not. IR3535 is EPA-registered in the United States, but it does not appear among the personal insect repellent actives Health Canada lists as registered in Canada, and we could not find a PCP-registered IR3535 product for the Canadian market.</p>
          <p>One entry on that list is not a bottle at all. Permethrin appears there for <strong>factory-treated clothing only</strong>, which means the way to use it in Canada is to buy the garment already treated rather than treating one yourself. A treated shirt, a pair of trousers or a set of socks works as a layer underneath whatever you put on your skin, which is why people who spend their evenings in long grass or at a trailhead tend to own a set alongside a bottle. Read the garment label for the wash count it is rated to. <BuyLink tag={AMZ_TAG} search="insect repellent treated clothing">Check insect-repellent clothing on Amazon.ca &rarr;</BuyLink></p>

          <h3>🟡 Tier 2: Effective natural options</h3>
          <ul>
            <li><strong>Oil of lemon eucalyptus / PMD</strong> — the best-evidenced natural active, with PCP-registered products in Canada. Two related lemon-eucalyptus actives carry Canadian registrations, and the difference matters when you read a label. <strong>p-Menthane-3,8-diol (PMD)</strong> is the synthetic form: every PMD end-use product registered in Canada is <strong>10% PMD</strong> (Health Canada re-evaluation decision RVD2022-11 lists them all — they are the OFF! Botanicals line), and the Canadian Paediatric Society rates PMD at about 2 hours against mosquitoes and up to 5 against black flies. <strong>Oil of lemon eucalyptus, hydrated, cyclized</strong> (sold as Citriodiol) is the naturally sourced form and is separately registered here — Druide&rsquo;s made-in-Canada 30% Citriodiol repellent carries a Canadian PCP registration number and claims about 6 hours. So a 30% lemon-eucalyptus bottle is not automatically a US-only product; check which of the two actives the label names, and look for a PCP number. Health Canada: not for children under 3. Brands: OFF Botanicals (10% PMD), Druide (30% Citriodiol).</li>
          </ul>
          ...
          <ul>
            ...
            <li><strong>Pregnant women:</strong> The Public Health Agency of Canada&rsquo;s travel-medicine guidance considers DEET (20–30%) and icaridin (20%) suitable for use in pregnancy and while breastfeeding, and Health Canada states adults including pregnant women may wear permethrin-treated clothing. Health Canada&rsquo;s repellent page itself sets no separate pregnancy approval, so treat this as PHAC guidance rather than a label approval.</li>
          ...
          <p>For the under-six-month case in that list, the product doing the actual work is the net, because nothing goes on the baby at all. A fine-mesh cover over the crib, playpen, bassinet or stroller is the barrier Health Canada points parents to, and the ones worth having are elasticated the whole way round so they stay put when the stroller moves rather than draping loose over the hood. Measure the frame before you order &mdash; stroller nets and crib canopies are not the same size. <BuyLink tag={AMZ_TAG} search="stroller mosquito net">Check stroller &amp; crib mosquito nets on Amazon.ca &rarr;</BuyLink></p>

          <h2>The Strategy Most Ontario Homeowners Miss</h2>
          <p>Personal repellent is for outdoor activities <em>away</em> from your property. For your own backyard, a much better strategy is <strong>professional barrier spray</strong> — applied to vegetation perimeters and shrub interiors where mosquitoes rest. It targets the population where it rests in your yard and is re-applied on a schedule, so you are not reaching for repellent every time you step outside. The approach follows from what the treatment is aimed at: every mosquito that bites you is a female needing a blood meal to develop her eggs — males feed on nectar and never bite — and those females spend the day resting in shaded leaf cover rather than out over open lawn, which is why the shrub interiors get sprayed and the grass largely does not. Our explainer on the <Link href="/blog/male-vs-female-mosquito">difference between male and female mosquitoes</Link> lays out the behaviour every repellent and every barrier spray is really working against.</p>
          <p>Most homeowners think the choice is between DIY repellent or nothing. The third option — and usually the best one — is professional yard treatment, so you rely far less on personal repellent at home. That is the model we run across the GTA from our Mississauga base: the same May-to-September programs behind our <Link href="/toronto-mosquito-control">mosquito control in Toronto</Link> and <Link href="/mississauga-mosquito-control">Mississauga mosquito spraying</Link>.</p>
          ...
          <ul>
            ...
            <li><strong>BuzzSkito Basic seasonal (5 sprays, monthly):</strong> $549</li>
            <li><strong>BuzzSkito Standard seasonal (10 sprays, every 2 weeks):</strong> $994</li>
          </ul>
          <p>For most Ontario yards, the Standard plan &mdash; a treatment every 2 weeks from May through September &mdash; is the one homeowners choose most. It works out to roughly $200 a month across the five-month season, plus HST. Season pricing scales with lot size, so if you are comparing a bottle of repellent against a full program, start with <Link href="/mosquito-control-cost">what mosquito control costs in Ontario</Link> by property size.</p>
          <p>The cheapest line in that comparison is also the one most households skip. A Bti dunk drops into the water you cannot pour out &mdash; a rain barrel, a pond edge, a blocked low spot at the back fence &mdash; and kills the larvae there before they ever emerge as biting adults, which is a different job from anything you spray on yourself or on the leaves. Check the package for the Canadian PCP registration number and follow the label rate for the volume of water you are treating. <BuyLink tag={AMZ_TAG} search="summit mosquito dunks bti">Check Bti mosquito dunks on Amazon.ca &rarr;</BuyLink></p>
