...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Follow the label, and treat it as the fine dust it is. Amorphous silica gel kills insects by a physical drying action rather than a nervous-system poison, and it carries no resistance concerns of the kind pyrethroids do. It is a very fine dust and, like any fine powder, you should not breathe it: wear a dust mask (N95 or better) when applying, keep pets and children out of the room until the visible airborne dust settles, and apply a barely-there film into cracks and voids rather than a visible pile out in the open. Amorphous silica is not the same hazard as crystalline silica, but respiratory common sense still applies. Always follow the exact label directions on the product you buy in Canada.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Availability shifts, so the honest advice is to check current Canadian listings rather than assume. Silica gel desiccant dusts are sold into the Canadian market, and CimeXa has appeared on Amazon.ca and through Canadian pest-supply retailers, but stock and the exact registered product can vary. Before you buy, confirm the listing ships to Canada and — because it is a pest control product — that the version you buy carries a Canadian PCP registration number. This matters: many bed bug products Canadians are pushed toward in online forums (US concentrates like Crossfire or Temprid FX) are not registered for sale in Canada and are illegal to import. A desiccant dust available through legitimate Canadian retail sidesteps that whole problem.',
  },
  {
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['Canadian availability', 'Amazon.ca + pest-supply retailers — confirm the listing shows a Canadian PCP number'],
                  ['PMRA status', 'A pest control product — buy a version with a Canadian PCP number'],
                ].map(([k, v]) => (
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <ul>
            ...
            <li><strong>Wear a dust mask.</strong> Whatever the label says about hazards, amorphous silica is a very fine powder and you should not breathe any fine dust. An N95 and keeping pets and kids out until the air clears is basic sense.</li>
