    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The comb is the whole diagnosis, and a household brush will not do it &mdash; the teeth on a proper flea comb are spaced to catch an adult flea and the dirt, which is what you are actually trying to see on the white paper. It is the cheapest item in this entire protocol and the one that tells you whether to spend anything else at all: <BuyLink tag={AMZ_TAG} search="flea comb">check flea combs on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p>If you are replacing one, buy for the next infestation rather than this one: a bed with a removable cover that goes through a 60&thinsp;&deg;C wash and a high-heat dryer turns the worst harbourage in the house into a fifteen-minute laundry job, which is the difference between doing this protocol once and doing it every spring. <BuyLink tag={AMZ_TAG} search="washable pet bed removable cover">check washable pet beds on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p>Given that the vacuum is doing more of the work than the bottle is, it is worth being honest about whether yours is up to it. A bagged sealed-HEPA machine with a working beater bar is the one piece of equipment that pays for itself across this job and the next one, because daily vacuuming for three weeks is the step people abandon when the machine is annoying to empty: <BuyLink tag={AMZ_TAG} search="bagged hepa vacuum cleaner">check sealed-HEPA vacuums on Amazon.ca &rarr;</BuyLink></p>
