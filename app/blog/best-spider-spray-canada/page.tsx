    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="not-prose text-gray-700">That has a purchasing consequence people miss. For web-sitters, the tool that beats every spray on this page is a vacuum with a hose and a crevice tool &mdash; it lifts the spider, the web, and the egg sac in one pass, which no residual reaches. A cordless handheld with a long wand is the one that actually gets used on ceiling corners and basement joists, because hauling a full canister up the stairs is how the job gets postponed to next weekend. Empty it outside straight afterwards. <BuyLink tag={AMZ_TAG} search="handheld cordless vacuum">Check cordless handheld vacuums on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p className="not-prose text-gray-700">Thresholds deserve a second look while you are down there, because they are the one line on that list you can close permanently. A residual band under an exterior door fades in weeks; a door sweep fitted to the same gap keeps wandering males out for years, which is why it outranks the can in our sequence. Measure the door width and the gap height before ordering &mdash; brush sweeps suit uneven or worn thresholds, rubber ones suit flat and true. <BuyLink tag={AMZ_TAG} search="door sweep">Check door sweeps on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p className="not-prose text-gray-700">Of those three, the prey-rich house is the one worth spending money on, because it is the only one that stops the spiders coming back rather than clearing the current batch. Silverfish, springtails, and the other damp-basement prey that recruit spiders all need humidity to persist, so pulling a basement down toward the 50% mark removes the food chain instead of the diners. It is slower than a can of spray and considerably more permanent. Our <Link href="/blog/best-dehumidifier-for-basement-canada">basement dehumidifier comparison</Link> covers sizing for Canadian basements. <BuyLink tag={AMZ_TAG} search="basement dehumidifier">Check basement dehumidifiers on Amazon.ca &rarr;</BuyLink></p>
