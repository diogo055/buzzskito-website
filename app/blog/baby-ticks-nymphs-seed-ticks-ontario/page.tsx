    ...
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl font-extrabold text-brand-900 mb-3">What are baby ticks — nymphs and seed ticks?</h2>
          <p className="speakable text-base text-gray-800 leading-relaxed">
            <strong>Baby ticks come in two stages.</strong> Larvae — commonly called &ldquo;seed ticks&rdquo; — are about 0.5 mm (poppy-seed-sized) with six legs. Nymphs are roughly 1–2 mm with eight legs. Nymphs cause most Lyme disease in Ontario because they are so tiny they go unnoticed. Larvae almost never carry Lyme; nymphs can.
          </p>
        </div>
      </section>
