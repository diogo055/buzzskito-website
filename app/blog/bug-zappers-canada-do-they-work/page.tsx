...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'For Ontario mosquito control, ranked by effectiveness: (1) Professional barrier spray treats the vegetation where mosquitoes rest with a residual product applied according to label directions, re-applied through the season, with tick treatment available as an add-on (from $99 per treatment); (2) BTI dunks/bits in any standing water — kill mosquito larvae before they become biting adults ($30/season); (3) Thermacell on the patio — a manufacturer-rated repellent zone about 15 ft (4.5 m) across around your seating area, roughly $80–$150 in the first year as an approximate figure; (4) Mosquito Magnet propane traps for cottage/rural properties ($850 first year); (5) Skin repellent (picaridin or DEET) for active outdoor use. Bug zappers don\'t make this list because they don\'t meaningfully reduce mosquito populations.',
  },
  {
...
export default function BugZappersCanadaPage() {
  return (
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <ol>
            ...
            <li><strong>Whole-yard barrier spray</strong> — <Link href="/mosquito-control">BuzzSkito&rsquo;s licensed application</Link> treats the vegetation where mosquitoes rest with a residual product applied according to label directions, re-applied through the season, with tick treatment available as an add-on. From $99 per treatment, $549–$994 for full-season programs — GTA homeowners can book the same treatment locally, including <Link href="/vaughan-mosquito-control">mosquito control in Vaughan</Link>.</li>
          ...
          <p>Item one is the cheapest line on that list by an order of magnitude, and it is the one a zapper cannot substitute for at any wattage: a BTI dunk dropped into a rain barrel, a pond edge, a blocked catch basin or a tarp puddle acts on the larvae in the water rather than on adults in the air. Follow the label for the volume of water each dunk covers. <BuyLink tag={AMZ_TAG} search="mosquito dunks bti">check BTI dunks on Amazon.ca &rarr;</BuyLink></p>
          <p>Item three is the one that changes tonight rather than next month. Because a zapper is a device you deliberately hang 15 to 25 feet away from where you sit, the seating area itself is left with nothing &mdash; and a butane or rechargeable repeller is the format built to cover exactly that patch of patio. <BuyLink tag={AMZ_TAG} search="thermacell mosquito repeller">check patio repellers on Amazon.ca &rarr;</BuyLink></p>
          ...
          <table className="min-w-[560px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Professional barrier spray</strong></td><td className="px-3 py-2">$549–$994/season</td><td className="px-3 py-2">Whole yard, re-treated through the season</td><td className="px-3 py-2">Low (targeted)</td></tr>
            </tbody>
          </table>
          ...
          <p>That last clause is where most installs quietly go wrong, because 15 to 25 feet of clearance is further from the house than people picture and the indoor cord from the garage shelf is what ends up bridging the gap. An outdoor-rated cord in the right gauge for the run is the correct part for a device that lives in the rain all summer. <BuyLink tag={AMZ_TAG} search="outdoor extension cord">check outdoor extension cords on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p>It is also the part owners forget entirely. A UV-A tube dims long before it fails outright, so a three-year-old zapper is still humming away while catching a fraction of what it did in its first season &mdash; the owner concludes the device was never any good, when what actually expired was the bulb. Match the replacement tube to your model number rather than to the wattage alone. <BuyLink tag={AMZ_TAG} search="bug zapper replacement bulb">check replacement UV tubes on Amazon.ca &rarr;</BuyLink></p>
          ...
          <p>So the Canadian regulator has not measured whether your zapper works, but it has decided what the box is allowed to say &mdash; and what it requires the outdoor box to say is that the thing does not control mosquitoes. Separately, the residual insecticide used in a licensed barrier application sits on a different track again: it carries a PCP registration number under the Act and is applied by a licensed technician according to its label, rather than relying on a device exemption.</p>
          ...
          <ul>
            ...
            <li><strong>Pest control products must be registered under the Pest Control Products Act and carry a PCP number.</strong> Health Canada &mdash; the rule that applies to the residual insecticide a licensed applicator sprays.</li>
      ...
      <CTASection heading="Stop Killing Moths · Start Killing Mosquitoes" subtext="Get a free quote for licensed barrier spray. From $99. Products applied according to label directions. Whole-yard coverage." variant="dark" />
    </>
  )
}
