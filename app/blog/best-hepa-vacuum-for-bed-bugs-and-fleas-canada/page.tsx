    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>For the fine, repetitive detail work &mdash; piping, bolt holes, headboard seams &mdash; a corded HEPA handheld is genuinely easier to control than dragging a full canister hose around the bed, which is exactly why it earns its own award above.</p>
