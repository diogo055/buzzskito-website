...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'No. A search of Health Canada’s Pesticide Label Search for products named “Advion” returns zero records, which means it is not registered in Canada in any class — not domestic for consumers, and not commercial for licensed applicators either. The Syngenta cockroach gel bait that does hold a Canadian registration is VANECTO Cockroach Gel Bait (Reg. No. 35686 P.C.P. Act, commercial class, isocycloseram). Listings that ship Advion to Canadian addresses are US-labelled stock, and a US EPA registration confers no legal status here. The screening test is simple: look for a Canadian registration number reading “Reg. No. XXXXX P.C.P. Act” on the label of the unit you actually receive. We cover the whole grey-market question, and the consumer-legal gel and bait-station lane, in our dedicated Advion in Canada guide.',
  },
  {
    question: 'When is a cockroach spray the right tool?',
    answer: 'Three situations. First, crack-and-crevice work: injecting a thin residual into a gap you cannot reach with bait — behind a loose baseboard, a pipe penetration under the sink, an expansion joint — where the spray becomes a treated doorway rather than a broadcast surface. Second, an exterior perimeter band for American and Oriental cockroaches that live outdoors or in sewers and wander in; treating the foundation, door thresholds, utility penetrations and window wells intercepts them before entry — but the product’s own Canadian label decides where you may put it, and provincial rules vary. Ontario’s cosmetic-pesticide ban is narrower than American threads assume: the Ontario government describes it as covering cosmetic use on lawns, gardens, patios, driveways, parks and schoolyards, and states it does not restrict pesticides used against indoor pests or pests that threaten health, safety or the structure of a home. Read the label’s approved sites, then check your province. Third, contact kill on a roach you can see. Outside those three jobs, a spray is usually the wrong instrument for the wrong species.',
  },
  {
    question: 'What does a PCP registration number mean on a Canadian insecticide?',
    answer: 'It is the registration number issued under the Pest Control Products Act, which Health Canada’s Pest Management Regulatory Agency administers, for that exact formulation and that exact label, for sale and use in Canada. It appears on the pack as “Reg. No. XXXXX P.C.P. Act”, usually near the guarantee panel, and the label itself is a legal document — the listed sites, application rates, re-entry advice and first-aid directions are all part of the registration. A product that carries only a US EPA registration number is not registered for sale or use in Canada, regardless of what a marketplace listing says. If you cannot find a PCP number on the actual container, you cannot verify the product is legal for you to use.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes — but not in the form most advice assumes, and this is the single biggest Canadian difference. Boric acid is one of the oldest verified cockroach actives and it is still registered here for consumers, as an enclosed bait station or a gel — not as a loose dust. In Re-evaluation Decision RVD2016-01, Health Canada cancelled every domestic-class boric acid dust, powder and granular formulation over cumulative-exposure concerns: last retail sale 22 July 2018, last legal use 22 July 2019. The domestic uses it kept were enclosed bait stations and spot treatment with gel formulations. Raid Ant, Roach & Earwig Gel Baits (Reg. No. 25735 P.C.P. Act) is one such registered domestic-class boric acid bait sold in Canada. If you want a dust for dry voids, the consumer-legal option in Canada is a registered diatomaceous earth insect dust. Either way the operative word is thin: a visible pile repels roaches and they walk around it. Keep it out of reach of children and pets, and off food-prep surfaces.',
  },
  {
    question: 'Can I use a US cockroach spray I ordered online in Canada?',
    answer: 'If it does not carry a Canadian PCP registration number, no. Health Canada states plainly that it is a violation of the Pest Control Products Act to buy and use unregistered pesticides, and that violators may be subject to enforcement action. This catches many of the aerosols and concentrates that dominate American advice threads. The practical problem is not just legal: without a Canadian label you have no approved directions, no verified rate, no bilingual first-aid information, and no recourse if the product turns out to be repackaged or counterfeit. Registered Canadian options exist for every job on this page.',
  },
  {
  ...
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              ...
              <li>Outdoor perimeter concentrates are governed first by the sites their Canadian label approves, then by provincial rules. Ontario&rsquo;s cosmetic ban is narrower than US threads assume &mdash; per the Ontario government it covers lawns, gardens, patios, driveways, parks and schoolyards, not products used against indoor or health-and-safety pests.</li>
              <li>Boric acid still works, but in Canada it is a consumer product only as a <strong>bait station or gel</strong> &mdash; Health Canada cancelled all domestic-class boric acid dusts and powders in RVD2016-01 (last legal use 2019). For a dry-void dust, buy registered diatomaceous earth.</li>
            ...
            awards={[
              {
                ...
                name: 'Combat Roach Killing Bait Stations (check the pack for a Canadian PCP number)',
                why: 'Bait is the highest-impact roach purchase a Canadian household can make: roaches feed, return to the harbourage, and the delayed-kill active spreads through droppings and shared shelter, killing insects deep in wall voids no aerosol will ever reach. One Canadian caveat American guides never mention — Combat itself no longer holds a Canadian registration. Health Canada\'s Pesticide Label Search lists Combat Roach Killing System (Reg. No. 26519 P.C.P. Act) as Historical, and no product named Combat is currently registered here for cockroaches, so listings shipping it to Canada are US-labelled stock. The registered domestic-class equivalent on Canadian shelves is Raid Ant, Roach & Earwig Gel Baits (Reg. No. 25735 P.C.P. Act, boric acid 2%). Whichever pack arrives, check it for a "Reg. No. ___ P.C.P. Act" number before you use it.',
                ...
                cons: ['Slow by design — judge it over weeks, not overnight', 'Fails if you spray near it or if sanitation is poor', 'Some populations show bait aversion — rotate the bait, not the strategy', 'Combat holds no current Canadian registration — verify the pack, or buy a registered Canadian bait instead'],
              },
              {
                badge: 'Best Crack-and-Crevice Spray',
                name: 'Raid Ant, Roach & Earwig aerosol (the Canadian-registered Raid can)',
                why: 'The spray to own if you own one. Note the Canadian name: the US "Raid Ant & Roach Killer" is registered here as Raid Ant, Roach & Earwig — Reg. No. 30355 P.C.P. Act (cyfluthrin, a pyrethroid, plus pyrethrins and piperonyl butoxide) and Reg. No. 32434 P.C.P. Act, both domestic class and both currently registered per Health Canada\'s Pesticide Label Search. The straw applicator is the entire reason to buy it — product goes into gaps, pipe penetrations and hinge voids instead of along baseboards. One marketplace caveat worth ten seconds of your time: some third-party sellers ship US-labelled SC Johnson stock, so confirm a "Reg. No. ___ P.C.P. Act" number on the can you receive, and send it back if it is missing.',
                search: 'raid ant and roach killer',
                pros: ['Straw applicator puts product in the gap, not on the counter', 'Domestic-class and currently PCP-registered in Canada under the Ant, Roach & Earwig name', 'Genuinely useful for contact kill and sealing off untreatable voids'],
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-white border-b border-emerald-200 py-10 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-xs font-extrabold text-emerald-700 uppercase tracking-wider mb-2">Product Types Compared &middot; Updated September 2026</p>
            ...
            <table className="min-w-[560px] w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="border-b border-navy-50">
                  ...
                  <td className="px-4 py-3 text-gray-700"><strong className="text-amber-700">Label sites first</strong> &mdash; irrelevant to a German cockroach colony indoors. Ontario&rsquo;s cosmetic ban covers lawns and gardens, not health-and-safety or structural pest use, but provincial rules vary</td>
                  <td className="px-4 py-3 text-xs text-gray-500">Check the label&rsquo;s approved sites and your provincial rules</td>
                </tr>
                <tr className="border-b border-navy-50">
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['Outdoor concentrates', 'Apply only to the sites the Canadian label lists; provincial rules vary'],
                  ['Boric acid in Canada', 'Bait stations and gels only — domestic dusts were cancelled (Health Canada RVD2016-01)'],
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p><strong>Before you buy one, there is a Canadian layer the American threads never mention.</strong> Federal PMRA registration is not the only gate, and it is worth being precise about what the second gate actually is, because this is widely mangled online. Ontario and several other provinces restrict the <em>cosmetic</em> use of pesticides &mdash; but Ontario&rsquo;s ban is narrower than it is usually described. The Ontario government states that it applies to cosmetic use on lawns, vegetable and ornamental gardens, patios, driveways, parks and schoolyards, and that it does <em>not</em> restrict pesticides used against indoor pests, or against pests that threaten health, safety or the structure of a home. A band applied to a foundation to stop insects entering a building is not the lawn-and-garden use the ban was written for. What actually governs you is narrower and stricter: <strong>the Canadian label</strong>. A pest control product may only be applied to the sites its approved label lists, at the rates it lists &mdash; and many outdoor concentrates sold in the US have no Canadian registration at all. That is why there is no buy button on this category anywhere on this page: we cannot know your province or your product, and a product being legal to sell federally does not settle whether it is approved for the site you have in mind. Read the label&rsquo;s approved sites and your provincial rules first, and if you are unsure, hire someone licensed &mdash; a certified applicator has access to commercial-class products you do not. (If you have already confirmed a product is permitted where you live, the equipment side is covered in our <Link href="/blog/best-pump-pressure-sprayer-canada">pump sprayer guide</Link>.)</p>
          ...
          <p>Every pest control product legally sold in Canada is registered under the Pest Control Products Act, which Health Canada&rsquo;s Pest Management Regulatory Agency (PMRA) administers, and carries a registration number on the label, formatted as <strong>&ldquo;Reg. No. XXXXX P.C.P. Act&rdquo;</strong>. That number is tied to <em>that exact formulation</em> and <em>that exact label</em> &mdash; the listed sites, rates, precautions, and bilingual first-aid directions. The label is not packaging copy; it is the legal document that governs use.</p>
          ...
          <h2>Registered Dusts: the Quiet Workhorse Nobody Buys (and the Boric Acid Trap)</h2>
          <p>A thin insecticidal dust is the most under-used tool in DIY roach control. The mechanism is elegant: a roach crosses a thin dust film, picks up particles on its legs and antennae, grooms itself compulsively as roaches do, ingests the dust, and dies over several days &mdash; long enough to return to the harbourage first.</p>
          <p><strong>But the Canadian answer to &ldquo;which dust&rdquo; is not the American one, and this trips up almost every roach guide written for this market.</strong> Boric acid has killed cockroaches longer than most modern actives have existed &mdash; and in Canada it is no longer a consumer dust. In <strong>Re-evaluation Decision RVD2016-01</strong>, Health Canada cancelled the domestic-class boric acid dust, powder and granular formulations over concerns about cumulative exposure from multiple sources; the last date of retail sale was 22 July 2018 and the last date of allowable use was 22 July 2019. What Health Canada kept in the domestic class were <em>enclosed bait stations and spot treatment with gel formulations</em> &mdash; which is exactly what a product like Raid Ant, Roach &amp; Earwig Gel Baits (Reg. No. 25735 P.C.P. Act) is: a registered domestic-class boric acid bait, 2% boric acid, still sold here. So boric acid is not banned in Canada. It is simply a bait, not a powder you puff into a void. If a listing offers you a boric acid roach <em>dust</em> for home use, that is not a product with a current Canadian domestic registration behind it.</p>
          <p><strong>For dry voids, the consumer-legal Canadian dust is diatomaceous earth.</strong> It kills by a desiccating mechanism plus ingestion during grooming, and registered domestic-class packs are sold here &mdash; Safer&rsquo;s Ant &amp; Crawling Insect Killer carries Reg. No. 32278 P.C.P. Act (80% diatomaceous earth), and other registered options include Diatomaceous Earth Insect Dust (Reg. No. 32283) and Ortho Bug B Gon Diatom (Reg. No. 32673). Follow the Canadian label on the pack you buy for approved sites and pests.</p>
          ...
          <p><strong>An outdoor perimeter concentrate bought before you have read its Canadian label.</strong> The concentrate that solves a peridomestic roach problem in an American thread often has no Canadian registration at all, and where a registered equivalent exists you may only apply it to the sites its label approves. Provincial rules are a second layer &mdash; though a narrower one than usually claimed: Ontario states its cosmetic ban covers lawns, gardens, patios, driveways, parks and schoolyards, not pesticides used against indoor pests or pests threatening health, safety or a home&rsquo;s structure. Label first, province second. That is why there is no buy button on that category anywhere on this page.</p>
