    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Where a trap genuinely earns its fuel bill is rural and cottage acreage: an open property backing onto marsh, pond or bush, where there is no fence line to spray and the mosquito pressure is structural rather than seasonal. That is the buyer we would hand a propane machine to without hesitation. If you are still comparing the whole category rather than the cost of feeding it, our <Link href="/blog/best-mosquito-trap">best mosquito trap in Canada guide</Link> ranks the machines themselves, and the <Link href="/blog/co2-mosquito-trap-canada">CO2 mosquito trap explainer</Link> covers how the attraction actually works.</p>
          ...
          <ul>
            ...
            <li><Link href="/blog/best-mosquito-trap">The Best Mosquito Traps in Canada, Ranked</Link></li>
