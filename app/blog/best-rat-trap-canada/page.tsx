...
const FAQS = [
  {
    ...
    answer: 'For most Canadian homes, the classic Victor Metal Pedal rat snap trap is the best combination of kill rate, reusability, and cost — a 2-pack covers a typical basement or garage and each trap can be reused for years. If you don\'t want to see or handle the rat, the Victor Electronic Rat Trap kills with a 6,000-volt shock inside an enclosed chamber and signals a catch with an indicator light. The Tomcat rat snap trap is the easiest to set by hand or foot and is the best pick if you find the Victor\'s spring bar intimidating. All three are widely available on Amazon.ca, and because they are traps rather than pesticides — rodent traps are not among the devices prescribed in Schedule 1 of the Pest Control Products Regulations — no PMRA registration applies to them.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, for specific situations. Victor’s published FAQ for the M241 electronic rat trap gives a 6,000-volt shock and up to 50 rats per set of four C batteries. Victor publishes neither a shock duration nor a time-to-death figure, so we do not quote one; retailer listings that cite a two-minute shock cycle are not sourced to Victor. The kill happens inside an enclosed chamber, so you never see the rat and disposal is a tip-into-the-garbage motion — the main reasons people pay 5–8x the price of a snap trap. Limitations: it can\'t be used outdoors — Victor’s support FAQ says the M241 cannot be exposed to the elements at all — batteries weaken in sub-zero garages, and one unit only kills one rat per cycle. Victor does sell a separate weather-resistant outdoor model, the Zapper Max (M460UC), if outdoor electronic trapping is what you need. For an active infestation, several snap traps working simultaneously usually clear a colony faster than one electronic unit.',
  },
  {
    question: 'Is rat poison legal in Canada?',
    answer: 'Some rodenticides are legal for consumers in Canada — but the products most US websites recommend are not. Health Canada’s PMRA states it plainly: domestic class products containing second-generation anticoagulants (brodifacoum, bromadiolone and difethialone) are prohibited. Those actives are registered commercial class only, for professional and agricultural users. The main PMRA-registered consumer option is bromethalin in pre-loaded, child-resistant bait stations sold under the Tomcat brand — Health Canada’s pesticide registry lists the Tomcat Rat Killer Disposable Bait Station (PCP 31970) and the Tomcat Rat Killer Bait Station Advanced Formula (PCP 34876) as current domestic-class registrations for Norway and roof rats. First-generation anticoagulants like chlorophacinone and diphacinone also remain in some domestic products with mandatory tamper-resistant stations. Our rat poison legality guide covers the full rules. For most homeowners, traps are the better first move — no poisoned-carcass odour in walls and no secondary risk to pets or wildlife.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Wear disposable gloves, double-bag the carcass in sealed plastic bags, and place it in your outdoor garbage — do not touch a rat barehanded. Health Canada says never to sweep or vacuum dry droppings, and to dampen droppings and debris with a bleach solution before wiping up; the US CDC publishes the dilution as about 1 part bleach to 9 parts water (roughly 1½ cups per gallon), sprayed until very wet and left to soak five minutes before wiping with paper towels. Wash your hands thoroughly afterwards. Snap traps can be disinfected the same way and reused — a trap that smells like a previous catch site can actually attract the next rat.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Some rodenticides are, but not the ones people assume. Under the EPA\'s 2008 Risk Mitigation Decision covering ten rodenticides, consumer and residential products may no longer contain second-generation anticoagulants — brodifacoum, bromadiolone, difenacoum and difethialone — which are now registered only for commercial and structural pest-control markets. Consumer products must be sold as pre-loaded, tamper-resistant bait stations (weather-resistant too for outdoor, above-ground placement), with consumer packaging capped at one pound. In other words the US and Canada converged on this; they did not diverge. California goes further still: AB 1788 (2020) banned the four second-generation compounds statewide, and AB 2552 (2024) extended that to first-generation anticoagulants.',
  },
  {
    question: 'Are glue traps legal in the United States?',
    answer: 'As of September 2026 there is no statewide glue-trap ban anywhere in the US. Every binding prohibition so far is municipal and in California: West Hollywood was the first city to pass one, with its prohibition in force from 31 May 2024; Ojai adopted its ordinance in March 2024, Culver City followed later that year, and Ventura in 2026 is reported as the largest US city to ban both use and sale. New York City Int. 531, introduced 12 February 2026, would bar sale citywide but is not law. In Albany, Senate bill S.3046 would bar glue traps in state-owned and state-leased buildings, while Assembly bill A.10193 goes much further and would ban their import, manufacture, sale, distribution and use statewide; both are still in committee. The federal Glue Trap Prohibition Act (H.R. 7018) died with the 118th Congress in January 2025. We do not recommend glue boards for rats regardless of legality.',
  },
  {
    question: 'What is the best rat trap for outdoors?',
    answer: 'A rat-sized snap trap inside a lockable, weather-resistant trap station — not a bare trap on the ground. An exposed snap trap outdoors is a non-target hazard to birds, squirrels, chipmunks, cats and curious hands, and rain rusts the spring while wet bait spoils within a day. Anchor the station so a rat cannot drag it, and site it against the foundation, along a fence line, under a deck or raised shed, or beside a burrow entrance. Bucket traps are the other legitimate outdoor option because they are multi-catch and shrug off weather. Most electronic traps are indoor-only — Victor states the M241 cannot be used outdoors at all — but the category is no longer empty: Victor’s Zapper Max (M460UC) is sold as weather- and water-resistant and is rated by the manufacturer for indoor and outdoor use.',
  },
  {
    ...
    <>
      ...
      <section className="bg-white px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <p className="text-gray-800 text-[15px] leading-relaxed font-medium">The best rat trap for most Canadian homes is the classic <AmazonLink search="victor rat trap" tag={AMZ_TAG} className="font-bold underline decoration-emerald-500 underline-offset-2 hover:text-emerald-900">Victor Metal Pedal rat snap trap</AmazonLink> — powerful enough for a 200–500 g Norway rat, reusable for years, and cheap enough to deploy the 4–6 traps a real infestation needs. If you don&rsquo;t want to see or handle a dead rat, the Victor Electronic Rat Trap kills inside an enclosed chamber with a 6,000-volt shock (Victor’s own published figure).</p>
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              ...
              <li>Victor rates the M241 electronic rat trap at up to 50 kills per set of 4 C batteries, with a 6,000-volt shock.</li>
              ...
              <li>Second-generation anticoagulant rodenticides (brodifacoum, bromadiolone, difethialone) are NOT sold domestic-class in Canada &mdash; Health Canada&rsquo;s PMRA prohibits domestic-class products containing them; they are commercial class only.</li>
          ...
          <AwardRow tag={AMZ_TAG}
            ...
            awards={[
              ...
              },
              {
                ...
                why: 'Lures the rat into an enclosed tunnel and delivers a 6,000-volt shock, Victor’s own published figure. An indicator light signals a catch and disposal is a tip-into-the-garbage motion, so you never see or handle the rat.',
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Three traps cover essentially every home situation, and all three are traps rather than pesticides &mdash; rodent traps are not among the devices prescribed in Schedule 1 of the Pest Control Products Regulations, so no PMRA registration applies &mdash; and they are safe to use in kitchens, basements, and garages when placed sensibly.</p>
          ...
          <p>The Victor Electronic Rat Trap lures the rat into an enclosed tunnel and delivers a 6,000-volt shock. That figure comes from Victor&rsquo;s own published M241 FAQ; Victor publishes neither a shock duration nor a time-to-death, so we do not invent either. A green indicator light signals a catch, and disposal is tipping the chamber over the garbage without ever seeing the animal. Four C batteries yield roughly 50 kills. The trade-offs: it costs several times what a snap trap does, it&rsquo;s indoor-only &mdash; Victor&rsquo;s support FAQ states the M241 cannot be used outdoors because its batteries and electronics cannot be exposed to the elements, and Victor&rsquo;s weather-resistant Zapper Max (M460UC) is the separate model rated for outside &mdash; battery output drops in freezing garages, and one unit handles one rat at a time. It shines for a light infestation — one or two rats — in a kitchen, apartment, or finished basement where squeamishness would otherwise stop you from trapping at all. We reviewed the mouse-sized version separately in our <Link href="/blog/victor-electronic-mouse-trap-review-canada">Victor electronic mouse trap review</Link>; the rat unit is the same concept scaled up.</p>
          ...
          <table className="min-w-[560px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Victor Electronic</strong></td><td className="px-3 py-2">Battery kill chamber</td><td className="px-3 py-2">6,000 V shock, enclosed chamber</td><td className="px-3 py-2">~50 kills per battery set</td><td className="px-3 py-2">No-touch, no-see indoor trapping</td></tr>
          ...
          <ul>
            ...
            <li><strong>Predator scent &mdash; unreliable.</strong> Fox, coyote and cat urine products are sold on the premise of an innate fear response. Rodents habituate to a static scent source quickly, and Health Canada&rsquo;s pesticide registry lists no predator-scent product registered in Canada for repelling rats or mice at all. Do not build a plan around them.</li>
          </ul>
          ...
          <p>Outdoors is where most electronic traps stop being an option. Victor&rsquo;s own support FAQ answers it flatly: an electronic trap cannot be used outdoors, because its batteries and electronic components cannot be exposed to the elements. Battery output also falls off sharply in a freezing garage. There is one genuine consumer exception &mdash; Victor&rsquo;s Zapper Max outdoor electronic rat trap (M460UC), which the manufacturer sells as weather-resistant and water-resistant for indoor and outdoor use &mdash; so &ldquo;outdoor electric rat trap&rdquo; is no longer an empty category. For most yards, a snap trap in a weatherproof station is still the cheaper and more forgiving answer.</p>
          ...
          <table className="min-w-[640px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Outdoor use</strong></td><td className="px-3 py-2">Only inside a weatherproof station</td><td className="px-3 py-2">Only inside a weatherproof station</td><td className="px-3 py-2">No &mdash; the M241 is indoor only; the outdoor Zapper Max is a separate model</td></tr>
          ...
          <p>Here&rsquo;s where Canadian and American advice diverge sharply, and where we refuse to follow the US playbook. The rodenticides most US sites recommend — <strong>second-generation anticoagulants</strong> like brodifacoum, bromadiolone, and difethialone (the classic &ldquo;one-feed&rdquo; green blocks) — are <strong>not legal for consumer sale in Canada</strong>. Health Canada&rsquo;s PMRA is explicit that domestic class products containing second-generation anticoagulants (brodifacoum, bromadiolone and difethialone) are prohibited, because of poisoning risk to children, pets, and the owls and hawks that eat poisoned rodents. We checked Health Canada&rsquo;s own pesticide product registry in September 2026: it lists no current domestic-class registration for any of the three &mdash; every one is commercial, restricted or technical class, for professional and agricultural users. US retail sites and marketplace sellers will still happily ship them north. We will not recommend any of those products: importing or using a pesticide that isn&rsquo;t PMRA-registered for domestic use is illegal under the Pest Control Products Act, and secondary poisoning of raptors is exactly why the rule exists.</p>
          <p>What consumers CAN legally buy in Canada: <strong>bromethalin</strong> (a non-anticoagulant neurotoxicant) in pre-loaded, child-resistant bait stations sold under the Tomcat brand &mdash; the registry lists the Tomcat Rat Killer Disposable Bait Station as PCP 31970 and the Advanced Formula station as PCP 34876, both domestic class and both labelled for Norway and roof rats &mdash; plus first-generation anticoagulant products (chlorophacinone, diphacinone, warfarin) that remain registered domestic class and that Health Canada requires to be sold and used inside bait stations. Even then, we&rsquo;d reach for traps first in almost every home scenario — poisoned rats routinely die inside wall voids, and the odour of a decomposing 400-gram rat in a wall lasts weeks. The full legal picture, including what to do about grey-market listings, is in our companion guide: <Link href="/blog/rat-poison-canada-what-is-legal">rat poison in Canada — what is actually legal</Link>.</p>
          ...
          <p><strong>What a US consumer can legally buy:</strong> pre-loaded, child- and dog-resistant bait stations, used strictly according to the label. The EPA is specific about what is inside them: the bait in ready-to-use stations currently registered for the consumer market contains one of just three actives &mdash; <strong>bromethalin, chlorophacinone or diphacinone</strong>. Cholecalciferol and zinc phosphide products exist, but for professional, structural and agricultural markets rather than the consumer shelf. That is a close cousin of the Canadian position described above, where PMRA-registered domestic products are dominated by bromethalin in disposable stations.</p>
          ...
          <p><strong>As of September 2026, there is no statewide glue-trap ban anywhere in the US.</strong> Every binding prohibition so far is municipal and in California: West Hollywood was the first city to pass one, with its prohibition in force from 31 May 2024; Ojai adopted its ordinance in March 2024, Culver City followed later that year, and Ventura in 2026 is reported as the largest US city to ban both use and sale. Everywhere else, they remain legal to buy.</p>
          <p>Two things are pending rather than law, and it is worth keeping them straight. New York City Council Int. 531, introduced 12 February 2026, would bar the sale of glue traps citywide. The two Albany bills are not the same as each other: Senate bill S.3046 would prohibit glue traps in state-owned and state-leased buildings, while Assembly bill A.10193 would ban their import, manufacture, sale, distribution and use across the whole state. Both remain in committee. At the federal level, the Glue Trap Prohibition Act (H.R. 7018) died with the 118th Congress in January 2025 and would need reintroduction. If you are in Los Angeles County, check your own city &mdash; the boundary between a city that has banned them and one that has not can be a single street.</p>
          ...
          <p>No — not as a control method. Controlled studies consistently show rodents habituate to ultrasonic emitters within days, and a Canadian registration number on the box proves nothing about whether one works. Devices that repel pests by sound are prescribed devices under Schedule 1 of the Pest Control Products Regulations, so they do carry PMRA registrations &mdash; the Tomcat Ultrasonic Rodent Repeller is PCP 33070 &mdash; but Health Canada&rsquo;s registry records them as &ldquo;device, no guarantee required&rdquo;, meaning no efficacy claim was ever assessed. Money spent on plug-in repellers is better spent on more snap traps and a tube of exclusion sealant. We break down the research in detail in <Link href="/blog/ultrasonic-pest-repellers-do-they-work">ultrasonic pest repellers — do they work?</Link></p>
          ...
          <table className="min-w-[620px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Victor Electronic Rat Trap</strong></td><td className="px-3 py-2"><strong>M241</strong></td><td className="px-3 py-2">The enclosed-chamber unit described above. Victor publishes 6,000 volts and four C batteries for the M241; the current retail revision, the M241B, runs on four AA batteries and is rated to about 35 rats per set</td></tr>
