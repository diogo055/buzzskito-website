      ...
      <section className="bg-white px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <p className="text-gray-800 text-[15px] leading-relaxed font-medium">For most Canadian households, <AmazonLink search="executioner fly swatter racket" tag={AMZ_TAG} className="font-bold underline decoration-emerald-500 underline-offset-2 hover:text-emerald-900">The Executioner</AmazonLink> is the best electric fly swatter — its single-layer zinc-steel grid at roughly 3,000 volts kills flies, mosquitoes, and wasps on the first swing. Families with young kids should choose the Zap It 4,000-volt USB-rechargeable racket for its three-layer safety mesh.</p>
            ...
            <div className="mt-4">
              <BuyLink search="executioner fly swatter racket" tag={AMZ_TAG} block className="sm:w-auto sm:min-h-0 sm:inline-flex sm:rounded-full sm:px-4 sm:py-2">Check price on Amazon.ca →</BuyLink>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <div className="not-prose overflow-x-auto my-4">
            <table className="w-full min-w-[860px] text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>The Executioner</strong></td><td className="px-3 py-2">~2,800–3,200V</td><td className="px-3 py-2">Single layer — open live grid</td><td className="px-3 py-2">2× AA</td><td className="px-3 py-2">First-swing kills on flies &amp; wasps · adults-only households</td><td className="px-3 py-2"><BuyLink tag={AMZ_TAG} search="executioner fly swatter racket" className="!px-3 !py-1.5 !text-xs whitespace-nowrap">Check price on Amazon.ca</BuyLink></td></tr>
                <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Executioner Pro</strong></td><td className="px-3 py-2">~3,000V+ (hotter C-cell zap)</td><td className="px-3 py-2">Single layer — open live grid</td><td className="px-3 py-2">2× C</td><td className="px-3 py-2">Cottages, cluster flies, extra reach (55 cm+)</td><td className="px-3 py-2"><BuyLink tag={AMZ_TAG} search="executioner pro fly swatter" className="!px-3 !py-1.5 !text-xs whitespace-nowrap">Check price on Amazon.ca</BuyLink></td></tr>
                <tr className="border-t border-navy-50"><td className="px-3 py-2"><strong>Zap It (rechargeable)</strong></td><td className="px-3 py-2">4,000V</td><td className="px-3 py-2">3-layer safety mesh</td><td className="px-3 py-2">USB-rechargeable lithium (~10,000 zaps/charge)</td><td className="px-3 py-2">Families with kids · bedroom mosquito hunts (built-in LED)</td><td className="px-3 py-2"><BuyLink tag={AMZ_TAG} search="zap it electric fly swatter 4000 volt usb rechargeable" className="!px-3 !py-1.5 !text-xs whitespace-nowrap">Check price on Amazon.ca</BuyLink></td></tr>
