    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The same damp-basement conditions that keep DE from working are what put earwigs, silverfish and centipedes in the same rooms every August, so the products overlap more than the pest names suggest &mdash; our <Link href="/blog/best-silverfish-traps">silverfish trap comparison</Link> and <Link href="/blog/best-centipede-killer-canada">centipede killer breakdown</Link> both come back to the same humidity target. For the earwig-specific shelf, the ranked picks live in <Link href="/blog/best-earwig-killer-canada">what actually kills earwigs in Canada</Link>.</p>
          <ul>
