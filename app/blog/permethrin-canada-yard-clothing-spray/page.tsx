...
const FAQS = [
  {
    ...
    answer: 'Yes — permethrin is legal in Canada and registered for use here under the Pest Control Products Act. The catch is the format, and this is the nuance most guides miss: Health Canada has NOT approved permethrin liquids or sprays sold for consumers to treat their OWN clothing, so a spray-on clothing treatment is not a PMRA-registered Canadian consumer product. Factory pre-treated permethrin clothing IS permitted here, for ages 16 and over, and is legal to buy and wear. Separately, higher-concentration permethrin YARD/lawn concentrates are classified as commercial or restricted-class products and can only be legally applied by a licensed pest control operator, so a homeowner may not spray concentrated permethrin on their own lawn either.',
  },
  {
    question: 'Where to buy permethrin spray in Canada?',
    answer: 'This is where most guides, including an earlier version of this one, get Canada wrong. Health Canada has not approved consumer permethrin liquids or sprays for treating your own clothing, so a spray-on clothing treatment is not a PMRA-registered Canadian retail product and should not be expected on a Canadian shelf. What IS permitted and sold here is factory pre-treated permethrin clothing, for ages 16 and over. Permethrin yard concentrate (for outdoor application) is more restricted in Canada — Health Canada PCP regulations limit residential availability. Most yard-application permethrin in Canada is restricted to licensed pest control operators using commercial concentrations.',
  },
  {
    question: 'Where can I buy permethrin concentrate in Canada?',
    answer: 'Concentrated permethrin (10%–36.8% formulations like Permethrin SFR or Martin\'s 10%) that you dilute for yard spraying is NOT sold to consumers in Canada — Health Canada PMRA classifies these as commercial-class or restricted-class products that require a licensed applicator. US retailers such as Home Depot, Tractor Supply, and DoMyOwn stock permethrin concentrate for homeowners, but those products cannot be legally imported and applied to a Canadian residential lawn. Consumer spray-on clothing treatment is not an approved Canadian format either — the permethrin format Canada does permit for personal protection is factory pre-treated clothing. For diluted-concentrate-style whole-yard coverage, hire a licensed Ontario applicator who applies PCP-registered barrier-spray products according to label directions.',
  },
  {
    question: 'Can you spray permethrin on your yard or lawn in Canada?',
    answer: 'Not as a homeowner. The permethrin route Canada permits for personal protection is treated clothing and gear, not turf — and the concentrated yard formulations that ARE labelled for turf are restricted to licensed applicators. Ontario\'s Cosmetic Pesticides rules further limit what can be applied to residential lawns. To legally treat your whole yard for mosquitoes and ticks you must hire a licensed Ontario pesticide operator (like BuzzSkito, Licence #L-240-2436835197), who applies PCP-registered barrier-spray products according to label directions, renewed on a schedule through the season.',
  },
  {
    question: 'How much does permethrin cost in Canada?',
    answer: 'Permethrin clothing SPRAY has no Canadian consumer price, because Health Canada has not approved that format for sale here — it is not a registered Canadian retail product, so any price you see quoted for it is either a US price or an invention. Permethrin-treated clothing (Sawyer Insect Shield brand) costs $40–$120 per garment depending on style. Yard-application permethrin concentrate is mostly NOT available to Canadian consumers — Health Canada restricts higher-concentration formulations to licensed applicators. Professional barrier spray treatments by licensed Ontario operators (which use PCP-registered bifenthrin-based formulations) start from $99 per treatment on a standard lot under 10,000 sq ft.',
  },
  {
    question: 'Can I buy permethrin yard spray in Canada?',
    answer: 'Mostly no — Health Canada (PMRA) restricts higher-concentration permethrin yard products to licensed pest control operators in most provinces. The permethrin products you will find over the counter in Canadian retailers are labelled for structural, garden and livestock use rather than for lawns, and the permitted personal-protection format here is factory pre-treated clothing rather than a spray you apply to fabric yourself. For residential yard treatment using registered active ingredients, you have two options: (1) hire a licensed Ontario pesticide applicator like BuzzSkito for professional barrier spray, or (2) use registered consumer alternatives like BTI (mosquito dunks/bits) for larvae and Thermacell devices for personal repellent zones.',
  },
  {
    question: 'Is permethrin safe for kids, pets, and skin?',
    answer: 'For people, the Canadian format is factory-treated clothing used as directed — and Health Canada\'s conditions say permethrin-treated clothing is intended for people 16 and older and should be kept away from young children who might chew treated fabric. Permethrin in dog spot-ons is a separate, dog-labelled product used at label doses. Permethrin is HIGHLY TOXIC to CATS — even small exposure can cause tremors, seizures, and death. If you have cats, do not apply liquid permethrin spray indoors and let treated clothing fully dry (24+ hours) before bringing it into a cat-occupied home. Permethrin is also toxic to fish — keep away from ponds, streams, and aquariums. Pollinators (bees) are sensitive — apply only when bees are not active and never spray directly on flowering plants.',
  },
  {
    question: 'How long does permethrin clothing spray last?',
    answer: 'Spray-on permethrin treatment bonds to fabric fibres and remains effective through 6 wash cycles or approximately 6 weeks of daily wear. In Canada that figure matters mainly as a comparison, because Health Canada has not approved consumer spray-on clothing treatment here: factory-treated permethrin clothing manufactured by Insect Shield lasts up to 70 wash cycles, and is the format Canada actually permits. After the treatment wears off, you can keep wearing the clothing — you simply lose the tick/mosquito repellent benefit.',
  },
  {
    question: 'Is permethrin effective against ticks?',
    answer: 'Yes — permethrin is one of the most effective tick deterrents available. Unlike DEET (which repels), permethrin kills ticks on contact with treated clothing. CDC research consistently shows 95%+ reduction in tick bites for hikers wearing permethrin-treated pants, socks, and boots compared to untreated clothing. For Ontario hikers in tick-active areas (Oak Ridges Moraine, Niagara Escarpment, Bruce Trail, Algonquin), permethrin-treated pants and socks are the gold standard for personal tick prevention. Permethrin belongs on clothing, never on skin.',
  },
  {
    question: 'Permethrin vs DEET vs Picaridin — what is the difference?',
    answer: 'Different applications, different chemistry. PERMETHRIN goes on CLOTHING (not skin) — kills ticks and mosquitoes on contact through fabric. DEET (20–30%) goes on SKIN — repels biting insects but doesn\'t kill them. PICARIDIN (20%) also goes on SKIN — similar repellent effect to DEET, less greasy, doesn\'t damage plastics or fabrics. Best combination for Ontario hiking: permethrin on clothing + DEET or picaridin on exposed skin. For sitting on a patio, neither permethrin nor DEET is ideal — Thermacell or professional yard barrier spray is the better fit for stationary outdoor use.',
  },
  {
  ...
  },
  {
    ...
    answer: `Some licensed applicators use permethrin-based products for specific commercial applications (mosquito abatement contracts, golf course turf), but the most common active ingredient used in Ontario residential mosquito barrier spray is bifenthrin or deltamethrin — both with PCP-registered products labelled for residential use against mosquitoes and ticks. BuzzSkito applies every residential treatment according to product label directions, under ${PROMISES.licence}.`,
  },
  {
    question: 'Where can I buy permethrin near me in Canada?',
    answer: 'Locally, the permethrin option Canada actually permits is factory pre-treated clothing — the Wind River No Fly Zone line sold through Mark\'s is the established Canadian example. Consumer spray-on clothing treatments are not approved for use in Canada, so a Canadian shelf is not where you will find them. Yard-application permethrin concentrate is not sold to consumers anywhere in Canada — Health Canada PMRA restricts it to licensed applicators. For whole-yard tick and mosquito treatment, hire a licensed Ontario operator instead.',
  },
  {
    question: 'Where do you buy Sawyer permethrin spray in Canada?',
    answer: 'Consumer permethrin clothing sprays are not approved for use in Canada, so Canadian chains do not stock them as a registered consumer product. The permitted Canadian route is factory pre-treated clothing, which carries a PMRA-required lining between the treated fabric and your skin and is marketed here for mosquitoes. Treated clothing protects the person wearing it — it is not a lawn treatment, and permethrin never goes on skin.',
  },
  {
    question: 'How do you get permethrin in Canada?',
    answer: 'For clothing use, buy factory pre-treated permethrin garments — that is the format Canada permits for consumers. What you cannot get here as a registered consumer product is a permethrin liquid or spray sold for you to treat your own clothing; Health Canada has not approved that format, so there is no compliant Canadian purchase of it. What you also cannot legally get in Canada is yard/turf permethrin concentrate: Health Canada PMRA classifies it as commercial- or restricted-class, so only a licensed applicator can obtain and apply it. For whole-yard treatment, book a licensed Ontario operator like BuzzSkito.',
  },
  {
    question: 'Why is permethrin not on Canadian store shelves?',
    answer: 'Permethrin clothing SPRAY is not approved for consumer use in Canada, so it is not a registered product on Canadian shelves — pre-treated clothing is the permitted format here. What you also will not find is yard/turf permethrin concentrate: Health Canada\'s Pest Management Regulatory Agency (PMRA) classifies higher-concentration formulations as commercial- or restricted-class, so they are kept off consumer shelves and reserved for licensed applicators. The US EPA allows the same concentrations in retail packaging, which is why they appear at US stores but not Canadian ones.',
  },
  {
    question: 'Is permethrin illegal in Canada?',
    answer: 'No — permethrin is not illegal in Canada, and that is the wrong question to ask. Permethrin is registered in Canada across structural, garden, agricultural and veterinary uses, and Health Canada\'s Pest Management Regulatory Agency (PMRA) re-confirmed those registrations in Re-evaluation Decision RVD2019-11 (26 August 2019). The right question is which FORMAT is permitted for which USE. Health Canada has not approved any permethrin liquid or spray sold for consumers to treat their own clothing, and per RVD2019-11 the household permethrin products that ARE registered here are expressly not labelled for clothing, furniture, mattresses, linens or toys. So permethrin is legal; consumer clothing-treatment spray is the specific thing Canada has not approved.',
  },
  {
    question: 'Can you buy permethrin spray in Canada?',
    answer: 'You can buy permethrin sprays in Canada — just not the clothing kind. Ready-to-use permethrin sprays with Canadian PCP registration numbers, labelled for structural and garden use, are sold at Canadian retail (Wilson CrawlOut Indoor/Outdoor at Canadian Tire is the most widely stocked example), and Canadian-made permethrin concentrates such as Garden+ Protector from Superior Control Products are sold direct to consumers through garden retailers. What Health Canada has not approved is a permethrin liquid or spray sold for you to treat your own clothing — which is why Sawyer is not on a Canadian shelf. Always check for a Canadian PCP registration number on the label and confirm your use site is listed before you buy.',
  },
  {
...
export default function PermethrinCanadaPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(blogPostingSchema({ title: TITLE, description: 'Comprehensive 2026 guide to permethrin in Canada — where to buy, legal status, permitted pre-treated clothing vs unapproved consumer spray vs restricted yard concentrate.', slug: SLUG, datePublished: DATE, dateModified: UPDATED })) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 via-brand-900 to-emerald-900 text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="speakable rounded-xl bg-white/10 border border-white/20 p-4 mb-4 max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-white leading-relaxed">Permethrin is registered in Canada, but the format decides what you may actually buy. Health Canada states that permethrin liquids and sprays for consumers to treat their own clothing are NOT approved here; factory pre-treated permethrin clothing IS permitted, for ages 16 and over. Higher-concentration yard and turf concentrate is restricted &mdash; only a licensed Ontario applicator may spray it on your lawn.</p>
          </div>
          <p className="text-xl text-brand-100 max-w-3xl">Which permethrin format Canadians can legally buy, why Health Canada has not approved a consumer clothing spray, why yard-application is restricted, and the licensed Ontario alternative for whole-yard tick and mosquito control.</p>
      ...
      <section className="bg-white px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <p className="text-gray-800 text-[15px] leading-relaxed font-medium">For most Canadians the permitted permethrin option is factory pre-treated clothing, not a spray you apply yourself: Health Canada has not approved consumer permethrin liquids or sprays for treating your own clothing. Higher-concentration yard concentrate is restricted to licensed applicators, so whole-yard treatment means hiring a licensed Ontario operator.</p>
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              <li>A consumer spray-on clothing treatment is not a format Health Canada permits for consumers &mdash; there is no Canadian-registered version of it to price.</li>
              <li>Factory-treated permethrin clothing stays effective for 70 wash cycles; spray-on treatment lasts about 6.</li>
              ...
              <li>Licensed Ontario barrier spray (bifenthrin/deltamethrin) starts at $99 per treatment and is re-applied on a schedule.</li>
            </ul>
            <p className="mt-3 text-xs text-gray-500">&mdash; BuzzSkito, GTA mosquito &amp; tick control · 150+ five-star Google reviews</p>
          </div>
          {/* Service arm takes the top slot on this GTA-relevant page: quote CTA above
              the first affiliate module (the AwardRow below), per the service-arm rule. */}
          <BlogPostCTA />
          <aside aria-label="What to do right now" className="not-prose my-8 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-5 sm:p-6">
            ...
            <p className="text-[15px] text-gray-800 leading-relaxed mb-4">You came looking for a spray you cannot legally buy here. That does not leave you without a plan before the weekend &mdash; it changes which three things the plan is made of.</p>
            <ol className="space-y-5 list-none pl-0 m-0">
              <li>
                <p className="font-bold text-brand-900 mb-1">1. Change what you wear and what you do afterwards &mdash; free, and it needs no registration</p>
                <p className="text-[15px] text-gray-800 leading-relaxed">Tuck trousers into socks so a tick has no gap to climb through, and wear light colours so a poppy-seed-sized nymph is visible on the fabric while it is still walking. When you get home, do a full-body check &mdash; scalp, behind the ears, waistline, behind the knees &mdash; and put the clothes straight into a hot dryer for ten minutes before they go anywhere near the wash. The Centers for Disease Control and Prevention advises tumble-drying dry clothing on high heat for ten minutes to kill ticks on it; a cold wash does not.</p>
              </li>
              <li>
                <p className="font-bold text-brand-900 mb-1">2. For skin, a repellent Health Canada actually registers</p>
                <p className="text-[15px] text-gray-800 leading-relaxed mb-3">Permethrin never goes on skin in any country &mdash; it is a fabric treatment. Skin is DEET or icaridin (picaridin), and both are registered here with their own age rules: no DEET under six months, 10% for ages six months to twelve years, up to 30% for twelve and over; icaridin carries no upper concentration limit in Canada and the Canadian Paediatric Society recommends it first for children six months to twelve years. Look for the PCP registration number on the label.</p>
                <BuyLink tag={AMZ_TAG} search="icaridin insect repellent">Check price on Amazon.ca &rarr;</BuyLink>
              </li>
              <li>
                <p className="font-bold text-brand-900 mb-1">3. For fabric, the treated-clothing format Canada does permit</p>
                <p className="text-[15px] text-gray-800 leading-relaxed mb-3">Factory pre-treated permethrin clothing is a different regulatory object from a bottle of pesticide, and it is permitted here for ages 16 and over &mdash; the permethrin is bonded at the factory, so there is no liquid to handle and nothing to reapply each season. Buy it as the trousers and socks you actually walk in rather than as a wardrobe; that is where a tick makes contact first.</p>
            ...
            awards={[
              {
                ...
                why: 'Factory pre-treated clothing is the permethrin format Canada permits for consumers, and Insect Shield is the treatment behind garments from outdoor brands (ExOfficio, Orvis, Columbia). The bonded permethrin survives 70 wash cycles — versus 6 for a spray-on treatment. Higher upfront cost, far lower long-term cost for frequent hikers.',
                search: 'insect shield permethrin treated clothing',
                score: 8.4,
                featured: true,
                pros: ['The permitted Canadian route — no unregistered format involved', 'Protection lasts 70 wash cycles — no annual respray', 'No handling of liquid permethrin at all', 'Wide range of garment styles'],
                cons: ['$40–$120 per garment adds up across a wardrobe', 'Covers only the garments you buy — boots, packs, and tents stay untreated'],
              },
              {
                badge: 'Best Canadian-Shelf Buy',
                name: 'Wind River No Fly Zone (Mark’s)',
                why: 'The permethrin-treated clothing line that reached Canadian retail in 2018 — shirts, pants, hoodies and socks built on Burlington’s No Fly Zone treatment technology, with the permethrin bonded at the factory. Sold at Mark’s, so it is the domestic answer for someone who wants permethrin protection bought in a Canadian store, and it is now marketed as tick and mosquito repellent clothing.',
                pros: ['Sold in Canadian stores — a domestic purchase, not a cross-border one', 'Carries the PMRA-required lining between treated fabric and skin', 'Factory-bonded, so there is no liquid permethrin to handle'],
                cons: ['Covers only the garments you buy — nothing for a yard, a patio, or kids on the lawn', 'The mandatory liner can make garments feel heavier than an American equivalent in the same weight class'],
              },
            ]}
            whichToBuy={
              <>
                <strong>Want the format Canada actually permits?</strong> Start with <em>Best Overall</em> factory pre-treated clothing &mdash; bonded for 70 wash cycles, and the only permethrin route Canada permits for personal protection here. Buy it as the pants and socks you hike in most. <strong>Want to buy it in a Canadian store?</strong> <em>Best Canadian-Shelf Buy</em> Wind River No Fly Zone at Mark&rsquo;s is the line sold domestically. <strong>Came here looking for a spray-on clothing treatment?</strong> There is deliberately no pick for it: Health Canada has not approved permethrin liquids or sprays sold for consumers to treat their own clothing, so we will not recommend one at any price. And if you came here for <strong>yard permethrin concentrate</strong>: it is not sold to Canadian consumers at any price &mdash; whole-yard treatment legally requires a licensed applicator, which is what our <Link href="/mosquito-control">licensed barrier spray service</Link> covers from $99.
              </>
            }
          />
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <table className="min-w-[560px] w-full text-sm">
              <thead className="bg-brand-800 text-white">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left">Permitted for consumers in Canada?</th>
          ...
          <div className="mt-5 rounded-xl bg-rose-50 border-l-4 border-rose-400 p-4">
            <p className="text-sm text-gray-800 leading-relaxed">
              <strong className="text-rose-900">⚠️ Permethrin yard spray is RESTRICTED in Canada.</strong> Health Canada PMRA limits yard-application permethrin concentrations to licensed applicators. For whole-yard tick and mosquito treatment, you need either: (1) a licensed Ontario operator applying PCP-registered residential formulations per the label, or (2) BTI bits/dunks for standing-water larvae plus a Thermacell for personal repellent zones. <Link href="/mosquito-control" className="text-emerald-700 underline font-semibold">Get a quote for licensed barrier spray</Link> from BuzzSkito (Ontario Pesticide Operator Licence #L-240-2436835197).
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['Sold in Canada', 'Factory pre-treated clothing (consumer); PMRA-registered structural, garden and livestock products; restricted concentrations to licensed applicators only'],
                  ...
                  ['Dog products', 'Dog-labelled spot-ons only, at label doses — keep liquid products away from pets'],
                  ['Bee toxicity', 'High — never spray during pollinator activity'],
                  ['Fish toxicity', 'High — never use near ponds/streams'],
                  ['Spray-on treatment duration', '6 wash cycles (~6 weeks daily wear) — not an approved consumer format in Canada'],
                  ['Insect Shield clothing duration', '70 wash cycles (factory-bonded)'],
                  ['Health Canada status', 'Factory pre-treated clothing permitted; consumer clothing spray NOT approved; yard concentrate restricted to licensed applicators'],
                ].map(([k, v]) => (
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="not-prose text-sm text-gray-600 mb-1">The permethrin format Canadians can legally buy for personal protection is factory pre-treated clothing — worn, never sprayed on skin:</p>
          ...
          <p>This is why permethrin is the gold standard for hikers, military personnel, and outdoor workers — DEET only works while it&rsquo;s wet on your skin (a few hours), while permethrin-treated fabric stays active through many washes: about 6 for a spray-on treatment, up to 70 for a factory-treated garment.</p>

          <h2>Is Permethrin Legal in Canada?</h2>
          <p className="speakable"><strong>Yes — permethrin is legal in Canada</strong>, but the legal format depends on how you use it. Factory <strong>permethrin-treated clothing</strong> is legal to buy and wear as a consumer product. A permethrin <strong>liquid or spray sold for you to treat your own clothing</strong> is not — Health Canada has not approved that format for Canadian consumers, so there is no PMRA-registered version of it to buy here. And what is <em>not</em> legal for a homeowner is spraying concentrated permethrin on your own lawn — higher-concentration <strong>yard/turf concentrates</strong> are classified by Health Canada as commercial- or restricted-class products that only a licensed applicator may apply.</p>
          <table className="not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              <tr className="border-t border-navy-50"><td className="px-3 py-2">Consumer 0.5% clothing/gear spray</td><td className="px-3 py-2 text-rose-700 font-semibold">Not approved in Canada</td><td className="px-3 py-2">Pre-treated clothing is the permitted format</td></tr>
          ...
          <p className="text-xs text-gray-500">Coverage is approximate and varies with foliage density and sprayer calibration. In Canada none of these rows is a legal consumer purchase — every one of them requires a licensed applicator, and the ready-to-use consumer clothing spray that US guides usually list alongside them is not an approved Canadian format either. For a legal whole-yard treatment, <Link href="/free-yard-assessment">get a free yard assessment</Link>.</p>

          <h2>What You CAN Buy as a Canadian Consumer</h2>
          <p>One format is missing from this list deliberately: a permethrin liquid or spray sold for you to treat your own clothing. Health Canada has not approved that format for Canadian consumers, so it is not a registered product you can buy here &mdash; which is why the personal-protection entries below are garments rather than bottles.</p>
          <h3>1. Wind River No Fly Zone Treated Clothing (Canadian Retail)</h3>
          <p>The permethrin-treated clothing line that reached Canadian retail in 2018 &mdash; shirts, pants, hoodies and socks with the permethrin bonded at the factory rather than sprayed on at home. Sold at Mark&rsquo;s, so it is the domestic route for someone who wants permethrin protection bought in a Canadian store, and under Canadian rules the garments carry the PMRA-required lining between the treated fabric and your skin.</p>
          <div className="not-prose mb-6 flex flex-wrap gap-3">
            <BuyLink tag={AMZ_TAG} search="insect shield permethrin treated clothing">Shop permethrin-treated clothing on Amazon.ca →</BuyLink>
          </div>
          <h3>2. Insect Shield Factory-Treated Clothing</h3>
          <p>Pre-treated clothing from outdoor brands (ExOfficio, Orvis, Columbia, etc.) using a proprietary permethrin-bonding process. Lasts 70 wash cycles, against about 6 for a spray-on treatment &mdash; part of why the factory-treated garment, and not a bottle, is the format permitted for Canadian consumers. Higher upfront cost ($40–$120 per garment) but far lower long-term cost for frequent hikers.</p>
          <div className="not-prose mb-6 flex flex-wrap gap-3">
            <BuyLink tag={AMZ_TAG} search="insect shield permethrin treated clothing">Shop permethrin-treated clothing on Amazon.ca →</BuyLink>
          </div>
          ...
          <p>The gap in most Canadian permethrin coverage is a brand nobody mentions. Mark&rsquo;s carries <strong>Wind River No Fly Zone</strong> &mdash; shirts, pants, hoodies and socks built on Burlington&rsquo;s No Fly Zone permethrin treatment technology, brought to Canadian retail in 2018 after years of work with PMRA. It is the practical domestic answer for someone who wants permethrin protection they can legally buy in a Canadian store, and under the rules above the garments carry the PMRA-required lining. The line is now marketed as tick and mosquito repellent clothing, notwithstanding the mosquitoes-only restriction PMRA imposed at launch.</p>
          <p>Insect Shield, the American factory-treatment brand that dominates every US article on this topic, reaches Canadian buyers through cross-border retail rather than through domestic distribution under a Canadian registration. That distinction matters for warranty, returns and duty, and it is worth knowing which side of the border a garment is shipping from before you order it.</p>
          <p>Whichever route you take, treated clothing protects the person wearing it and nothing else. If the exposure you are actually worried about is children or a dog on the lawn, that is a different problem with a different answer &mdash; our guides to <Link href="/blog/how-to-keep-ticks-out-of-yard-ontario">keeping ticks out of an Ontario yard</Link> and <Link href="/blog/tick-prevention-yard-ontario-safe-for-kids">tick prevention for yards where kids play</Link> cover the ground-level version, and <Link href="/blog/do-ticks-die-in-the-washing-machine">whether ticks survive the washing machine</Link> matters more than most people expect once treated clothing comes off.</p>

          <h2>The Licensed-Applicator Alternative for Whole-Yard Treatment</h2>
          <p>If you want yard-wide tick and mosquito treatment (not just clothing), the only legal residential option in Ontario is hiring a licensed pesticide operator. Licensed Ontario applicators use PCP-registered formulations (typically bifenthrin or deltamethrin-based), applied according to label directions and renewed on a schedule through the season.</p>
          <p>BuzzSkito is licensed under Ontario Pesticide Operator Licence #L-240-2436835197 and provides residential mosquito and tick barrier spray across the GTA. Single treatments start at $99; seasonal mosquito plans cover the full May–September season with monthly, every-2-weeks or weekly applications (from $549), and the seasonal tick program runs 5 sprays ($597 on its own, $497 with a mosquito plan). The properties that need it most are the ones backing onto the same escarpment and moraine habitat you would spray your hiking pants for &mdash; our <Link href="/caledon-tick-spray">tick spray in Caledon</Link> and <Link href="/burlington-tick-spray">Burlington tick control</Link> pages show what a yard treatment covers on those lots. <Link href="/mosquito-control">Get a free quote for your property →</Link></p>
          ...
          <table className="min-w-[560px] not-prose w-full text-sm border-collapse border border-navy-100 rounded-lg overflow-hidden my-4">
            ...
            <tbody>
              ...
              <tr className="border-t border-navy-50"><td className="px-3 py-2">Bifenthrin (Pro)</td><td className="px-3 py-2">Whole yard</td><td className="px-3 py-2">Re-applied on a schedule</td><td className="px-3 py-2">Licensed barrier spray</td></tr>
            </tbody>
          </table>
          ...
          <ol>
            <li><strong>Permethrin-treated clothing</strong> for hiking, yard work in tick zones, evening walks</li>
            ...
            <li><strong>Professional barrier spray</strong> for whole-yard residual treatment</li>
          </ol>
          <p className="not-prose text-sm text-gray-600 mb-2">Three of those five layers are products you buy rather than services you book: a skin repellent, a metofluthrin area device, and Bti larvicide for standing water. Unlike a clothing spray, all three are formats sold to consumers here &mdash; find the Canadian PCP registration number on the label and confirm your use site before you buy, whichever route you take.</p>
          <div className="not-prose mb-6 flex flex-wrap gap-3">
            <BuyLink tag={AMZ_TAG} search="icaridin insect repellent">Icaridin skin repellent →</BuyLink>
            <BuyLink tag={AMZ_TAG} search="thermacell mosquito repeller">Thermacell patio repeller →</BuyLink>
            <BuyLink tag={AMZ_TAG} search="mosquito dunks bti larvicide">Bti dunks &amp; bits →</BuyLink>
          </div>
          <p>Layer five is the only one that treats the ground rather than the person walking over it. Where a ravine or woodlot runs right behind the fence line &mdash; the highest-exposure setup our <Link href="/toronto-tick-spray">Toronto tick spray</Link> page describes &mdash; permethrin-treated clothing covers the hiker but does nothing for kids playing on the lawn.</p>
          ...
          <div className="not-prose my-4">
            <BuyLink tag={AMZ_TAG} search="screen tent screen house">Check screen tents on Amazon.ca →</BuyLink>
          </div>
            ...
            <table className="min-w-[640px] w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  ['Oil of lemon eucalyptus / PMD', 'Not for children under 3 years', 'Skin', 'Plant-derived but genuinely age-restricted — plant-derived does not mean no age limit'],
          ...
          <ul>
            ...
            <li><Link href="/blog/tick-prevention-yard-ontario-safe-for-kids">Tick Prevention for Ontario Yards with Kids</Link> &mdash; because treated clothing is rated for ages 16 and up in Canada</li>
      ...
      <CTASection heading="Permethrin Protects Your Clothing · Barrier Spray Treats Your Yard" subtext={`Get a free quote for licensed barrier spray. From $99. ${PROMISES.labelLine}. ${PROMISES.licence}.`} variant="dark" />
    </>
  )
}
