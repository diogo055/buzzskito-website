...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "BuzzSkito technicians apply barrier spray to foliage, fence lines, and shaded resting surfaces — not to open flowers or actively blooming plants. Pyrethroids are toxic to bees, which is why product labels restrict spraying blooming plants and areas where bees are foraging. We follow those label directions and avoid treating flowering plants — that is how the risk to pollinators is managed.",
  },
]
...
export default function NaturalMosquitoControlPage() {
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema(`/blog/${POST.slug}`, UPDATED)) }}
      />
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
          ...
          <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
            <li>BTi dunks kill mosquito larvae in standing water with a toxin that targets mosquito and black fly larvae specifically &mdash; the City of Toronto uses BTi as its primary larviciding tool.</li>
            <li>Cedar-oil yard sprays provide 7&ndash;14 days of light residual, a shorter-lived residual than professional synthetic barrier spray.</li>
            <li>A female mosquito lays 100&ndash;300 eggs in water as shallow as a bottle cap, with a new generation of adults roughly every 10 days.</li>
            <li>Essential oils applied to yard vegetation evaporate too quickly to give meaningful residual protection outdoors.</li>
            <li>Oil of lemon eucalyptus (OLE) is the best-evidenced plant-based personal repellent, and the US CDC lists it among the repellent actives it recommends.</li>
            <li>Ravine-adjacent and waterfront properties typically need professional seasonal treatment; low-pressure urban lots can often manage with BTi plus standing-water elimination.</li>
          </ul>
        ...
        <TopPick tag={AMZ_TAG}
          ...
          blurb="Of every natural option, BTi dunks are the one that genuinely works — a soil-bacterium larvicide that kills mosquito larvae in standing water, with a toxin that targets mosquito and black fly larvae specifically (use it as the label directs). It's the same tool the City of Toronto relies on for larviciding. Drop one in rain barrels, ponds, and birdbaths to stop the next generation before it can bite."
          search="summit mosquito dunks"
          score={8.7}
          pros={['Toxin targets mosquito & black fly larvae', 'Kills larvae before they become biting adults', 'Long-lasting — one dunk treats water for ~30 days']}
        ...
        <p>When Ontario homeowners ask about &ldquo;natural&rdquo; mosquito control, they usually mean one of four things: plant-based repellent sprays applied to the yard, biological larvicides like BTi that target the larvae, essential oils used as personal repellents, or mosquito-repelling plants in the garden. Each of these exists on a spectrum from genuinely effective to mostly wishful thinking.</p>
        <p>Professional barrier spray, by contrast, typically uses a synthetic pyrethroid (permethrin or bifenthrin) that is a synthetic analogue of naturally occurring pyrethrins found in chrysanthemum flowers. It is not &ldquo;organic.&rdquo; Products sold for this use in Canada carry a PCP registration number, and the label sets out how, where and at what rate they may be applied, including restrictions near water and flowering plants.</p>
        <p>The honest answer: a layered approach — combining the genuinely effective natural methods with targeted professional treatment where it&apos;s warranted — keeps professional treatment to the places it is actually warranted.</p>
        ...
        <p>Drop a BTi dunk into rain barrels, ornamental ponds, birdbaths, and any standing water that can&apos;t be eliminated. The bacterium reproduces in the water and kills larvae before they develop into biting adults. Its toxin targets mosquito and black fly larvae specifically; use it as the label directs. The City of Toronto uses BTi as its primary larviciding tool across the city each year.</p>
        ...
        <p>Cedar oil-based products are marketed as &ldquo;natural&rdquo; yard sprays and do have mosquito-repelling and insecticidal properties. The practical limitation for Ontario use is residual time — cedar oil volatilizes rapidly in heat and breaks down quickly in rain, typically providing 7–14 days of light protection, a shorter residual than professional synthetic barrier spray.</p>
        ...
        <p>Lemon eucalyptus oil (OLE, not the essential oil) is the best-evidenced plant-based personal repellent, and the US CDC lists it among the repellent actives it recommends against mosquitoes. Citronella, lavender, and other essential oils provide brief personal repellency but degrade within 20–30 minutes on skin.</p>
        ...
        <h3>7. Encouraging Natural Predators — Pleasant, Rarely Decisive</h3>
        <p>Bat houses, purple martin boxes, backyard ponds stocked with minnows, and leaving opossums alone all get recommended as the chemical-free route. Each predator does eat mosquitoes or ticks; the honest question is how many, and whether that number is large enough to change how often you get bitten in your own yard. We ranked them one by one in <Link href="/blog/what-eats-ticks-and-mosquitoes" className="text-brand-700 underline">what eats ticks and mosquitoes</Link> — worth reading before you spend a weekend building a bat box.</p>
        ...
        <h2>BuzzSkito&apos;s Approach: Licensed, Label-Directed, Responsibly Applied</h2>
        <p>BuzzSkito&apos;s treatments are applied under our {PROMISES.licence}, according to product label directions. Our applications are targeted — we treat the specific surfaces and zones where mosquitoes live and rest, not the entire yard. We avoid open water and flowering plants, and follow the label&apos;s application rate and pollinator directions.</p>
        <p>This approach is not &ldquo;organic&rdquo; in the strictest sense, but it is a licensed, label-directed approach to residential mosquito control, chosen for how it holds up in Ontario&apos;s climate. We are transparent about what we use, at what concentration, and why — every service visit includes a product log that you can keep for your records.</p>
        ...
        <ul>
          ...
          <li><Link href="/blog/wondercide-canada-review" className="text-brand-700 hover:underline">Wondercide Canada — Honest Review + Where to Buy</Link></li>
      ...
      <CTASection
        ...
        subtext={`${PROMISES.labelLine}, licensed application, transparent product logs. Serving the GTA — free quotes at (289) 216-5030.`}
      />
    </>
  )
}
