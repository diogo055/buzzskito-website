...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'The Oven wins decisively on results and carries far less fire risk, and DIY whole-room rental is the option we caution against most. Renting propane or electric room heaters (roughly $150–$350 per day in Canadian cities) to cook a bedroom fails in a well-documented way: cold spots. Wall voids, baseboard gaps, and the undersides of furniture lag the air temperature and become survival refuges, bugs actively flee along cables and pipes into cooler adjacent rooms, and unattended high-output heaters bring fire and insurance risk. A sealed, monitored chamber inverts every one of those failure modes — a contained volume you can verifiably take lethal and confirm with a probe.',
  },
  {
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 my-6 speakable">
            ...
            <ul className="mt-3 space-y-1.5 text-sm text-gray-700 list-disc pl-5">
              ...
              <li>Heat is a physical kill method rather than a pesticide &mdash; no PMRA registration involved, and it works identically on the pyrethroid-resistant bed bugs now common in Canada.</li>
            </ul>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Heat exits that entire argument. The Oven 2 is a physical device, not a pesticide &mdash; there is no PMRA registration to check because none is required, nothing to import illegally, no pesticide applied to your bedding, and no resistance mechanism now or ever. A pyrethroid-resistant bed bug and a susceptible one die at exactly the same 49&deg;C. When the legal, heat-only option is also the one with the cleaner kill science, the buying decision gets easy.</p>
