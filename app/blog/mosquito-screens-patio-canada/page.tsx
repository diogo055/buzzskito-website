...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'In 2026, a basic pop-up screen house (roughly 10×10 ft, instant-setup fibreglass poles) runs $120–$250 at Canadian Tire, Walmart, or Amazon.ca. A sturdier steel-frame screened gazebo (10×12 ft with a proper roof) is $300–$700, and a large 12×14 ft hardtop screened gazebo can reach $900–$2,000. Add-on mosquito netting curtain kits that clip onto an existing open gazebo or pergola cost $80–$300. Costco Canada often has the best pricing on the larger steel-frame and hardtop models during its spring outdoor-living sale (April–May); the pop-up units are cheapest at Canadian Tire and Walmart.',
  },
  {
