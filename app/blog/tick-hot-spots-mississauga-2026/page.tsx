  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        ...
        <p>The Oakville side of the western GTA has its own version of this in the 16 Mile Creek watershed, and the reported case data has followed both corridors upward — see <Link href="/blog/lyme-disease-cases-mississauga-oakville-2026" className="text-brand-700 underline">how Lyme case counts have climbed across Peel and Halton since 2020</Link>.</p>
