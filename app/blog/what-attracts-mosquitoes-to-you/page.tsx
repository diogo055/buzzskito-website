    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The two sexes are easy to tell apart once you know the tell: the male carries bushy, plumose antennae and a proboscis that is not built for piercing skin. If you want to know which one is hovering over your patio, we cover the visual differences and why only the female needs a blood meal in <Link href="/blog/male-vs-female-mosquito">male vs female mosquitoes</Link>.</p>
          ...
          <p>One caveat before you count yourself a magnet: some people are not bitten more, they simply <em>react</em> more. The U.S. Centers for Disease Control and Prevention describes the bump and the itch as your body&rsquo;s reaction to mosquito saliva, and how strongly that reaction shows up varies enormously from person to person &mdash; two people can take the same three bites and only one ends up visibly covered in welts. If your evidence for being a magnet is mostly the size of the lumps, read <Link href="/blog/why-do-mosquito-bites-itch">why mosquito bites itch</Link> before you blame your blood.</p>
          ...
          <p>If you want the study-by-study version &mdash; which single study the type O finding actually rests on, how small its sample was, and why secretor status may be doing the work instead &mdash; we weigh the evidence in <Link href="/blog/what-blood-type-do-mosquitoes-bite">what blood type mosquitoes bite most</Link>.</p>
          ...
          <p>If you want the shade-by-shade version of that finding, we charted the full attract-versus-ignore list from the 2022 <em>Nature Communications</em> study in <Link href="/blog/what-colors-attract-mosquitoes">which colours mosquitoes are drawn to</Link>.</p>
