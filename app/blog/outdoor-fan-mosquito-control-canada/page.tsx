      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <aside aria-label="Professional mosquito control" className="not-prose my-8 rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-7 shadow-sm">
            ...
            <p className="text-sm text-gray-700 mb-4 leading-relaxed">Airflow defends the chairs you are sitting in. BuzzSkito’s licensed barrier spray treats the whole yard in one visit, with the residual renewed on a schedule — from $99 for a single treatment, $549 for the Basic Season, $994 for 10 bi-weekly treatments. Tick protection runs $597/season standalone or $497 bundled, which is five tick sprays across the season — and no fan ever built moves a tick, because ticks do not fly. Serving 19+ GTA cities, May–September.</p>
