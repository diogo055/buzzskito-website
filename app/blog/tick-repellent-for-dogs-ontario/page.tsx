...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Natural repellents give partial, short-lived protection and are not a substitute for a veterinary preventative anywhere blacklegged ticks are established, which now includes much of southern Ontario. Diluted cedarwood and lemon-eucalyptus oil products can deter some ticks for a few hours. Never apply essential oils to a dog without veterinary guidance — many, including tea tree, pennyroyal, and undiluted peppermint, are toxic to dogs, and cats are far more sensitive still. Garlic and brewer\'s yeast have no evidence of efficacy, and garlic is toxic to dogs in quantity.',
  },
  {
    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>For the rest of the picture &mdash; the three stages vets describe, how the 4Dx/C6 test is interpreted, whether the infection is curable, and the rare kidney complication that makes it dangerous &mdash; see our full guide to <Link href="/blog/can-dogs-get-lyme-disease">Lyme disease in dogs</Link>.</p>
