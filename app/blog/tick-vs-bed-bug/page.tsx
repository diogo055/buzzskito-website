    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Two things make the check harder than it should be. The first is <strong>size</strong>. Most people picture an adult tick, but the stage that bites people most often is the nymph &mdash; roughly the size of a poppy seed, and easy to mistake for a speck of dirt or a very small bed bug. If the specimen is tiny, read <Link href="/blog/baby-ticks-nymphs-seed-ticks-ontario">our guide to tick nymphs and seed ticks</Link> alongside <Link href="/blog/baby-bed-bugs-nymphs-canada">what a bed bug nymph actually looks like</Link>. The second is <strong>damage</strong>: a squashed specimen loses its legs and its outline, which is exactly why both identification services above ask you to photograph the bug before you crush it.</p>
