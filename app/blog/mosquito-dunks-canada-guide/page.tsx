    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>The method has spread widely in the United States over the last two seasons, and it is genuinely clever: instead of hunting for hidden water, you out-compete it. The build below follows the instructions published by <strong>K-State Research and Extension</strong> in Johnson County, Kansas, which credits the approach to <strong>Doug Tallamy</strong>, the University of Delaware entomologist. <strong>Mississippi State University Extension</strong> has published its own version with an urban entomologist walking through the same steps. It helps to be clear about whose behaviour the bucket is exploiting: only females bite and only females lay eggs, which is the practical upshot of <Link href="/blog/male-vs-female-mosquito">the difference between male and female mosquitoes</Link> &mdash; the males in your yard are feeding on nectar and will ignore the bucket entirely, so every design decision here is about what an egg-laying female finds attractive.</p>
