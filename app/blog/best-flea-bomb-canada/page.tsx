    ...
    <>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="not-prose text-sm text-gray-600 mb-2">The comb is worth owning before any of this. A fine-tooth flea comb costs almost nothing, confirms in two minutes whether the animal is actually carrying fleas, and gives you flea dirt to test on a wet paper towel &mdash; which is how you tell fleas from an allergy before you spend a dollar on chemistry.</p>
          <div className="not-prose mb-6">
            <BuyLink tag={AMZ_TAG} search="flea comb fine tooth">Check flea combs on Amazon.ca →</BuyLink>
          </div>
          ...
          <p>Under Canada&rsquo;s <em>Pest Control Products Act</em>, any insecticide sold or used in Canada must be registered, a system Health Canada&rsquo;s Pest Management Regulatory Agency (PMRA) administers, and must carry a <strong>PCP registration number</strong> on its label. That number is the entire test. It is not a formality, and it is not something a marketplace listing can substitute for.</p>
          ...
          <p className="not-prose text-sm text-gray-600 mb-2">Step two has a purchase hiding inside it. A foam-core pet bed cannot be hot-washed and is usually the single most infested object in the house &mdash; replacing it with a fully machine-washable bed you can run at 60&deg;C every week is cheaper than trying to salvage it mid-infestation.</p>
          <div className="not-prose mb-6">
            <BuyLink tag={AMZ_TAG} search="machine washable dog bed">Check washable pet beds on Amazon.ca →</BuyLink>
          </div>
          ...
          <div className="not-prose my-4">
            <BuyLink tag={AMZ_TAG} search="steam cleaner carpet upholstery">Check steam cleaners on Amazon.ca →</BuyLink>
          </div>
          ...
          <div className="not-prose my-4 flex flex-wrap gap-3">
            <BuyLink tag={AMZ_TAG} search="safers insect killing diatomaceous earth">Safer&rsquo;s DE (PMRA-registered) →</BuyLink>
          ...
          <p className="not-prose text-sm text-gray-600 mb-2">Exclusion is a hardware job rather than a pesticide one: galvanised hardware cloth buried in an L-shape around the deck skirt or shed base is what actually stops a skunk or a feral cat re-colonising the space and re-seeding the fleas.</p>
          <div className="not-prose mb-6">
            <BuyLink tag={AMZ_TAG} search="galvanized hardware cloth mesh">Check hardware cloth on Amazon.ca →</BuyLink>
          </div>
