  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 py-12 prose-brand">
        ...
        <div className="not-prose mb-6 flex flex-wrap gap-3">
          <BuyLink search="tick twister removal tool">Tick removal tool on Amazon.ca →</BuyLink>
        ...
        <aside aria-label="Professional tick control" className="not-prose my-8 rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-7 shadow-sm">
          ...
          <p className="text-sm text-gray-700 mb-4 leading-relaxed">BuzzSkito&rsquo;s tick barrier treatment targets the shaded, leafy yard edges where ticks wait — 5 sprays a season across 19 GTA cities, backed by 129 five-star reviews.</p>
      ...
      <CTASection heading="Keep ticks out of your yard this season" subtext="Get a free quote for licensed tick barrier treatment across the GTA. 129 five-star reviews. Book before peak season." variant="dark" />
    </>
  )
}
