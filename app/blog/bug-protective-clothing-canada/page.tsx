    ...
    <>
      ...
      <section className="bg-gradient-to-br from-emerald-50 to-white border-b border-emerald-200 py-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl font-extrabold text-brand-900 mb-3">What bug protective clothing works in Canada?</h2>
          <p className="speakable text-base text-gray-800 leading-relaxed">
            <strong>For full-coverage bug protection in Canada, pair a Coghlan&rsquo;s mesh bug jacket with a Sea to Summit head net.</strong> Standard mesh stops mosquitoes and black flies; ultra-fine no-see-um mesh blocks biting midges too. For hands-free chemical protection, buy PMRA-registered permethrin-treated garments — DIY permethrin sprays aren&rsquo;t legal for sale in Canada.
          </p>
        </div>
      </section>
