  ...
  return (
    <>
      ...
      <CityHero
        breadcrumbs={[
          { label: 'Home', href: '/' },
          { label: 'BuzzSkito vs Mosquito.Buzz' },
        ]}
        title={<>BuzzSkito vs Mosquito.Buzz</>}
