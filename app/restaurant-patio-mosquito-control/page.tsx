...
export default function RestaurantPatioMosquitoControlPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/restaurant-patio-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        title={<>Restaurant Patio Mosquito Control in the GTA</>}
        subtitle={<>Keep your patio full and your guests comfortable all season. BuzzSkito provides regular mosquito barrier spray for restaurant patios across Mississauga, Toronto, Oakville, Burlington, and the GTA &mdash; scheduled around your operating hours.</>}
      />
      ...
      <section className="py-12 px-4 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="h2-display text-brand-900 mb-8 text-center">How Restaurant Patio Treatment Works</h2>
