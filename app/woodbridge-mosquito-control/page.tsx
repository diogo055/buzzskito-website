...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Woodbridge · From $99',
  description:
    'Woodbridge mosquito control · 129 five-star reviews. Barrier spray from $99, no contracts, free re-spray. Same-week service. (289) 216-5030.',
