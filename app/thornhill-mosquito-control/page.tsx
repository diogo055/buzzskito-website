...
export default function ThornhillMosquitoPage() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/thornhill-mosquito-control', '2026-07-01')) }} />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Looking at all your Thornhill pest control options? See our specialist guide: <Link href="/pest-control-thornhill" className="text-brand-700 hover:underline font-semibold">Pest Control in Thornhill</Link> — explains why a mosquito and tick specialist beats a generalist for the two pests that actually drive Thornhill backyard misery.</p>
