...
const FAQS = [
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Sixteen Mile Creek, conservation areas, Niagara Escarpment edge benefit from an early-May start. Tick control is 5 sprays per season, starting in late May (nymph emergence) and running through August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator focused only on <strong>mosquitoes and ticks</strong> in {CITY} yards near Sixteen Mile Creek, conservation areas, Niagara Escarpment edge. Treatments applied according to label directions.</>}
      ...
      <QuickAnswer question={`Who is the best pest control company for mosquitoes and ticks in ${CITY}?`}>
        <p>
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Sixteen Mile Creek, conservation areas, Niagara Escarpment edge). Single treatments start at <strong>$99</strong> on a standard lot under 10,000 sq ft, with season plans from $549. With <strong>150+ five-star Google reviews</strong> (zero negative), no contracts, the rain-back guarantee on every plan, and the <strong>BuzzSkito Bite-Free Guarantee</strong> on Standard &amp; Exclusive plans, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
        </p>
      </QuickAnswer>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — residual formula applied according to label directions to vegetation, shrub interiors, and resting sites, re-applied on your plan's schedule (monthly, every 2 weeks or weekly). <Link href="/milton-mosquito-control">See {CITY} mosquito control →</Link></li>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            ...
            <li>→ <Link href="/milton-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — yard tick spray for lawn edges and wooded borders</li>
