...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Public health agencies\' core advice is to avoid bites: use insect repellent as its label directs, wear long sleeves and pants in mosquito and tick habitat, do tick checks after being outdoors, and remove any attached tick promptly. Around the home, remove standing water, keep grass short, and clear leaf litter. Some families also have the yard\'s mosquito resting areas and tick edge zones treated with a professional barrier spray; that is pest control for the yard, not a substitute for personal protection or medical advice.',
  },
  {
    question: 'Are mosquito and tick diseases in Ontario getting worse?',
    answer: 'Yes. Warmer, longer seasons have expanded the range of the blacklegged tick across the GTA and southern Ontario, driving a steady rise in Lyme disease cases, while West Nile virus remains an annual risk in mosquito season. Public-health surveillance shows both tick populations and reported cases trending upward, making bite prevention increasingly important.',
  },
]
  ...
  return (
    <>
      ...
      <QuickAnswer question="What diseases do mosquitoes and ticks spread in Ontario?">
        <p>
          <strong>In Ontario, mosquitoes spread West Nile virus and (rarely) Eastern Equine Encephalitis, while blacklegged ticks spread Lyme disease and anaplasmosis.</strong> Lyme disease is the most common of the four and has been rising as tick range expands across the GTA; West Nile virus is an annual mosquito-season risk. Public health agencies stress preventing bites: repellent, protective clothing, tick checks, and prompt tick removal.
        </p>
      </QuickAnswer>
      ...
      <article className="py-12 px-4 bg-white">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p>Eastern Equine Encephalitis is rare in Ontario but serious when it occurs. It is spread by mosquitoes and, as the name suggests, has historically affected horses, though human cases can happen. EEE circulates mainly among birds in freshwater swamp habitats, with certain mosquito species occasionally bridging it to mammals. Most human infections cause mild or no symptoms, but severe cases can lead to brain inflammation (encephalitis). Because there is no vaccine or specific treatment for people, avoiding mosquito bites is the main protection, the same advice as for West Nile; see our <Link href="/blog/mosquito-repellent-guide-ontario-2026">Ontario mosquito repellent guide</Link> for personal-protection options.</p>
          ...
          <p>Every one of these diseases is transmitted by a bite, so every prevention strategy comes down to the same principle: avoiding bites where your family lives and plays. A layered approach:</p>
          <ul>
            <li><strong>Reduce vectors at the source:</strong> Remove standing water where mosquitoes breed; keep grass short and clear leaf litter to reduce tick habitat.</li>
            <li><strong>Treat your yard:</strong> A professional <Link href="/mosquito-control">mosquito barrier spray</Link> and <Link href="/tick-control">tick barrier spray</Link> target the resting areas and edge zones where adult mosquitoes and questing ticks gather around your home. It is pest control for the yard, not a replacement for the personal steps below.</li>
          ...
          <aside aria-label="Professional mosquito and tick control" className="not-prose my-8 rounded-2xl border-2 border-amber-300 bg-gradient-to-br from-amber-50 to-white p-6 sm:p-7 shadow-sm">
            <h3 className="text-xl sm:text-2xl font-extrabold text-brand-900 mb-2 leading-tight">Mosquito &amp; tick control for your yard</h3>
            <p className="text-sm text-gray-700 mb-4 leading-relaxed">BuzzSkito treats the mosquito resting areas and tick edge zones around your home, from $99 on a standard lot under 10,000 sq ft. Products applied according to label directions; 150+ five-star reviews across the GTA.</p>
      ...
      <CTASection heading="Mosquito & Tick Control Starts in Your Yard" subtext={`Get a free quote for licensed mosquito and tick barrier spray. From $99 on a standard lot under 10,000 sq ft. ${PROMISES.response}`} variant="dark" />
    </>
  )
}
