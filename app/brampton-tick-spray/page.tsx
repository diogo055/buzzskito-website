...
export const metadata: Metadata = buildMetadata({
  title: 'Brampton Tick Control 2026 · From $99 · 129 Five-Star Reviews',
  description:
    'Brampton tick spray · 129 five-star reviews. 5 sprays per season, 30-day protection. Castlemore, Heart Lake, Mount Pleasant, Bramalea. (289) 216-5030.',
    ...
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl font-extrabold text-brand-900 mb-3">What is the best tick control company in Brampton?</h2>
