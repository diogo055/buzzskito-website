...
const FAQS = [
  {
    ...
    answer: 'Tick spray in Toronto starts from $99 per application. A 2-treatment seasonal program (spring + fall) starts from $179. Properties near the Don Valley, Humber River, or High Park typically benefit from both spring and fall applications. No contracts. Call (289) 216-5030 for a free Toronto tick spray quote.',
  },
  {
