...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Bram West | From $99',
  description:
    'Professional mosquito control in Bram West, Brampton. Barrier spray near Credit River & Churchville from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Bram West properties near the Credit River or the Churchville heritage district typically benefit from Standard's two-week spacing; properties in the newer residential areas farther from the river may do well with Basic. Call (289) 216-5030 for a free property assessment.",
  },
  {
...
export default function BramWestMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/bram-west-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Bram West's Credit River frontage and historic Churchville heritage district create intense mosquito pressure. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
