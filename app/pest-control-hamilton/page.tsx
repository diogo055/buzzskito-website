...
const FAQS = [
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Cootes Paradise, Dundas Valley, Bruce Trail benefit from an early-May start. Tick treatments should target late May (nymph emergence) and again in August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
    ...
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-gray-800 leading-relaxed">
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Cootes Paradise, Dundas Valley, Bruce Trail). Single treatments start at <strong>$99</strong>, with seasonal programs available on quote. With <strong>150+ five-star Google reviews</strong> (zero negative), no contracts, a 30-minute re-entry window, and the <strong>BuzzSkito Bite-Free Guarantee</strong>, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — Health Canada-approved residual formula applied to all vegetation, shrub interiors, and resting sites. Up to 30-day protection. <Link href="/hamilton-mosquito-control">See {CITY} mosquito control →</Link></li>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            ...
            <li>→ <Link href="/hamilton-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — Lyme disease prevention and yard tick spray</li>
