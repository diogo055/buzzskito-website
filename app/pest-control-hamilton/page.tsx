...
export const metadata: Metadata = buildMetadata({
  ...
  description: `Hamilton pest control specialist focused on mosquitoes and ticks — the two pests that drive backyard misery in the GTA. Health Canada-approved barrier spray from $99, BuzzSkito Bite-Free Guarantee, no contracts. 129 five-star reviews. Call (289) 216-5030.`,
  canonical: SLUG,
})
