...
export default function CasaLomaMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/casa-loma-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Casa Loma's ravine corridors, mature tree canopy, and surrounding parkland create persistent mosquito pressure. BuzzSkito's barrier spray gives Casa Loma families 30-day protection per treatment.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>BuzzSkito's barrier spray creates a treated zone around your Casa Loma property — targeting all resting vegetation where mosquitoes from these corridors settle when they arrive on your lot. The product knocks down the mosquitoes resting on those surfaces and leaves a residual there for up to 30 days per treatment. Mosquitoes keep dispersing in from the corridors, so the treatment is repeated through the season rather than done once.</p>
