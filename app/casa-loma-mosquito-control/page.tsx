...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Casa Loma, Toronto. Barrier spray near Nordheimer Ravine from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Casa Loma properties adjacent to Nordheimer Ravine, Sir Winston Churchill Park, or Wells Hill Park typically benefit from Standard's two-week spacing; properties on interior streets with less direct park exposure may do well with Basic. Call (289) 216-5030 for a free assessment.",
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Casa Loma's ravine corridors, mature tree canopy, and surrounding parkland create persistent mosquito pressure. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>BuzzSkito's barrier spray creates a treated zone around your Casa Loma property — targeting all resting vegetation where mosquitoes from these corridors settle when they arrive on your lot. The product is applied to those surfaces according to its label directions. Mosquitoes keep dispersing in from the corridors, so the treatment is repeated through the season rather than done once.</p>
