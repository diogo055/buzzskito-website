...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Casa Loma | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Casa Loma, Toronto. Barrier spray near Nordheimer Ravine from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/casa-loma-mosquito-control',
})

const NEIGHBOURHOOD = 'Casa Loma'
const CITY = 'Toronto'
const SLUG = '/casa-loma-mosquito-control'

const FAQS = [
  {
    question: 'Why does the Casa Loma neighbourhood have high mosquito pressure?',
    answer: "Casa Loma is surrounded by some of Toronto's most active mosquito breeding habitat. Nordheimer Ravine runs directly through the neighbourhood, connecting to the broader Cedarvale-Nordheimer ravine corridor. Sir Winston Churchill Park and Wells Hill Park add further green canopy and moisture retention. These combined green spaces create a sheltered, humid microclimate ideal for mosquito reproduction from May through September.",
  },
  {
    question: 'How does Nordheimer Ravine affect mosquitoes in Casa Loma?',
    answer: "Nordheimer Ravine is a deep, forested corridor running through the heart of the Casa Loma area. Its permanent stream flow, dense understory vegetation, and sheltered canopy create year-round mosquito breeding habitat that cannot be treated at the source. Properties on streets adjacent to the ravine — including Wells Hill Avenue, Nina Street, and sections of Spadina Road — experience direct evening dispersal from this population throughout the season.",
  },
  {
    question: 'How many mosquito treatments does a Casa Loma home need?',
    answer: "Casa Loma properties adjacent to Nordheimer Ravine, Sir Winston Churchill Park, or Wells Hill Park typically benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties on interior streets with less direct park exposure may do well with 3–4 visits. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in the Casa Loma area?',
    answer: "Mosquito season in Casa Loma typically runs from late April through September. The Nordheimer Ravine corridor retains warmth and moisture earlier in spring than exposed areas, enabling earlier emergence. Peak mosquito activity is from late May through July, with sustained pressure through August in properties closest to the ravine and park edges.",
  },
  {
    question: 'Does BuzzSkito serve all streets in the Casa Loma neighbourhood?',
    answer: "Yes. We serve all Casa Loma streets including Walmer Road, Spadina Road, Austin Terrace, Wells Hill Avenue, and all properties adjacent to Nordheimer Ravine and Sir Winston Churchill Park. We also serve all surrounding Toronto neighbourhoods. Call (289) 216-5030 to confirm service at your specific address.",
  },
]

export default function CasaLomaMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/casa-loma-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Casa Loma's ravine corridors, mature tree canopy, and surrounding parkland create persistent mosquito pressure. BuzzSkito's barrier spray gives Casa Loma families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Casa Loma's Ravine and Parkland Mosquito Problem</h2>
          <p>The Casa Loma neighbourhood is defined by its dramatic topography — and that same geography creates one of midtown Toronto's most persistent mosquito environments. <strong>Nordheimer Ravine</strong> cuts directly through the area, its permanent stream and dense forest canopy sustaining mosquito breeding populations that are protected from any source-level treatment. To the south, <strong>Sir Winston Churchill Park</strong> and <strong>Wells Hill Park</strong> add further green space with moisture-retaining vegetation that supports additional mosquito habitat.</p>
          <p>BuzzSkito's barrier spray creates a treated zone around your Casa Loma property — targeting all resting vegetation where mosquitoes from these corridors settle when they arrive on your lot. This typically reduces active mosquito presence by 80–95% within 24 hours, with protection lasting up to 30 days per treatment.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of Casa Loma and surrounding areas. See our <Link href="/toronto-mosquito-control" className="text-brand-700 hover:underline">Toronto mosquito control</Link> page for city-wide coverage, or our page for <Link href="/the-annex-mosquito-control" className="text-brand-700 hover:underline">The Annex</Link>.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/casa-loma-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Casa Loma properties from Nordheimer Ravine and parkland mosquitoes. No contracts." />
    </>
  )
}
