...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control North Oakville | From $99',
  description:
    'Mosquito control in North Oakville. Barrier spray near 16 Mile Creek from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties near stormwater ponds or Sixteen Mile Creek are often well-served by Basic; properties directly adjacent to ponds may benefit from Standard's two-week spacing. Call (289) 216-5030 for a free assessment tailored to your specific North Oakville address.",
  },
  {
...
export default function NorthOakvilleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/north-oakville-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>North Oakville's rapidly growing communities contain stormwater ponds that create consistent seasonal mosquito breeding. Licensed Ontario pesticide operator. Treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Sixteen Mile Creek and its tributaries add natural creek-source pressure to the engineered pond pressure, particularly in the Dundas and Glenorchy areas. BuzzSkito's barrier spray creates a treated zone around your North Oakville property — targeting all resting vegetation — and repeat visits through the season keep that zone in place regardless of the pond or creek proximity.</p>
