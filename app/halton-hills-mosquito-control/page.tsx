...
const NEIGHBOURHOODS: { name: string; href?: string }[] = [
  { name: 'Georgetown', href: '/georgetown-mosquito-control' },
  { name: 'Acton' },
  { name: 'Glen Williams' },
  { name: 'Norval' },
  { name: 'Limehouse' },
...
export default function HaltonHillsMosquitoPage() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/halton-hills-mosquito-control', '2026-07-01')) }} />
