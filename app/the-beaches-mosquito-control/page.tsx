  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>The Beaches faces mosquito pressure from Ashbridge's Bay, the Eastern Ravine, and Lake Ontario's waterfront — one of Toronto's most complex multi-source mosquito environments. BuzzSkito's barrier spray gives Beaches families their backyards back.</>}
