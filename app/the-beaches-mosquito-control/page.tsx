...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Mosquito control for The Beaches. Eastern Ravine, Ashbridge\'s Bay & Lake Ontario waterfront drive intense mosquito pressure. From $99. (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). With multi-directional pressure from both ravines and Ashbridge's Bay, properties directly adjacent to the Eastern Ravine or within 500 metres of Ashbridge's Bay typically benefit from Standard's two-week spacing given the sustained source pressure. Call (289) 216-5030 for a free assessment tailored to your specific address.",
  },
  {
    question: "How is BuzzSkito's spray applied in Beaches gardens near the lake?",
    answer: "We apply the product according to its label directions. We do not apply directly to water, waterfront vegetation in the riparian zone, or open blooms. For properties very close to Ashbridge's Bay or the lakefront, we can go over your specific application plan before the visit. Keep people and pets off treated areas until the spray has dried, as the product label directs.",
  },
]
...
export default function TheBeachesMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/the-beaches-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>The Beaches faces mosquito pressure from Ashbridge's Bay, the Eastern Ravine, and Lake Ontario's waterfront — one of Toronto's most complex multi-source mosquito environments. Licensed Ontario pesticide operator; treatments applied according to label directions.</>}
