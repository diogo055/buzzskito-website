...
export default function HamiltonTickSprayPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/hamilton-tick-spray', '2026-07-01')) }} />
      ...
      <section className="py-14 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="h2-display text-brand-950 mb-2 text-center">What Hamilton Homeowners Say About Our Tick Control</h2>
