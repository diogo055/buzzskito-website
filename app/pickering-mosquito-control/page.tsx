...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Pickering Durham | BuzzSkito',
  description:
...
const NEIGHBOURHOOD = 'Pickering'
const CITY = 'Durham Region'
const SLUG = '/pickering-mosquito-control'

const FAQS = [
  {
    question: 'Why does Pickering have significant mosquito pressure?',
    answer: "Pickering's geography creates mosquito pressure from multiple major sources. Frenchman's Bay — a large coastal wetland on Lake Ontario — is one of the most productive mosquito breeding sites in Durham Region. The Rouge River runs through Pickering's west side, connecting to Rouge National Urban Park's extensive wetlands. Altona Forest, one of the largest remaining urban forests in the GTA, adds interior woodland breeding habitat. This combination of bay, river, and forest makes Pickering one of Durham Region's most mosquito-affected communities.",
  },
  {
    question: "How does Frenchman's Bay affect mosquito levels in Pickering?",
    answer: "Frenchman's Bay is a large coastal wetland and marsh that produces substantial mosquito populations each season. The bay's cattail beds, emergent vegetation, and sheltered shallow water zones are highly productive breeding habitat. Properties in south Pickering near the bay — particularly in the Liverpool Road and Bayly Street area — face direct dispersal pressure from this significant source. The bay's proximity to Lake Ontario also creates high-humidity conditions that extend evening mosquito activity.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Altona Forest is one of the largest intact urban forests in the GTA, containing mature forest canopy, seasonal wetlands, vernal pools, and dense understory vegetation that sustain mosquito populations from early spring through fall. Properties in the Altona Road and Finch Avenue area that border the forest experience elevated mosquito activity, particularly during evening hours when adult mosquitoes disperse from the forest's sheltered interior.",
  },
  {
    question: 'Does BuzzSkito serve all of Pickering?',
    answer: "Yes. We serve all Pickering neighbourhoods from the waterfront through to north Pickering. This includes properties near Frenchman's Bay, the Rouge River, Altona Forest, and all residential areas. We also serve adjacent Ajax and Scarborough. Call (289) 216-5030 to confirm service at your specific Pickering address.",
  },
]

export default function PickeringMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howToSchema({ service: 'mosquito', city: 'Pickering' })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/pickering-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Pickering's Frenchman's Bay, Rouge River corridor, and Altona Forest create multi-source mosquito pressure from waterfront to forest. BuzzSkito's barrier spray gives Pickering families 30-day protection per treatment.
          </p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Pickering properties from bay, river, and forest mosquitoes. No contracts." />
    </>
  )
}
