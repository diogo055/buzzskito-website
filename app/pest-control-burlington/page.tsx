...
const SLUG = '/pest-control-burlington'
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `General pest control companies offer 10–20 services — ants, mice, wasps, spiders, mosquitoes, ticks, etc. They train technicians on a wide catalogue and rotate between treatment types. A specialist (like BuzzSkito for mosquitoes and ticks) does one thing repeatedly. Our technicians know exactly where mosquitoes and ticks rest in ${CITY} backyards (Niagara Escarpment, Tyandaga, lakefront) and apply targeted barrier spray to those specific zones. The result: better kills, longer protection, fewer return visits.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Niagara Escarpment, Tyandaga, lakefront. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Niagara Escarpment, Tyandaga, lakefront benefit from an early-May start. Tick treatments should target late May (nymph emergence) and again in August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
...
export default function PestControlBurlingtonPage() {
  return (
    <>
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-gray-800 leading-relaxed">
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Niagara Escarpment, Tyandaga, lakefront). Single treatments start at <strong>$99</strong>, with seasonal programs available on quote. With <strong>150+ five-star Google reviews</strong> (zero negative), no contracts, a 30-minute re-entry window, and the <strong>BuzzSkito Bite-Free Guarantee</strong>, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [`${CITY} pressure zones`, "Niagara Escarpment, Tyandaga, lakefront"],
      ...
      <section className="py-12 px-4 bg-white border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-extrabold text-brand-900 mb-2">Burlington City Profile — What We've Observed Treating Burlington Properties</h2>
          <p className="text-gray-600 text-sm mb-6">Data and observations specific to Burlington, drawn from BuzzSkito field experience and public surveillance records (not generic content recycled across our city pages).</p>

          {/* Stats grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Population</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">187,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Households</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">~70,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
            ...
            <div className="bg-brand-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-brand-900 mt-1 leading-tight">~30–40 min from Mississauga HQ via QEW</p>
            </div>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Burlington FSAs (Postal Code Areas) We Service</h3>
          <p className="text-sm text-gray-700 mb-6 font-mono break-words">L7L, L7M, L7N, L7P, L7R, L7S, L7T</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Specific Burlington Landmarks Near Our Treatment Zones</h3>
          <p className="text-sm text-gray-700 mb-6">Royal Botanical Gardens, Bronte Creek (west boundary), Niagara Escarpment trails, Mount Nemo Conservation Area, Spencer Smith Park, LaSalle Park, Tyandaga Park</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-3">Burlington Mosquito & Tick Pressure by Neighborhood Tier</h3>
            ...
            <table className="w-full text-sm">
              <thead className="bg-brand-800 text-white">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left">Burlington Neighborhoods</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-navy-50 last:border-0">
                  ...
                  <td className="px-4 py-2 text-gray-800">Tyandaga, North Burlington, Aldershot — RBG + Escarpment + lakefront</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 2 (high)</td>
                  <td className="px-4 py-2 text-gray-800">Roseland, Shoreacres — lakefront + mature canopy</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 3 (moderate)</td>
                  <td className="px-4 py-2 text-gray-800">Alton Village, Millcroft, Headon Forest — stormwater ponds in newer subdivisions</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 4 (lower)</td>
                  <td className="px-4 py-2 text-gray-800">Downtown Burlington core, The Orchard — less natural habitat</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">What We've Observed Treating Burlington</h3>
          <p className="text-sm text-gray-700 leading-relaxed">Burlington has mosquito pressure from three directions: Lake Ontario waterfront (Aldershot, Spencer Smith Park area), Bronte Creek (west boundary with Oakville), and the Niagara Escarpment / Royal Botanical Gardens (north end). Tyandaga and North Burlington — at the foot of the Escarpment — have sheltered microclimates that retain humidity longer, extending mosquito season 2–4 weeks past lakefront timing. RBG's 1,100 hectares of naturalized land directly affect adjacent properties.</p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Niagara Escarpment, Tyandaga, lakefront:</p>
          <ul>
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — Health Canada-approved residual formula applied to all vegetation, shrub interiors, and resting sites. Up to 30-day protection. <Link href="/burlington-mosquito-spray">See {CITY} mosquito control →</Link></li>
            <li><strong>Tick barrier spray</strong> — targeted treatment of the 1–3 metre lawn-to-woods transition zone where blacklegged ticks and dog ticks concentrate. <Link href="/burlington-tick-spray">See {CITY} tick control →</Link></li>
          ...
          <p>Most {CITY} backyards in the Niagara Escarpment, Tyandaga, lakefront exposure zone are squarely in the "call BuzzSkito" category. Mosquitoes and ticks are the dominant pests in residential GTA properties — everything else is rarer or seasonal.</p>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            <li>→ <Link href="/burlington-mosquito-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Mosquito Control</Link> — our specialty barrier spray for mosquitoes</li>
            <li>→ <Link href="/burlington-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — Lyme disease prevention and yard tick spray</li>
