...
export default function KingCityMosquitoPage() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/king-city-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>From Humber River tributaries through King City village to the Holland Marsh corridor near Schomberg — BuzzSkito delivers professional mosquito barrier spray for King Township estate properties.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Looking at all your King City pest control options? See our specialist guide: <Link href="/pest-control-king-city" className="text-brand-700 hover:underline font-semibold">Pest Control in King City</Link> — explains why a mosquito and tick specialist beats a generalist for the two pests that actually drive King City backyard misery.</p>
