...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Falgarwood | From $99',
  description:
    'Professional mosquito control in Falgarwood, Oakville. Barrier spray near Sixteen Mile Creek from $99. Licensed operator. Call (289) 216-5030.',
  canonical: '/falgarwood-mosquito-control',
})

const NEIGHBOURHOOD = 'Falgarwood'
const CITY = 'Oakville'
const SLUG = '/falgarwood-mosquito-control'

const FAQS = [
  {
    question: 'Why does Falgarwood have mosquito problems?',
    answer: "Falgarwood's mosquito pressure stems primarily from its proximity to the Sixteen Mile Creek valley. The creek's ravine corridor — with permanent water flow, floodplain wetlands, and dense bankside vegetation — is one of Oakville's most significant mosquito breeding zones. Falgarwood's mature residential lots with established tree canopy provide ideal daytime resting habitat for mosquitoes that disperse from the creek each evening.",
  },
  {
    question: 'How does Sixteen Mile Creek affect mosquitoes in Falgarwood?',
    answer: "Sixteen Mile Creek is one of Oakville's largest waterways, and its ravine corridor runs directly along Falgarwood's western edge. The creek sustains permanent water flow, standing pools, and saturated floodplain soils that produce mosquitoes continuously from May through September. The dense vegetation along the creek banks shelters adult mosquitoes during the day, and they disperse into adjacent residential areas — including Falgarwood — each evening as temperatures drop.",
  },
  {
    question: 'How many treatments does a Falgarwood home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Falgarwood properties near Sixteen Mile Creek typically benefit from Standard's two-week spacing; interior properties farther from the creek may do well with Basic. Call (289) 216-5030 for a free property assessment tailored to your specific Falgarwood address.",
  },
  {
    question: 'When should I book my first Falgarwood mosquito treatment?',
    answer: "We recommend booking your first treatment in late April or early May, before mosquito populations fully establish. Sixteen Mile Creek's permanent water flow allows early-season emergence as soon as temperatures consistently reach 10°C. Starting early gives the barrier spray time to suppress the first generation, reducing pressure for the rest of the season.",
  },
  {
    question: 'Does BuzzSkito serve all of Falgarwood in Oakville?',
    answer: "Yes. We serve all Falgarwood streets including properties adjacent to Sixteen Mile Creek. We also serve all surrounding Oakville neighbourhoods including Glen Abbey. Call (289) 216-5030 to confirm service at your specific Falgarwood address.",
  },
]

export default function FalgarwoodMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/falgarwood-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. Falgarwood's proximity to the Sixteen Mile Creek ravine generates persistent mosquito pressure throughout the season.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Falgarwood's Sixteen Mile Creek Mosquito Pressure</h2>
          <p>Falgarwood is a well-established residential neighbourhood in central Oakville, bordered by the <strong>Sixteen Mile Creek</strong> valley to the west. This creek — one of the largest waterways in Halton Region — sustains a permanent riparian corridor with year-round water flow, floodplain wetlands, and dense bankside vegetation that produces mosquitoes continuously from spring through fall.</p>
          <p>Falgarwood's mature residential lots with established tree canopy compound the problem by providing ideal daytime resting habitat for mosquitoes that arrive from the creek corridor. BuzzSkito's barrier spray targets these resting surfaces — leaf undersides, shrub interiors, fence lines — throughout your property, creating a treated zone that is repeated on a schedule through the season to keep pace with the ongoing pressure from Sixteen Mile Creek.</p>

          <h2>Part of Our Oakville Mosquito Control Network</h2>
          <p>We serve all of Falgarwood and surrounding Oakville. See our <Link href="/oakville-mosquito-control" className="text-brand-700 hover:underline">Oakville mosquito control</Link> page for city-wide coverage, or our <Link href="/glen-abbey-mosquito-control" className="text-brand-700 hover:underline">Glen Abbey</Link> neighbourhood page for adjacent coverage.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Falgarwood properties from Sixteen Mile Creek mosquitoes. No contracts." />
    </>
  )
}
