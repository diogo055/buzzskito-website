...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Glen Abbey | From $99',
  description:
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). For ravine-adjacent or creek-proximate Glen Abbey properties, we typically recommend Standard's two-week spacing; interior properties further from the ravine system may be well-served by Basic. Call (289) 216-5030 for a free assessment tailored to your specific address.",
  },
  {
...
export default function GlenAbbeyMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/glen-abbey-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. Glen Abbey's ravines and proximity to Bronte Creek create some of Oakville's most consistent seasonal mosquito pressure.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>BuzzSkito treats all resting vegetation on your Glen Abbey property — shrubs, garden borders, fence lines adjacent to ravine edges, and any naturalized plantings — creating a treated zone where arriving mosquitoes rest, repeated on a schedule through the season.</p>
