...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control High Park | From $99',
  description:
    'Professional mosquito control in High Park, Toronto. Barrier spray near Grenadier Pond from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties directly adjacent to High Park or the Humber River typically benefit from Standard's two-week spacing or Exclusive's weekly visits. The sheer scale of the nearby breeding habitat — Grenadier Pond, park wetlands, and Humber River combined — means consistent re-treatment is essential. Interior properties one or two blocks from the park edge may do well with Basic. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function HighParkMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/high-park-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator. Treatments applied according to label directions, for High Park homes near 161 hectares of parkland, Grenadier Pond, and the Humber River.</>}
      ...
      <TypicalPrices service="mosquito" city="High Park" />
      ...
      <div className="max-w-4xl mx-auto px-4">
        <CityPriceCard city="High Park" service="mosquito" location="price_card_faq" />
      </div>
