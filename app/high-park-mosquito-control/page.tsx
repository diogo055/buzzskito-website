  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>High Park's 161 hectares of parkland, Grenadier Pond, and proximity to the Humber River create Toronto's most intense mosquito environment. BuzzSkito's barrier spray gives High Park families 30-day protection per treatment.</>}
