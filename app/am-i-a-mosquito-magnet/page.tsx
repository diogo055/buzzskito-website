...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Find out why mosquitoes bite you more than other people. Free 9-question test based on peer-reviewed research (blood type, body chemistry, lactic acid, CO2, pregnancy, clothing). Get your 1-100 magnet score + custom protection plan. Used by 150+ GTA homeowners.',
  canonical: SLUG,
})
    ...
    <>
      ...
      <section className="bg-white py-14 px-4">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="text-gray-700 mb-4"><strong>Body heat + visual contrast.</strong> Mosquitoes have infrared-sensitive antennae that detect body temperature gradients. They also use eyes (yes, mosquitoes have surprisingly good vision) to lock onto dark high-contrast targets against the background. Switching to light-coloured clothing removes that contrast cue, so you are harder to lock onto visually. It does nothing about the CO2 and heat cues they used to find you in the first place, but it is one of the easiest changes you can make.</p>
