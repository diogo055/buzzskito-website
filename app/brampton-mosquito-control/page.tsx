...
export const metadata: Metadata = buildMetadata({
  title: 'Brampton Mosquito Control 2026 · From $99 · 137 Five-Star Reviews',
  description:
      ...
      <section className="bg-amber-50 border-y-4 border-amber-300 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base text-gray-800 leading-relaxed">
            <strong>BuzzSkito provides specialist mosquito barrier spray across all Brampton neighbourhoods — Mount Pleasant, Gore Meadows, Castlemore, Springdale, Bramalea, Creditview, and Fletcher&apos;s Meadow.</strong> Treatments use Health Canada-approved formulations applied to vegetation and shrub interiors where mosquitoes rest. Single treatments start at <strong>$99</strong>, with seasonal programs available on quote. With <strong>137 five-star Google reviews</strong>, no contracts, a 30-minute re-entry window, and the <strong>BuzzSkito Bite-Free Guarantee</strong>, Brampton homeowners get reliable barrier spray for stormwater-pond and creek-adjacent properties. Call (289) 216-5030.
          </p>
        </div>
      </section>
