...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Moore Park, Toronto. Barrier spray near Moore Park Ravine & Mud Creek from $99. Safe for kids & pets. Call (289) 216-5030.',
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Moore Park sits between Moore Park Ravine and David Balfour Park — two deep ravine systems that generate intense mosquito pressure from both sides. BuzzSkito's barrier spray gives Moore Park families 30-day protection per treatment.</>}
      />
