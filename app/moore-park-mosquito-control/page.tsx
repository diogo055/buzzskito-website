...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Moore Park | From $99',
  description:
    'Professional mosquito control in Moore Park, Toronto. Barrier spray near Moore Park Ravine & Mud Creek from $99. Licensed Ontario operator. Call (289) 216-5030.',
  canonical: '/moore-park-mosquito-control',
})

const NEIGHBOURHOOD = 'Moore Park'
const CITY = 'Toronto'
const SLUG = '/moore-park-mosquito-control'

const FAQS = [
  {
    question: 'Why does Moore Park have such heavy mosquito activity?',
    answer: "Moore Park is bordered by two of Toronto's most significant ravine systems. The Moore Park Ravine runs along the neighbourhood's eastern and southern edges, while the Mud Creek ravine and David Balfour Park border it to the west. These deep, forested ravines contain permanent water courses, seasonal pooling zones, and dense vegetation that sustain mosquito breeding from late April through September. Moore Park's compact, tree-lined streets sit between these two ravine systems, placing virtually every property within mosquito dispersal range.",
  },
  {
    question: 'How do Moore Park Ravine and David Balfour Park affect mosquitoes?',
    answer: "Moore Park Ravine contains Mud Creek — a permanent water course that flows through dense forest canopy before joining the Don River system. David Balfour Park, to the west, is a deep ravine with its own water features and naturalized vegetation. Together, these two ravine systems create a pincer effect: mosquitoes disperse into Moore Park from both the east and the west simultaneously, making the neighbourhood one of the most challenging mosquito environments in midtown Toronto.",
  },
  {
    question: 'How many treatments does a Moore Park home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). The dual-ravine exposure — Moore Park Ravine to the east and David Balfour Park to the west — creates above-average pressure from two directions, so properties on streets closest to either ravine edge often benefit from Standard's two-week spacing. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in Moore Park?',
    answer: "Moore Park's mosquito season begins in late April to early May, driven by Mud Creek's early spring water flow through Moore Park Ravine. The sheltered ravine topography warms earlier than open areas, accelerating mosquito emergence. Peak activity runs from late May through July. The neighbourhood's mature tree canopy retains humidity, sustaining significant mosquito pressure into September.",
  },
  {
    question: 'Does BuzzSkito serve all of Moore Park?',
    answer: "Yes. We serve all Moore Park streets including those bordering Moore Park Ravine, David Balfour Park, and the Beltline Trail. We also serve adjacent neighbourhoods including Rosedale, Leaside, and Summerhill. Call (289) 216-5030 to confirm service at your specific Moore Park address.",
  },
]

export default function MooreParkMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/moore-park-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator treating Moore Park yards between Moore Park Ravine and David Balfour Park, two deep ravine systems that push mosquitoes in from both sides. Treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Moore Park's Dual-Ravine Mosquito Problem</h2>
          <p>Moore Park is one of midtown Toronto's most desirable residential neighbourhoods — and one of its most mosquito-affected. The <strong>Moore Park Ravine</strong> runs along the neighbourhood's eastern and southern boundaries, with <strong>Mud Creek</strong> — a permanent water course — flowing through dense forest before joining the Don River system. To the west, <strong>David Balfour Park</strong> contains its own deep ravine with water features and naturalized vegetation.</p>
          <p>This dual-ravine geography creates a pincer effect: mosquitoes disperse into Moore Park from both directions simultaneously, and the neighbourhood's mature tree canopy provides ideal daytime resting habitat between feeding flights. BuzzSkito's barrier spray targets these resting surfaces across your property, and repeat visits through the season keep that treated zone in place while the ravines keep producing new mosquitoes.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of Moore Park and surrounding neighbourhoods. See our <Link href="/rosedale-mosquito-control" className="text-brand-700 hover:underline">Rosedale mosquito control</Link> page, or our page for <Link href="/leaside-mosquito-control" className="text-brand-700 hover:underline">Leaside</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Moore Park properties from dual-ravine mosquito pressure. No contracts." />
    </>
  )
}
