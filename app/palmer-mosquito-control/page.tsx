...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Palmer | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Palmer, Burlington. Barrier spray near Grindstone Creek from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Palmer properties near Grindstone Creek or Lowville Park typically benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties on the northern edge of the neighbourhood closest to the conservation area may benefit from the full 5-treatment season program. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function PalmerMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/palmer-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Palmer's proximity to Grindstone Creek and Lowville Park creates sustained mosquito pressure from north Burlington's most productive breeding habitat. BuzzSkito's barrier spray gives Palmer families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/palmer-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
