...
const ALL_FAQS = [
  ...
  { question: 'How long does the treatment last?', answer: 'Mosquito treatments provide up to 30 days of protection per application. Tick treatments last up to 90 days. For continuous mosquito coverage, we recommend reapplication every 21–28 days throughout the season.' },
