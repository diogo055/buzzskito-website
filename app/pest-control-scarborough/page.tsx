...
const SLUG = '/pest-control-scarborough'
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `General pest control companies offer 10–20 services — ants, mice, wasps, spiders, mosquitoes, ticks, etc. They train technicians on a wide catalogue and rotate between treatment types. A specialist (like BuzzSkito for mosquitoes and ticks) does one thing repeatedly. Our technicians know exactly where mosquitoes and ticks rest in ${CITY} backyards (Rouge Park, Highland Creek, ravine system) and apply targeted barrier spray to those specific zones. The result: each visit goes where mosquitoes and ticks actually rest in your yard.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Rouge Park, Highland Creek, ravine system. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Rouge Park, Highland Creek, ravine system benefit from an early-May start. Tick control is 5 sprays per season, starting in late May (nymph emergence) and running through August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
...
export default function PestControlScarboroughPage() {
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator focused only on <strong>mosquitoes and ticks</strong> in {CITY} yards near Rouge Park, Highland Creek, ravine system. Treatments applied according to label directions.</>}
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [`${CITY} pressure zones`, "Rouge Park, Highland Creek, ravine system"],
      ...
      <section className="py-12 px-4 bg-white border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-extrabold text-brand-900 mb-2">Scarborough City Profile — What We've Observed Treating Scarborough Properties</h2>
          <p className="text-gray-600 text-sm mb-6">Data and observations specific to Scarborough, drawn from BuzzSkito field experience and public surveillance records (not generic content recycled across our city pages).</p>

          {/* Stats grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Population</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">632,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Households</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">~225,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
            ...
            <div className="bg-brand-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-brand-900 mt-1 leading-tight">~50–60 min from Mississauga HQ</p>
            </div>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Scarborough FSAs (Postal Code Areas) We Service</h3>
          <p className="text-sm text-gray-700 mb-6 font-mono break-words">M1B, M1C, M1E, M1G, M1H, M1J, M1K, M1L, M1M, M1N, M1P, M1R, M1S, M1T, M1V, M1W, M1X</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Specific Scarborough Landmarks Near Our Treatment Zones</h3>
          <p className="text-sm text-gray-700 mb-6">Rouge National Urban Park (west boundary), Highland Creek valley, Bluffer's Park, Morningside Park, Cedar Brae Golf Club, Thomson Memorial Park</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-3">Scarborough Mosquito & Tick Pressure by Neighborhood Tier</h3>
            ...
            <table className="w-full text-sm">
              <thead className="bg-brand-800 text-white">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left">Scarborough Neighborhoods</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-navy-50 last:border-0">
                  ...
                  <td className="px-4 py-2 text-gray-800">Rouge, Malvern, Highland Creek — Rouge Park + creek valley</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 2 (high)</td>
                  <td className="px-4 py-2 text-gray-800">Guildwood, Cliffside, Cliffcrest — Bluffs + lakefront</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 3 (moderate)</td>
                  <td className="px-4 py-2 text-gray-800">Birchcliffe, Woburn, Bendale — mature residential</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 4 (lower)</td>
                  <td className="px-4 py-2 text-gray-800">Agincourt, Milliken — newer denser development</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">What We've Observed Treating Scarborough</h3>
          <p className="text-sm text-gray-700 leading-relaxed">Scarborough has the most extensive ravine system in Toronto outside the Don Valley — Highland Creek, Rouge River, and Morningside Creek all flow through residential neighborhoods. The Rouge National Urban Park boundary on the east side adds significant mosquito and tick exposure for Rouge, Malvern, and parts of Highland Creek. Scarborough Bluffs create lakefront humidity extending mosquito activity in Cliffside and Cliffcrest into late October.</p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Rouge Park, Highland Creek, ravine system:</p>
          <ul>
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — residual formula applied according to label directions to vegetation, shrub interiors, and resting sites, re-applied on your plan's schedule (monthly, every 2 weeks or weekly). <Link href="/scarborough-mosquito-control">See {CITY} mosquito control →</Link></li>
            <li><strong>Tick barrier spray</strong> — targeted treatment of the 1–3 metre lawn-to-woods transition zone where blacklegged ticks and dog ticks concentrate. <Link href="/scarborough-tick-spray">See {CITY} tick control →</Link></li>
          ...
          <p>Most {CITY} backyards in the Rouge Park, Highland Creek, ravine system exposure zone are squarely in the "call BuzzSkito" category. Mosquitoes and ticks are the dominant pests in residential GTA properties — everything else is rarer or seasonal.</p>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            <li>→ <Link href="/scarborough-mosquito-control" className="text-brand-700 hover:underline font-semibold">{CITY} Mosquito Control</Link> — our specialty barrier spray for mosquitoes</li>
            <li>→ <Link href="/scarborough-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — yard tick spray for lawn edges and wooded borders</li>
