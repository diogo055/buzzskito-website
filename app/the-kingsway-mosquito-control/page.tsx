...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control The Kingsway | From $99 · 5★ Rated',
  description:
...
const NEIGHBOURHOOD = 'The Kingsway'
const CITY = 'Toronto'
const SLUG = '/the-kingsway-mosquito-control'

const FAQS = [
  {
    question: 'Why does The Kingsway have such significant mosquito pressure?',
    answer: "The Kingsway sits directly above the Humber River valley — one of Toronto's largest and deepest ravine systems. The Humber River's permanent water flow, extensive floodplain, and dense riparian vegetation create ideal year-round mosquito breeding habitat. Properties on the south and west edges of The Kingsway that overlook the valley experience the most intense evening mosquito activity as populations disperse upslope from the river corridor.",
  },
  {
    question: 'How does the Humber River valley affect mosquito activity in my yard?',
    answer: "The Humber River valley through The Kingsway section contains permanent river flow, seasonal pooling in the floodplain, and dense tree canopy that retains humidity well into the evening. This creates one of the GTA's most productive mosquito habitats. Mosquitoes from the valley can travel 1–3 km into adjacent residential areas. Kingsway Park, which connects the neighbourhood to the river trail system, provides an additional corridor for mosquito dispersal into residential lots.",
  },
  {
  ...
  },
  {
    ...
    answer: "The Kingsway's mosquito season runs from late April through September. The Humber River valley warms early in spring due to its sheltered topography, enabling early mosquito emergence. Peak activity is from late May through July, with sustained evening pressure into September. The neighbourhood's mature tree canopy holds humidity and extends daily mosquito activity windows.",
  },
  {
    question: 'Does BuzzSkito serve all of The Kingsway in Etobicoke?',
    answer: "Yes. We serve all Kingsway streets including those overlooking the Humber River valley and those near Kingsway Park. We also serve all surrounding Etobicoke neighbourhoods including Humber Valley Village, Sunnylea, and Islington Village. Call (289) 216-5030 to confirm service at your specific Kingsway address.",
  },
]

export default function TheKingswayMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/the-kingsway-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            The Kingsway sits above the Humber River valley — one of Toronto's largest mosquito breeding corridors. BuzzSkito's barrier spray gives Kingsway families 30-day protection per treatment so you can enjoy your garden all season.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/the-kingsway-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Kingsway properties from Humber River valley mosquitoes. No contracts." />
    </>
  )
}
