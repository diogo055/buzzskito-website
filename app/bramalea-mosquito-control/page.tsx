...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Bramalea | From $99',
  description:
    'Professional mosquito control in Bramalea, Brampton. Barrier spray near Etobicoke Creek & Professor\'s Lake from $99. Licensed Ontario operator. Call (289) 216-5030.',
  canonical: '/bramalea-mosquito-control',
})

const NEIGHBOURHOOD = 'Bramalea'
const CITY = 'Brampton'
const SLUG = '/bramalea-mosquito-control'

const FAQS = [
  {
    question: 'Why does Bramalea have heavy mosquito pressure?',
    answer: "Bramalea's mosquito pressure comes from two significant water features. Etobicoke Creek runs through the heart of the neighbourhood, providing a permanent breeding corridor with standing pools, saturated floodplain soils, and dense bankside vegetation. Professor's Lake — a large man-made recreational lake — adds additional breeding and resting habitat, particularly around its naturalized shoreline and adjacent parkland. Together, these water features make Bramalea one of Brampton's most mosquito-affected areas.",
  },
  {
    question: "How does Professor's Lake affect mosquitoes in Bramalea?",
    answer: "Professor's Lake is a large recreational lake surrounded by parkland and naturalized shoreline vegetation. While the lake itself is not a primary breeding site (mosquitoes prefer still, shallow water), the marshy areas around its edges, the adjacent stormwater drainage features, and the dense vegetation surrounding the lake provide significant mosquito resting and secondary breeding habitat. Properties near the lake experience elevated evening mosquito activity throughout the season.",
  },
  {
    question: 'How many treatments does a Bramalea home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Bramalea properties near Etobicoke Creek or Professor's Lake typically benefit from Standard's two-week spacing; interior Bramalea properties may do well with Basic. Call (289) 216-5030 for a free property assessment tailored to your specific Bramalea address.",
  },
  {
    question: 'When does mosquito season start in Bramalea?',
    answer: "Mosquito season in Bramalea typically begins in late April or early May, as Etobicoke Creek's standing water and Professor's Lake's marshy edges provide early-season breeding habitat. Peak activity runs from late May through July. The season extends into September or early October, with the creek and lake sustaining populations longer than areas without permanent water.",
  },
  {
    question: 'Does BuzzSkito serve all of Bramalea in Brampton?',
    answer: "Yes. We serve all Bramalea streets including properties near Etobicoke Creek and Professor's Lake. We also serve all surrounding Brampton neighbourhoods. Call (289) 216-5030 to confirm service at your specific Bramalea address.",
  },
]

export default function BramaleaMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/bramalea-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Bramalea's Etobicoke Creek corridor and Professor's Lake create persistent dual-source mosquito pressure. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Bramalea's Creek-and-Lake Mosquito Problem</h2>
          <p>Bramalea is one of Brampton's largest and most established communities, and its geography makes it one of the city's most mosquito-affected areas. <strong>Etobicoke Creek</strong> flows through the heart of the neighbourhood, its ravine corridor providing a permanent breeding habitat with year-round water flow, standing floodplain pools, and dense riparian vegetation that shelters adult mosquitoes during the day.</p>
          <p><strong>Professor's Lake</strong> — Bramalea's signature recreational feature — adds a secondary dimension. While the open lake itself is less of a breeding concern, the marshy shoreline areas, adjacent stormwater features, and naturalized parkland vegetation surrounding the lake provide significant mosquito resting habitat. BuzzSkito's barrier spray targets all of these resting surfaces on your property — leaf undersides, shrub interiors, fence lines — creating a treated zone on the surfaces where mosquitoes from both the creek and the lake area settle, renewed on a schedule through the season.</p>

          <h2>Part of Our Brampton Mosquito Control Network</h2>
          <p>We serve all of Bramalea and surrounding Brampton. See our <Link href="/brampton-mosquito-control" className="text-brand-700 hover:underline">Brampton mosquito control</Link> page for city-wide coverage.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Bramalea properties from Etobicoke Creek and Professor's Lake mosquitoes. No contracts." />
    </>
  )
}
