  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Bramalea's Etobicoke Creek corridor and Professor's Lake create persistent dual-source mosquito pressure. BuzzSkito's barrier spray gives Bramalea families up to 30-day protection per treatment.</>}
