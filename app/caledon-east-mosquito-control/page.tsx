...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Caledon East. Barrier spray near Caledon Lake from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Many Caledon East properties are well-served by Basic; rural and estate properties with large lots, nearby ponds, or agricultural water sources may benefit from Standard's two-week spacing. Call (289) 216-5030 for a free assessment tailored to your specific property.",
  },
  {
...
export default function CaledonEastMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/caledon-east-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Caledon East's rural ponds, proximity to Caledon Lake, and agricultural landscape create persistent mosquito pressure throughout the warm season. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Our tick barrier spray targets the lawn edges, leaf litter and fence lines where ticks wait for a host, 5 sprays per season. See our <Link href="/caledon-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
