...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control GTA · From $99 · 137 Reviews',
  description:
    'GTA mosquito control · 137 five-star reviews. Health Canada-approved barrier spray from $99, no contracts, free re-spray. 19+ cities served. (289) 216-5030.',
