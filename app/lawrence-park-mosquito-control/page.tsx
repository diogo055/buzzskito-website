...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Lawrence Park | From $99 · 5★ Rated',
  description:
...
const NEIGHBOURHOOD = 'Lawrence Park'
const CITY = 'Toronto'
const SLUG = '/lawrence-park-mosquito-control'

const FAQS = [
  {
    question: 'Why does Lawrence Park have such heavy mosquito activity?',
    answer: "Lawrence Park is bordered by some of Toronto's deepest ravines. The Sherwood Park ravine and Burke Brook corridor run along the neighbourhood's eastern edge, creating permanent water flow, dense vegetation, and sheltered humidity that sustain mosquito breeding all season. The neighbourhood's mature tree canopy — one of the densest in Toronto — provides ideal daytime resting habitat, allowing mosquito populations to persist from late April through September.",
  },
  {
    question: 'How does the Sherwood Park ravine affect mosquitoes in my yard?',
    answer: "Sherwood Park's ravine contains Burke Brook — a permanent, year-round watercourse surrounded by dense canopy and low-lying vegetation. This combination of flowing water, pooling in low areas after rain, and sheltered microclimate makes it one of north Toronto's most productive mosquito breeding zones. Properties on streets backing onto the ravine — particularly near St. Edmund's Drive and Weybourne Crescent — experience the most consistent pressure.",
  },
  {
  ...
  },
  {
    ...
    answer: "Lawrence Park's mosquito season begins in late April to early May, driven by Burke Brook's early spring water flow. The neighbourhood's sheltered ravine topography warms earlier than open areas, accelerating mosquito emergence. Peak activity runs from late May through July, with sustained pressure into September. The mature canopy retains humidity, extending the active window compared to less-treed areas.",
  },
  {
    question: 'Does BuzzSkito serve all of Lawrence Park?',
    answer: "Yes. We serve all of Lawrence Park South and Lawrence Park North, including all streets adjacent to Sherwood Park ravine and Burke Brook. We also serve surrounding Toronto neighbourhoods including Lytton Park, Bedford Park, and North York. Call (289) 216-5030 to confirm service at your specific Lawrence Park address.",
  },
]

export default function LawrenceParkMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/lawrence-park-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Lawrence Park's deep ravines, Burke Brook, and mature tree canopy create intense mosquito pressure from spring through fall. BuzzSkito's barrier spray gives Lawrence Park families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/lawrence-park-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Lawrence Park properties from ravine and creek mosquitoes. No contracts." />
    </>
  )
}
