...
const FAQS = [
  {
    ...
    answer: 'BuzzSkito offers the lowest starting price in Vaughan ($99/treatment), no contracts, and a perfect 5.0 rating across 137 Google reviews. Mosquito Man has more cumulative reviews (900+) but operates on seasonal contracts. LawnSavers is best for existing lawn-care customers wanting a bundled add-on. The right choice depends on whether you prioritize price, flexibility, or bundled services.',
  },
  {
        ...
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <div className="not-prose overflow-x-auto my-6">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  { company: 'BuzzSkito', price: 'From $99', reviews: '137 (5.0★)', contracts: 'No contracts', area: 'All Vaughan' },
