...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Bolton | From $99',
  description:
    'Professional mosquito control in Bolton, Caledon. Barrier spray near Humber River from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/bolton-mosquito-control',
})

const NEIGHBOURHOOD = 'Bolton'
const CITY = 'Caledon'
const SLUG = '/bolton-mosquito-control'

const FAQS = [
  {
    question: 'Why does Bolton have significant mosquito pressure?',
    answer: "Bolton sits at the confluence of the Humber River and several tributary streams, creating one of the most concentrated mosquito breeding environments in the Caledon area. The Humber River runs directly through Bolton, with its floodplain, riparian wetlands, and dense vegetation sustaining large mosquito populations. Bolton Camp and the surrounding conservation lands add further wooded breeding habitat. Albion Hills Conservation Area to the north contributes additional source pressure from its extensive forests and seasonal water features.",
  },
  {
    question: 'How does the Humber River affect mosquito levels in Bolton?',
    answer: "The Humber River is one of the GTA's most significant mosquito breeding corridors, and Bolton sits directly on it. The river's slow-moving sections through Bolton, adjacent floodplain wetlands, backwater pools, and dense riparian vegetation create continuous breeding habitat from spring through fall. Properties within 1 km of the Humber River corridor in Bolton experience the highest and most sustained seasonal pressure.",
  },
  {
    question: 'How many treatments does a Bolton property need per season?',
    answer: "Most Bolton properties benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties adjacent to the Humber River, Bolton Camp, or Albion Hills typically benefit from the full 5-treatment program due to continuous re-pressure from nearby water sources and conservation land. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'Does Albion Hills Conservation Area contribute to Bolton mosquitoes?',
    answer: "Yes. Albion Hills Conservation Area, located north of Bolton, encompasses extensive forest, the upper Humber River headwaters, and seasonal wetlands that produce mosquito populations dispersing into Bolton's northern residential areas. The conservation area's managed forest and ski trails contain dense understory vegetation that provides ideal mosquito resting habitat during the warm months.",
  },
  {
    question: 'Does BuzzSkito serve all of Bolton?',
    answer: "Yes. We serve all Bolton streets including those along the Humber River corridor, near Bolton Camp, and in newer residential developments. We also serve all surrounding Caledon communities. Call (289) 216-5030 to confirm service at your specific Bolton address.",
  },
]

export default function BoltonMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/bolton-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Bolton's position on the Humber River, near Bolton Camp and Albion Hills Conservation Area, creates multi-source mosquito pressure throughout the season. BuzzSkito's barrier spray gives Bolton families 30-day protection per treatment.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Bolton's River and Conservation Area Mosquito Problem</h2>
          <p>Bolton is Caledon's largest community and sits directly on the <strong>Humber River</strong> — one of the GTA's most significant watershed corridors. The river runs through the heart of Bolton, with its floodplain wetlands, slow-moving water sections, and dense riparian vegetation creating sustained mosquito breeding habitat from May through September. Properties along the river corridor face consistent evening dispersal from this permanent source.</p>
          <p><strong>Bolton Camp</strong>, the former Ontario summer camp property along the Humber River, adds extensive wooded and wetland habitat that contributes to local mosquito populations. To the north, <strong>Albion Hills Conservation Area</strong> encompasses upper Humber River headwaters, managed forest, and seasonal wetlands that produce additional mosquito pressure for Bolton's northern residential areas. BuzzSkito's barrier spray targets all resting vegetation on your Bolton property, creating a treated buffer that provides up to 30 days of protection between treatments.</p>

          <h2>Part of Our Caledon Mosquito Control Network</h2>
          <p>We serve all of Bolton and surrounding Caledon. See our <Link href="/caledon-mosquito-control" className="text-brand-700 hover:underline">Caledon mosquito control</Link> page for municipality-wide coverage, or our <Link href="/caledon-east-mosquito-control" className="text-brand-700 hover:underline">Caledon East</Link> page for adjacent community coverage.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Bolton properties from river and conservation area mosquitoes. No contracts." />
    </>
  )
}
