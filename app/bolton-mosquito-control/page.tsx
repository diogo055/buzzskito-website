...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Bolton | From $99 · 5★ Rated',
  description:
...
export default function BoltonMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/bolton-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Bolton's position on the Humber River, near Bolton Camp and Albion Hills Conservation Area, creates multi-source mosquito pressure throughout the season. BuzzSkito's barrier spray gives Bolton families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/bolton-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
