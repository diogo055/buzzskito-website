...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Bolton, Caledon. Barrier spray near Humber River from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties adjacent to the Humber River, Bolton Camp, or Albion Hills typically benefit from Standard's two-week spacing due to continuous re-pressure from nearby water sources and conservation land. Call (289) 216-5030 for a free assessment.",
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Bolton's position on the Humber River, near Bolton Camp and Albion Hills Conservation Area, creates multi-source mosquito pressure throughout the season. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
