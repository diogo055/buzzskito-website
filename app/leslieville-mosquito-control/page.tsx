...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Leslieville | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Leslieville, Toronto. Barrier spray near Ashbridges Bay from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/leslieville-mosquito-control',
})

const NEIGHBOURHOOD = 'Leslieville'
const CITY = 'Toronto'
const SLUG = '/leslieville-mosquito-control'

const FAQS = [
  {
    question: 'Why does Leslieville have significant mosquito pressure?',
    answer: "Leslieville is affected by multiple mosquito sources. Ashbridges Bay and the Eastern Beaches waterfront to the south create a coastal humidity zone that sustains mosquito activity through evening hours. The Don Valley South corridor to the west — where the Don River meets the lake — is one of Toronto's most prolific mosquito breeding areas. Greenwood Park adds local green space with moisture retention. This combination of waterfront, river corridor, and parkland makes Leslieville consistently mosquito-affected from May through September.",
  },
  {
    question: 'How does Ashbridges Bay affect mosquito activity in Leslieville?',
    answer: "Ashbridges Bay is a significant wetland and waterfront area south of Leslieville. Its marshland, shoreline vegetation, and the high-humidity coastal microclimate create ideal mosquito breeding and resting habitat. Evening onshore breezes push mosquitoes from the bay area north into Leslieville's residential streets. Properties south of Queen Street East are particularly affected, but dispersal reaches well into the neighbourhood's interior.",
  },
  {
    question: 'How many treatments does a Leslieville property need per season?',
    answer: "Most Leslieville properties benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties near Ashbridges Bay, the Don Valley South, or Greenwood Park typically need the full 5-treatment program. Interior properties may do well with 3–4 treatments. Call (289) 216-5030 for a free assessment tailored to your specific Leslieville address.",
  },
  {
    question: 'When does mosquito season start in Leslieville?',
    answer: "Leslieville's mosquito season runs from late April through September or early October. The lake's moderating effect on temperatures means both earlier spring warming and later fall activity compared to inland Toronto neighbourhoods. The Don Valley South corridor sustains early-season emergence. Peak activity is from late May through July, with sustained pressure near the waterfront through August.",
  },
  {
    question: 'Does BuzzSkito serve all of Leslieville Toronto?',
    answer: "Yes. We serve all Leslieville streets from the Don Valley east to Greenwood Avenue, and from the Danforth south to the waterfront. We also serve all surrounding Toronto neighbourhoods including Riverdale and the Beaches. Call (289) 216-5030 to confirm service at your specific Leslieville address.",
  },
]

export default function LeslievilleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/leslieville-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Leslieville's proximity to Ashbridges Bay, the Don Valley South, and Greenwood Park creates multi-source mosquito pressure. BuzzSkito's barrier spray gives Leslieville families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Leslieville's Multi-Source Mosquito Problem</h2>
          <p>Leslieville faces mosquito pressure from three distinct sources. <strong>Ashbridges Bay</strong> to the south is a significant wetland and waterfront zone — its marshland and shoreline vegetation generate substantial mosquito populations that drift north into residential streets on evening breezes. The <strong>Don Valley South</strong> corridor to the west, where the Don River meets Lake Ontario, is one of Toronto's most prolific breeding zones. <strong>Greenwood Park</strong> adds local green space with moisture-retaining vegetation that supports additional mosquito habitat.</p>
          <p>BuzzSkito's barrier spray creates a treated zone around your Leslieville property — targeting all resting vegetation where mosquitoes from these sources settle when they arrive on your lot. This typically reduces active mosquito presence by 80–95% within 24 hours, with protection lasting up to 30 days per treatment.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of Leslieville and surrounding areas. See our <Link href="/toronto-mosquito-control" className="text-brand-700 hover:underline">Toronto mosquito control</Link> page for city-wide coverage, or our pages for <Link href="/riverdale-mosquito-control" className="text-brand-700 hover:underline">Riverdale</Link> and <Link href="/the-beaches-mosquito-control" className="text-brand-700 hover:underline">The Beaches</Link>.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/leslieville-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Leslieville properties from Ashbridges Bay and Don Valley mosquitoes. No contracts." />
    </>
  )
}
