  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Honest 2026 comparison of mosquito control providers serving North York — Don Mills, Willowdale, Lawrence Park, York Mills, Bayview Village, Lansing, Parkwoods. Pricing, reviews, contracts.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>North York homeowners have several professional mosquito control options. Here&rsquo;s an honest comparison based on publicly available pricing, Google reviews, and North York-specific service offerings as of July 2026.</p>
