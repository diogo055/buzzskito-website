...
const FAQS = [
  {
    ...
    answer: 'Tick spray in Woodbridge starts from $99 per application. A 2-treatment seasonal program (spring + fall) starts from $179. Properties near Boyd Conservation Area or the Humber River valley benefit most from both spring and fall applications. No contracts. Call (289) 216-5030.',
  },
  {
...
export default function WoodbridgeTickPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/woodbridge-tick-spray')) }} />
