...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Eastlake | From $99',
  description:
    'Professional mosquito control in Eastlake, Oakville. Barrier spray near Joshua Creek & Lake Ontario from $99. Licensed operator. Call (289) 216-5030.',
  canonical: '/eastlake-mosquito-control',
})

const NEIGHBOURHOOD = 'Eastlake'
const CITY = 'Oakville'
const SLUG = '/eastlake-mosquito-control'

const FAQS = [
  {
    question: 'Why does Eastlake have significant mosquito pressure?',
    answer: "Eastlake's mosquito pressure comes from two converging sources. Joshua Creek runs through the neighbourhood's eastern edge, providing a permanent riparian breeding corridor with standing water, dense bankside vegetation, and sheltered floodplain habitat. The Lake Ontario shoreline to the south adds a secondary pressure zone — coastal humidity sustains mosquito activity well into the evening hours, and shoreline vegetation provides additional breeding and resting habitat.",
  },
  {
    question: 'How does Joshua Creek affect mosquito activity in Eastlake?',
    answer: "Joshua Creek is a permanent watercourse that flows south through Eastlake toward Lake Ontario. Its ravine corridor retains standing water in pools and floodplain depressions after rainfall, creating ideal mosquito breeding habitat. The dense vegetation along the creek banks provides daytime shelter for adult mosquitoes, which then disperse into adjacent Eastlake properties each evening. Properties within 500 metres of the creek experience the most consistent pressure.",
  },
  {
    question: 'How many treatments does an Eastlake home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). The combination of creek proximity and lakefront humidity makes Eastlake one of the areas in southeast Oakville where we most commonly recommend Standard's two-week spacing for properties near Joshua Creek or the Lake Ontario shoreline. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When is mosquito season worst in Eastlake?',
    answer: "Eastlake's mosquito season runs from late April through September or early October. Lake Ontario's moderating effect on local temperatures means earlier spring warming and extended fall activity compared to inland Oakville neighbourhoods. Peak mosquito activity is typically from late May through July, with a secondary spike after heavy rain events that flood Joshua Creek's banks.",
  },
  {
    question: 'Does BuzzSkito serve all of Eastlake in Oakville?',
    answer: "Yes. We serve all Eastlake streets including properties adjacent to Joshua Creek and the Lake Ontario shoreline. We also serve all surrounding Oakville neighbourhoods. Call (289) 216-5030 to confirm service at your specific Eastlake address.",
  },
]

export default function EastlakeMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/eastlake-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. Eastlake's location between Joshua Creek and the Lake Ontario shoreline creates persistent mosquito pressure from two directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Eastlake's Creek-and-Lake Mosquito Problem</h2>
          <p>Eastlake is one of southeast Oakville's most desirable residential communities, prized for its proximity to both <strong>Joshua Creek</strong> and <strong>Lake Ontario</strong>. That same geography makes it one of the area's most mosquito-affected neighbourhoods. Joshua Creek's ravine corridor — running along Eastlake's eastern boundary — provides permanent breeding habitat: standing pools, saturated floodplain soils, and dense riparian vegetation that shelters adult mosquitoes during the day.</p>
          <p>The <strong>Lake Ontario shoreline</strong> to the south adds a secondary zone of activity. Coastal humidity sustains mosquito activity well into evening hours, and shoreline vegetation provides additional resting habitat. BuzzSkito's barrier spray targets all resting surfaces on your Eastlake property — leaf undersides, shrub interiors, fence lines — creating a treated zone where mosquitoes dispersing from both the creek and the waterfront come to rest, repeated on a schedule through the season.</p>

          <h2>Part of Our Oakville Mosquito Control Network</h2>
          <p>We serve all of Eastlake and surrounding Oakville. See our <Link href="/oakville-mosquito-control" className="text-brand-700 hover:underline">Oakville mosquito control</Link> page for city-wide coverage, or our <Link href="/joshua-creek-mosquito-control" className="text-brand-700 hover:underline">Joshua Creek</Link> neighbourhood page for adjacent coverage.</p>
          ...
          <p>We also offer professional tick control in this area. Our targeted tick barrier spray treats the lawn edges, leaf litter, and wooded borders where ticks wait for a host, with 5 sprays per season. See our <Link href="/oakville-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Eastlake properties from Joshua Creek and lakefront mosquitoes. No contracts." />
    </>
  )
}
