...
const SLUG = '/pest-control-mississauga'
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `General pest control companies offer 10–20 services — ants, mice, wasps, spiders, mosquitoes, ticks, etc. They train technicians on a wide catalogue and rotate between treatment types. A specialist (like BuzzSkito for mosquitoes and ticks) does one thing repeatedly. Our technicians know exactly where mosquitoes and ticks rest in ${CITY} backyards (Credit River, Rattray Marsh, Erindale Park exposure) and apply targeted barrier spray to those specific zones. The result: each visit goes where mosquitoes and ticks actually rest in your yard.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Credit River, Rattray Marsh, Erindale Park exposure. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Credit River, Rattray Marsh, Erindale Park exposure benefit from an early-May start. Tick control is 5 sprays per season, starting in late May (nymph emergence) and running through August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
...
export default function PestControlMississaugaPage() {
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator focused only on <strong>mosquitoes and ticks</strong> in {CITY} yards near the Credit River, Rattray Marsh and Erindale Park. Treatments applied according to label directions.</>}
      ...
      <QuickAnswer question={`Who is the best pest control company for mosquitoes and ticks in ${CITY}?`}>
        <p>
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Credit River, Rattray Marsh, Erindale Park exposure). Single treatments start at <strong>$99</strong> on a standard lot under 10,000 sq ft, with season plans from $549. With <strong>150+ five-star Google reviews</strong> (zero negative), no contracts, the rain-back guarantee on every plan, and the <strong>BuzzSkito Bite-Free Guarantee</strong> on Standard &amp; Exclusive plans, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
        </p>
      </QuickAnswer>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [`${CITY} pressure zones`, "Credit River, Rattray Marsh, Erindale Park exposure"],
      ...
      <section className="py-12 px-4 bg-white border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-extrabold text-brand-900 mb-2">Mississauga City Profile — What We've Observed Treating Mississauga Properties</h2>
          <p className="text-gray-600 text-sm mb-6">Data and observations specific to Mississauga, drawn from BuzzSkito field experience and public surveillance records (not generic content recycled across our city pages).</p>

          {/* Stats grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Population</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">728,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
              <p className="text-xs text-gray-500 uppercase font-bold tracking-wider">Households</p>
              <p className="text-lg font-extrabold text-brand-900 mt-1">~250,000</p>
            </div>
            <div className="bg-brand-50 rounded-xl p-4">
            ...
            <div className="bg-brand-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-brand-900 mt-1 leading-tight">Service area HQ — our shortest drive</p>
            </div>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Mississauga FSAs (Postal Code Areas) We Service</h3>
          <p className="text-sm text-gray-700 mb-6 font-mono break-words">L4T, L4V, L4W, L4X, L4Y, L4Z, L5A, L5B, L5C, L5E, L5G, L5H, L5J, L5K, L5L, L5M, L5N, L5R, L5S, L5T, L5V, L5W</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">Specific Mississauga Landmarks Near Our Treatment Zones</h3>
          <p className="text-sm text-gray-700 mb-6">Rattray Marsh Conservation Area, Erindale Park, Riverwood Conservancy, Streetsville Memorial Park, Lakeside Park, Jack Darling Memorial Park, Meadowvale Conservation Area</p>

          <h3 className="text-lg font-extrabold text-brand-900 mb-3">Mississauga Mosquito & Tick Pressure by Neighborhood Tier</h3>
            ...
            <table className="w-full text-sm">
              <thead className="bg-brand-800 text-white">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left">Mississauga Neighborhoods</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-navy-50 last:border-0">
                  ...
                  <td className="px-4 py-2 text-gray-800">Lorne Park, Clarkson, Port Credit, Lakeview — Rattray Marsh + lakefront humidity</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 2 (high)</td>
                  <td className="px-4 py-2 text-gray-800">Streetsville, Meadowvale, Erin Mills — Credit River corridor + conservation areas</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 3 (moderate)</td>
                  <td className="px-4 py-2 text-gray-800">Cooksville, Mineola, Applewood — established neighborhoods with mature canopy</td>
                </tr>
                <tr className="border-b border-navy-50 last:border-0">
                  <td className="px-4 py-2 font-semibold text-brand-900 bg-gray-50 w-1/4">Tier 4 (lower)</td>
                  <td className="px-4 py-2 text-gray-800">Hurontario, City Centre, Churchill Meadows — newer development, less canopy</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 className="text-lg font-extrabold text-brand-900 mb-2">What We've Observed Treating Mississauga</h3>
          <p className="text-sm text-gray-700 leading-relaxed">Lakefront properties (Port Credit, Lakeview, Clarkson) typically see mosquito activity 7–10 days earlier than inland Mississauga due to Lake Ontario thermal moderation. Rattray Marsh-adjacent yards in Lorne Park experience the longest active season — often into early October.</p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Credit River, Rattray Marsh, Erindale Park exposure:</p>
          <ul>
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — residual formula applied according to label directions to vegetation, shrub interiors, and resting sites, re-applied on your plan's schedule (monthly, every 2 weeks or weekly). <Link href="/mississauga-mosquito-control">See {CITY} mosquito control →</Link></li>
            <li><strong>Tick barrier spray</strong> — targeted treatment of the 1–3 metre lawn-to-woods transition zone where blacklegged ticks and dog ticks concentrate. <Link href="/mississauga-tick-spray">See {CITY} tick control →</Link></li>
          ...
          <p>Most {CITY} backyards in the Credit River, Rattray Marsh, Erindale Park exposure exposure zone are squarely in the "call BuzzSkito" category. Mosquitoes and ticks are the dominant pests in residential GTA properties — everything else is rarer or seasonal.</p>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            <li>→ <Link href="/mississauga-mosquito-control" className="text-brand-700 hover:underline font-semibold">{CITY} Mosquito Control</Link> — our specialty barrier spray for mosquitoes</li>
            <li>→ <Link href="/mississauga-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — yard tick spray for lawn edges and wooded borders</li>
