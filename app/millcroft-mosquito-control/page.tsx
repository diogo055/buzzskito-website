...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Millcroft | From $99 · 5★ Rated',
  description:
...
const NEIGHBOURHOOD = 'Millcroft'
const CITY = 'Burlington'
const SLUG = '/millcroft-mosquito-control'

const FAQS = [
  {
    question: 'Why does Millcroft have so many mosquitoes?',
    answer: "Millcroft is built around the Grindstone Creek corridor, one of Burlington's most active mosquito breeding systems. The creek runs directly through the neighbourhood, with adjacent wetlands, naturalized stormwater ponds, and floodplain vegetation that produce large mosquito populations from May through September. Mount Nemo Conservation Area to the west adds escarpment-fed moisture and wooded breeding habitat that further contributes to Millcroft's mosquito pressure.",
  },
  {
    question: 'How does Grindstone Creek affect mosquito levels in Millcroft?',
    answer: "Grindstone Creek is one of the most significant mosquito breeding corridors in north Burlington. The creek's permanent water flow, slow-moving sections, backwater pools, and surrounding wetland vegetation create continuous breeding habitat. Mosquitoes from the creek corridor can disperse up to 3 km into adjacent residential areas. Millcroft properties within 500 metres of Grindstone Creek experience the highest and most consistent seasonal pressure.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Mount Nemo Conservation Area sits on the Niagara Escarpment immediately west of Millcroft. The conservation area's forested escarpment slopes, groundwater seepage zones, and seasonal streams produce mosquito populations that disperse into upper Millcroft properties. This escarpment-source pressure combines with Grindstone Creek pressure to make Millcroft one of Burlington's higher-activity neighbourhoods.",
  },
  {
    question: 'Does BuzzSkito serve all of Millcroft Burlington?',
    answer: "Yes. We serve all Millcroft streets including those adjacent to Grindstone Creek and the Mount Nemo escarpment. We also serve all surrounding Burlington neighbourhoods. Call (289) 216-5030 to confirm service at your specific Millcroft address.",
  },
]

export default function MillcroftMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/millcroft-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Millcroft's location along Grindstone Creek and near Mount Nemo Conservation Area creates persistent mosquito pressure from multiple sources. BuzzSkito's barrier spray gives Millcroft families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/millcroft-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Millcroft properties from creek and escarpment mosquitoes. No contracts." />
    </>
  )
}
