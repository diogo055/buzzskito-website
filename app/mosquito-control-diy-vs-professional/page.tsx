...
export default function DIYvsProfessionalPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/mosquito-control-diy-vs-professional', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        title={<>DIY vs Professional Mosquito Control &mdash; Is It Worth It?</>}
        subtitle={<>Citronella candles, home foggers, essential oils, and yard sprays compared to professional barrier treatment. An honest breakdown of cost, effectiveness, and safety.</>}
