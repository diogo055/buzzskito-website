...
const NEIGHBOURHOOD = 'Sunnybrook'
const CITY = 'Toronto'
const SLUG = '/sunnybrook-mosquito-control'

const FAQS = [
  {
    question: 'Why does the Sunnybrook area have such intense mosquito pressure?',
    answer: "The Sunnybrook neighbourhood is directly adjacent to Sunnybrook Park and Wilket Creek Park — two of Toronto's largest contiguous green spaces. Combined, they contain over 100 hectares of forest, meadow, and riparian habitat along Wilket Creek and the West Don River. These protected areas sustain permanent water features, seasonal wetlands, and dense vegetation that produce large mosquito populations throughout the season. The Don Valley trail corridor runs through the area, connecting it to the broader Don River watershed mosquito habitat.",
  },
  {
    question: 'How does Wilket Creek Park affect mosquitoes in my yard?',
    answer: "Wilket Creek Park contains Wilket Creek — a permanent watercourse that flows through dense forest canopy and meadow habitat before joining the West Don River in Sunnybrook Park. The creek's pools, seasonal overflow areas, and shaded riparian zones are among north Toronto's most productive mosquito breeding habitat. Properties on streets bordering Wilket Creek Park — particularly along Leslie Street and near the Sunnybrook Park boundary — experience the most consistent season-long pressure.",
  },
  {
    question: 'How many treatments does a Sunnybrook-area home need per season?',
    answer: "Properties near Sunnybrook Park and Wilket Creek Park typically benefit from 4–5 treatments spaced 21–28 days apart from May through September. The sheer volume of adjacent parkland and permanent water features means mosquito pressure is consistent and sustained throughout the season. We most commonly recommend the full 5-treatment program for park-adjacent properties. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start near Sunnybrook Park?',
    answer: "Mosquito season in the Sunnybrook area begins in late April to early May, driven by Wilket Creek's early spring water flow. The Don Valley's sheltered topography warms earlier than surrounding neighbourhoods. Peak activity runs from late May through July, with sustained pressure into September. The extensive forest canopy in Sunnybrook Park and Wilket Creek Park retains humidity, extending daily mosquito activity windows well into the evening.",
  },
  {
    question: 'Does BuzzSkito serve all of the Sunnybrook area?',
    answer: "Yes. We serve all residential streets in the Sunnybrook neighbourhood including those adjacent to Sunnybrook Park, Wilket Creek Park, and the Bayview Avenue corridor. We also serve surrounding neighbourhoods including the Bridle Path, York Mills, Don Mills, and Lawrence Park. Call (289) 216-5030 to confirm service at your specific address.",
  },
]

export default function SunnybrookMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/sunnybrook-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Sunnybrook's residential streets border Sunnybrook Park, Wilket Creek Park, and the Don Valley — over 100 hectares of mosquito breeding habitat. BuzzSkito's barrier spray gives Sunnybrook families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Sunnybrook's Massive Parkland Mosquito Problem</h2>
          <p>The Sunnybrook neighbourhood is defined by its proximity to some of Toronto's largest contiguous green spaces. <strong>Sunnybrook Park</strong> and <strong>Wilket Creek Park</strong> together contain over 100 hectares of forest, meadow, and riparian habitat along <strong>Wilket Creek</strong> and the <strong>West Don River</strong>. These protected parklands — part of the broader Don Valley trail system — sustain permanent water features, seasonal wetlands, and dense canopy that produce large, persistent mosquito populations.</p>
          <p>Properties in the Sunnybrook neighbourhood are surrounded by this parkland on multiple sides. The extensive tree canopy provides ideal daytime resting habitat for mosquitoes, while the creek and river corridors ensure continuous breeding throughout the season. BuzzSkito's barrier spray creates a protective treatment zone around your property, targeting all resting vegetation and providing up to 30 days of protection between treatments.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of Sunnybrook and surrounding neighbourhoods. See our <Link href="/bridle-path-mosquito-control" className="text-brand-700 hover:underline">Bridle Path mosquito control</Link> page, or our page for <Link href="/don-mills-mosquito-control" className="text-brand-700 hover:underline">Don Mills</Link>.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/sunnybrook-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Sunnybrook properties from parkland and Don Valley mosquitoes. No contracts." />
    </>
  )
}
