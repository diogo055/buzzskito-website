...
const FAQS = [
  ...
  { question: 'Is professional barrier spray better than buying these products myself?', answer: 'The two approaches solve different problems. Consumer gear is labelled for homeowner use and suits targeted jobs: a Thermacell on the deck, dunks in the rain barrel, DEET on your skin for a hike. A professional barrier spray is applied to the vegetation where mosquitoes rest across your property, kills on contact, and leaves a residual that is renewed on the plan\'s schedule (every 2 weeks on Standard, monthly on Basic) — and unlike traps or repellents, it can also target ticks where they wait. BuzzSkito treats mosquitoes and ticks across 19 GTA cities, with single treatments from $99 and seasonal programs from $549. Many customers still run dunks and a Thermacell alongside our service.' },
]
    ...
    <>
      ...
      <GuideHub
        ...
        serviceTieIn={{
          ...
          body: <>All the gear below works, but it is a job you have to keep doing. BuzzSkito&rsquo;s licensed technicians spray a professional barrier across your whole yard — mosquitoes <em>and</em> ticks — from <strong>$99</strong> per treatment. {PROMISES.rainBackShort}, plus a {PROMISES.biteFreeScope}.</>,
        ...
        faqs={FAQS}
        cta={{ heading: 'Skip the gadget graveyard — let a pro handle the bugs', subtext: `Free yard assessment. Mosquito & tick barrier spray from $99. ${PROMISES.rainBackShort}. ${PROMISES.biteFreeScope}.` }}
      />
    </>
  )
}
