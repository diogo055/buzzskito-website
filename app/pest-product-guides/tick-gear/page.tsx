...
const FAQS = [
  {
    ...
    answer: 'It depends how much of the work you want to do yourself. For hands-off, whole-property control, a professional barrier spray to the lawn edges, leaf litter, and fence lines is the most complete option — a licensed technician treats the zones where ticks rest, following the product label. For the DIY route, the evidence-backed stack is factory permethrin-treated clothing, a perimeter repellent or ready-to-use yard spray, and permethrin tick tubes to hit the larval ticks feeding on mice. Cedar-oil products like Wondercide use a plant-oil active ingredient but need frequent reapplication.',
  },
  {
    question: 'Do DIY tick products work as well as professional treatment?',
    answer: 'For a small, well-defined problem, good DIY gear helps — factory permethrin-treated clothing, a repellent barrier at the lawn-to-woods edge, and tick tubes can meaningfully cut your exposure. Where DIY falls short is coverage and residual: consumer sprays break down faster, are easy to under-apply, and rarely reach the shaded, humid microhabitats at fence lines and garden edges where ticks actually rest. Professional barrier spray is aimed at those exact zones with a precision sprayer, applied as the product label directs, which is why many homeowners with real tick pressure layer a professional treatment under their DIY habits.',
  },
  {
    question: 'Are tick tubes worth it in Ontario?',
    answer: 'They can be a smart part of a layered plan, but not a standalone fix. Tick tubes are packed with permethrin-treated cotton that mice collect for nesting material; the permethrin kills the larval ticks feeding on those mice, cutting the next generation at the wildlife-reservoir source. The catch is they only target the larval stage on rodents — they do nothing about the nymphs and adults already questing in your grass. Tubes placed in spring and mid-summer make most sense as one layer alongside a perimeter treatment that reaches the nymphs and adults in the grass.',
  },
  {
    question: 'Does Wondercide actually kill ticks?',
    answer: 'Yes, with caveats. Wondercide is a cedar-oil spray that kills and repels ticks on contact and is legitimately available in Canada — but like any essential-oil product, the knockdown is real only while it is wet, the residual is short, and it needs frequent reapplication after rain or heavy dew (which Ontario yards get plenty of). It is a reasonable pick if you specifically want a plant-oil (cedar) product and are willing to spray often — follow its label, including any directions for pets. Our Wondercide Canada review breaks down the products and pricing.',
  },
  {
  ...
  return (
    <>
      ...
      <GuideHub
        ...
        quickAnswer={{
          lead: <>The best tick control for most Canadian yards is a <strong>layered approach</strong>: treat the shaded lawn edges, leaf litter, and fence lines where blacklegged ticks actually live, and protect yourself with factory permethrin-treated gear. DIY products &mdash; repellent yard sprays, permethrin tick tubes, and cedar-oil sprays like Wondercide &mdash; genuinely help, but they need frequent reapplication and careful coverage; a <strong>professional barrier spray</strong>, applied by a licensed technician according to the product label, covers those edges for you with far less effort.</>,
          bullets: [
