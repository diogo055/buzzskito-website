...
export default function RiverOaksMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/river-oaks-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            River Oaks sits between Morrison Creek and Sixteen Mile Creek — two active mosquito breeding corridors. BuzzSkito's barrier spray gives River Oaks families up to 30-day protection per treatment.
          </p>
