...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Mosquito control in River Oaks, Oakville. Barrier spray near Morrison Creek & Sixteen Mile Creek from $99. Safe for kids & pets. (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "River Oaks properties near Morrison Creek or Sixteen Mile Creek typically benefit from 4-5 barrier spray treatments spaced 21-28 days apart from May through September. Interior properties with no direct creek exposure may do well with 3-4 treatments. Call (289) 216-5030 for a free property assessment.",
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>River Oaks sits between Morrison Creek and Sixteen Mile Creek — two active mosquito breeding corridors. BuzzSkito's barrier spray gives River Oaks families up to 30-day protection per treatment.</>}
      />
