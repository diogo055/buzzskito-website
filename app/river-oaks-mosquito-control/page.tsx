...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control River Oaks | From $99',
  description:
    'Mosquito control in River Oaks, Oakville. Barrier spray near Morrison Creek & Sixteen Mile Creek from $99. Ontario-licensed. (289) 216-5030.',
  canonical: '/river-oaks-mosquito-control',
})

const NEIGHBOURHOOD = 'River Oaks'
const CITY = 'Oakville'
const SLUG = '/river-oaks-mosquito-control'

const FAQS = [
  {
    question: 'Why does River Oaks have heavy mosquito pressure?',
    answer: "River Oaks sits between two significant creek systems — Morrison Creek and Sixteen Mile Creek — both of which sustain permanent water flow, riparian vegetation, and floodplain habitats that are ideal mosquito breeding grounds. The neighbourhood's mature tree canopy and large residential lots create additional sheltered resting habitat, meaning mosquitoes from the creeks find abundant daytime cover within the neighbourhood itself.",
  },
  {
    question: 'How do Morrison Creek and Sixteen Mile Creek affect mosquitoes in River Oaks?',
    answer: "Morrison Creek runs through the heart of River Oaks, while Sixteen Mile Creek borders it to the west. Both creeks generate mosquito populations from standing water in their floodplains, pooling after rain events, and dense bankside vegetation. Properties backing onto either creek corridor experience the most consistent pressure, but mosquito dispersal of up to 3 km means the entire neighbourhood is affected throughout the season.",
  },
  {
    question: 'How many treatments does a River Oaks property typically need?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). River Oaks properties near Morrison Creek or Sixteen Mile Creek typically benefit from Standard's two-week spacing. Interior properties with no direct creek exposure may do well with Basic. Call (289) 216-5030 for a free property assessment.",
  },
  {
    question: 'When does mosquito season start in River Oaks?',
    answer: "Mosquito season in River Oaks typically begins in late April or early May, as both Morrison Creek and Sixteen Mile Creek provide early-season standing water that allows mosquito larvae to develop as soon as temperatures reach 10°C consistently. Peak activity runs from late May through July, with the season extending into September or early October.",
  },
  {
    question: 'Does BuzzSkito serve all of River Oaks in Oakville?',
    answer: "Yes. We serve all River Oaks streets including properties adjacent to Morrison Creek and Sixteen Mile Creek. We also serve all surrounding Oakville neighbourhoods. Call (289) 216-5030 to confirm service at your specific River Oaks address.",
  },
]

export default function RiverOaksMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/river-oaks-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>River Oaks sits between Morrison Creek and Sixteen Mile Creek — two active mosquito breeding corridors. Licensed Ontario pesticide operator; treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>River Oaks' Dual-Creek Mosquito Challenge</h2>
          <p>River Oaks is one of Oakville's most established and sought-after neighbourhoods — and its position between two creek systems makes it one of the most mosquito-affected. <strong>Morrison Creek</strong> runs through the neighbourhood's interior, its ravine corridor providing a year-round mosquito breeding habitat with permanent water flow, dense vegetation, and sheltered floodplain areas that retain standing water after every rainfall.</p>
          <p>To the west, the <strong>Sixteen Mile Creek</strong> valley adds a second major source of mosquito pressure. River Oaks' mature tree canopy — one of the neighbourhood's defining features — provides ideal daytime resting habitat for mosquitoes that disperse from both creek corridors each evening. BuzzSkito's barrier spray targets these resting surfaces throughout your property, creating a treated perimeter. Mosquitoes keep dispersing in from both creek systems, so the treatment is repeated through the season rather than done once.</p>

          <h2>Part of Our Oakville Mosquito Control Network</h2>
          <p>We serve all of River Oaks and surrounding Oakville. See our <Link href="/oakville-mosquito-control" className="text-brand-700 hover:underline">Oakville mosquito control</Link> page for city-wide coverage.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting River Oaks properties from Morrison Creek and Sixteen Mile Creek mosquitoes. No contracts." />
    </>
  )
}
