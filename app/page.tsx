  ...
  return (
    <>
      ...
      {/* ── Cinematic scroll-story hero ─────────────────────────────────────
          Pinned scroll-story (CinematicHero.tsx). The <h1>, CTA, and trust
          line render server-side and are visible at scroll progress 0 — that
          frame is the LCP and the full pitch. SEO content below is untouched. */}
      <CinematicHero />
