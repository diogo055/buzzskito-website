...
const FAQS = [
  ...
  { question: 'How often does Mississauga need tick treatment?', answer: 'BuzzSkito recommends five treatments per season — roughly one a month from May through September. Monthly visits keep treatments on schedule through peak nymph season in May–July rather than leaving a multi-month gap. The later visits continue treatments into the adult tick surge that runs through autumn, into November in mild years. Because deer, mice, and birds keep bringing ticks in from the Credit River corridor and nearby conservation lands, repeated applications are what hold the barrier — a one-off visit cannot. Public Health Ontario notes nymphs are poppy-seed sized and easy to miss, so do a tick check after time outdoors.' },
  { question: 'Do ticks really carry Lyme disease in Mississauga?', answer: 'Yes. The blacklegged tick (Ixodes scapularis), which transmits Lyme disease, is established in Mississauga\'s Conservation Areas. Ontario public health data shows increasing Lyme disease cases in the GTA. Professional tick control targets the yard edges where ticks wait for a host; it works alongside tick checks after time outdoors, not instead of them.' },
  ...
  { question: 'What should my family and pets do after a tick treatment?', answer: 'Treatments are applied by an Ontario-licensed pesticide operator (Licence L-240-2436835197), and products are applied according to label directions. Keep children and pets off treated areas until the spray has dried, as the product label directs. We apply to vegetation where ticks rest, not to open lawn or play areas.' },
  { question: 'How does professional tick spray work?', answer: 'We apply a residual barrier to the specific micro-habitats where ticks concentrate: the 1-3 metre transition zone between lawn and natural vegetation, garden bed edges, leaf litter, woodpiles, fence lines, and under decks. Products are applied according to label directions, and the 5-spray season plan renews the treatment roughly monthly from May through September.' },
  ...
  { question: 'How much is a full-season tick program in Mississauga?', answer: 'A standalone seasonal tick program is $597 for 5 sprays across the May–September season (plus HST). If you already have a BuzzSkito mosquito plan, add full-season tick protection for just $497 — a $100 saving. Single treatments start from $99. Pricing scales with lot size for properties from 10,000 to 100,000 sq ft. No contracts, and every plan comes with our rain-back guarantee: rain within 1 hour of a treatment and we come back and re-treat free.' },
...
export default function MississaugaTickPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema({ name: `Tick Spray ${CITY}`, description: `Professional tick barrier spray service in ${CITY}, Ontario. Applied according to label directions.`, slug: '/mississauga-tick-spray', city: CITY, price: null })) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator. Treatments applied according to label directions, for Mississauga properties near the Credit River trails, Rattray Marsh, and conservation-area tick habitat.</>}
        service="tick"
      ...
      <QuickAnswer question="What is the best tick control company in Mississauga?">
        <p>
          <strong>BuzzSkito provides specialist tick barrier spray across all Mississauga neighbourhoods — Port Credit, Meadowvale, Streetsville, Erin Mills, Lorne Park, Clarkson, Cooksville, Lakeview, Churchill Meadows, Mineola, Applewood, Credit Valley.</strong> Treatments are applied by an Ontario-licensed pesticide operator, according to label directions, to the specific 1–3 metre zones where blacklegged ticks concentrate — lawn-to-woods transitions, leaf litter, garden bed edges, and fence-line vegetation. Single treatments start at <strong>$99</strong>; the 5-spray tick season is $597 on its own or $497 added to any mosquito plan. With <strong>150+ five-star Google reviews</strong>, no contracts, and a <strong>rain-back guarantee on every plan</strong>, Mississauga families get targeted tick treatment for ravine, conservation-area, and wooded-edge properties. Call (289) 216-5030.
        </p>
      </QuickAnswer>
      ...
      <TypicalPrices service="tick" city="Mississauga" />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Beyond single visits (from <strong>$99</strong>), most ravine- and conservation-adjacent Mississauga homes choose a full-season tick program that covers tick season from start to finish:</p>
          <div className="not-prose overflow-x-auto my-4">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-amber-700 text-white">
          ...
          <p className="text-sm text-gray-500">Prices scale with lot size (10,000–100,000 sq ft). No contracts. {PROMISES.rainBack}</p>
          ...
          <p>The seasonal program is five treatments, roughly one a month from May through September. Monthly visits keep the barrier renewed across the months blacklegged ticks are active here:</p>
          <div className="not-prose overflow-x-auto my-4">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-amber-700 text-white">
              ...
              <tbody>
                {[
                  ...
                  { t: 'Treatment 2', timing: 'June', target: 'Nymph peak — nymphs are poppy-seed sized and hard to detect' },
          ...
          <CityPriceCard city="Mississauga" service="tick" />
          ...
          <div className="not-prose overflow-x-auto my-4">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {[
                  { type: 'Standard lot (under 10,000 sq ft)', price: 'From $99/treatment', coverage: 'Typical Mississauga semi or detached home' },
                  { type: 'Standard lot, full tick season', price: '$597 · $497 bundled', coverage: '5 sprays May–September, plus HST; $497 with any mosquito plan' },
                  { type: 'Larger lot (10,000–100,000 sq ft)', price: 'Priced by lot size', coverage: 'Port Credit estates, Rattray Marsh area' },
          ...
          <ul>
            <li><strong>Store-bought repellents protect people, not yards.</strong> DEET sprays protect the wearer. Professional yard spray treats the lawn edges and leaf litter where ticks wait for a host.</li>
            ...
            <li><strong>Mississauga&apos;s tick sources are beyond your property.</strong> The Credit River, Rattray Marsh, and Erindale Park will produce ticks every year. A treated barrier on your property is the part you control, alongside tick checks after time outdoors.</li>
          </ul>
          ...
          <ol>
            ...
            <li><strong>Drying time</strong> — keep kids and pets off treated areas until the spray has dried, as the product label directs.</li>
      ...
      <section className="py-14 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { author: 'Priya R.', location: 'Meadowvale', text: 'The technician explained exactly what product they were using. Treated the garden edges and fence line where ticks were coming from. Couldn\'t be happier with the results.' },
      ...
      <div className="max-w-4xl mx-auto px-4">
        <CityPriceCard city="Mississauga" service="tick" location="price_card_faq" />
      </div>
