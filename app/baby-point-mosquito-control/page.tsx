...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Baby Point | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Baby Point, Toronto. Barrier spray near Humber River ravine from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/baby-point-mosquito-control',
})

const NEIGHBOURHOOD = 'Baby Point'
const CITY = 'Toronto'
const SLUG = '/baby-point-mosquito-control'

const FAQS = [
  {
    question: 'Why does Baby Point have such intense mosquito pressure?',
    answer: "Baby Point sits on a promontory directly above the Humber River ravine. The neighbourhood is surrounded on three sides by the ravine system — the Humber River to the west and south, and a deep tributary ravine to the east. This near-total ravine encirclement means virtually every Baby Point property is within dispersal range of one of Toronto's most productive mosquito breeding corridors. The Humber's permanent river flow, floodplain pooling, and dense riparian vegetation sustain season-long mosquito populations.",
  },
  {
    question: 'How does the Humber River ravine affect my Baby Point property?',
    answer: "The Humber River ravine surrounding Baby Point contains permanent water flow, seasonal flood pooling, and thick canopy cover that creates a humid microclimate ideal for mosquito breeding. Baby Point's unique geography — elevated on a bluff above the river — means mosquitoes rise from the valley floor into the neighbourhood each evening. Properties on Baby Point Road, Baby Point Crescent, and Humberview Road along the ravine edge face the most direct exposure.",
  },
  {
    question: 'How many treatments does a Baby Point home need per season?',
    answer: "Baby Point's near-complete ravine encirclement means most properties benefit from the full 5-treatment seasonal program, spaced 21–28 days apart from May through September. The Humber River ravine provides continuous mosquito pressure from multiple directions, making consistent barrier coverage essential. Call (289) 216-5030 for a free property assessment.",
  },
  {
    question: 'When does mosquito season run in Baby Point?',
    answer: "Baby Point's mosquito season runs from late April through September. The Humber River's sheltered valley warms early in spring, enabling early mosquito emergence. Peak pressure runs from late May through July, but the ravine's humidity and permanent water flow sustain significant activity into September. Evening pressure is particularly intense due to the upslope drift of mosquitoes from the valley floor.",
  },
  {
    question: 'Does BuzzSkito serve all of Baby Point?',
    answer: "Yes. We serve all Baby Point streets including those along the ravine edges — Baby Point Road, Baby Point Crescent, Humberview Road, and all interior streets. We also serve surrounding neighbourhoods including The Junction, Bloor West Village, and Swansea. Call (289) 216-5030 to book your free assessment.",
  },
]

export default function BabyPointMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([{ name: 'Home', url: '/' }, { name: 'Mosquito Control', url: '/mosquito-control' }, { name: 'Etobicoke', url: '/etobicoke-mosquito-control' }, { name: NEIGHBOURHOOD, url: SLUG }])) }} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/baby-point-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <nav aria-label="Breadcrumb" className="text-brand-400 text-sm mb-4 flex gap-1 flex-wrap">
            ...
            <Link href="/etobicoke-mosquito-control" className="hover:text-white">Etobicoke</Link><span>/</span>
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Baby Point is surrounded on three sides by the Humber River ravine — one of Toronto's most productive mosquito breeding corridors. BuzzSkito's barrier spray gives Baby Point families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Baby Point's Ravine-Enclosed Mosquito Problem</h2>
          <p>Baby Point occupies a dramatic promontory above the <strong>Humber River</strong>, surrounded on three sides by one of Toronto's deepest ravine systems. This unique geography — the same landscape that makes Baby Point architecturally stunning — creates exceptionally intense mosquito pressure. The Humber River's permanent flow, seasonal floodplain pooling, and dense riparian forest produce large mosquito populations that rise from the valley floor into the neighbourhood each evening.</p>
          <p>The <strong>Humber River ravine</strong> to the west and south, and a tributary ravine to the east, mean that mosquitoes approach Baby Point properties from multiple directions simultaneously. BuzzSkito's barrier spray creates a treated perimeter around your property — targeting the vegetation where mosquitoes rest during the day — providing up to 30 days of protection between treatments regardless of the surrounding ravine pressure.</p>

          <h2>Part of Our Etobicoke Mosquito Control Network</h2>
          <p>We serve all of Baby Point and surrounding west Toronto. See our <Link href="/etobicoke-mosquito-control" className="text-brand-700 hover:underline">Etobicoke mosquito control</Link> page for area-wide coverage.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/baby-point-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
          ...
          <ul>
            ...
            <li><Link href="/blog/mosquito-control-etobicoke-north-york" className="text-brand-700 hover:underline">Mosquito &amp; Tick Control in Etobicoke and North York</Link></li>
          </ul>
        </div>
      </section>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Baby Point properties from Humber River ravine mosquitoes. No contracts." />
    </>
  )
}
