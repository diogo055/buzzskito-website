...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Aldershot | From $99',
  description:
    'Professional mosquito control in Aldershot, Burlington. Barrier spray from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). For RBG-adjacent or waterfront Aldershot properties, the combination of RBG and lakeshore pressure makes Standard's two-week spacing a common recommendation. Call (289) 216-5030 for a free assessment at your specific address.",
  },
  {
...
export default function AldershotMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/aldershot-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Aldershot sits between the Royal Botanical Gardens and Burlington Bay — two of Burlington's most significant mosquito source zones. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
