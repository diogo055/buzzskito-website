  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Aldershot sits between the Royal Botanical Gardens and Burlington Bay — two of Burlington's most significant mosquito source zones. BuzzSkito's barrier spray protects Aldershot families all season long.</>}
