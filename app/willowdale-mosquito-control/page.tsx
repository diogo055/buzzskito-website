...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Willowdale | From $99',
  description:
    'Mosquito control in Willowdale, Toronto. Barrier spray from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Ravine-adjacent Willowdale properties typically benefit from Standard's two-week spacing. Properties in West Willowdale with no direct ravine exposure may be well-served by Basic. Call (289) 216-5030 for a free assessment at your specific address.",
  },
  {
...
export default function WillowdaleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/willowdale-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator treating Willowdale yards along the Don River ravine corridors, where mature canopy keeps mosquito pressure steady all season. Treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>BuzzSkito's barrier spray treats all resting surfaces on your Willowdale property — shrubs, garden borders, fence lines, and accessible undercanopy — creating a treated zone on the resting surfaces arriving mosquitoes use, renewed at each scheduled visit.</p>
