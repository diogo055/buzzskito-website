...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Tyandaga | From $99',
  description:
    'Professional mosquito control in Tyandaga, Burlington. Barrier spray near Tyandaga Park from $99. Licensed Ontario operator. Call (289) 216-5030.',
  canonical: '/tyandaga-mosquito-control',
})

const NEIGHBOURHOOD = 'Tyandaga'
const CITY = 'Burlington'
const SLUG = '/tyandaga-mosquito-control'

const FAQS = [
  {
    question: 'Why does Tyandaga have significant mosquito pressure?',
    answer: "Tyandaga sits at the base of the Niagara Escarpment, where moisture from the escarpment slopes drains into the neighbourhood's mature ravines and creek corridors. Tyandaga Park and the surrounding escarpment trail system contain dense vegetation and seasonal water pooling that create ideal mosquito breeding habitat. The neighbourhood's established tree canopy and proximity to escarpment woodlands sustain mosquito populations from May through September.",
  },
  {
    question: 'How does the Niagara Escarpment affect mosquito activity in Tyandaga?',
    answer: "The Niagara Escarpment creates a cooler, more humid microclimate along Tyandaga's western edge. Groundwater seepage from the escarpment feeds small streams and wet depressions that serve as mosquito breeding sites throughout the season. Properties backing onto escarpment trails or wooded escarpment slopes experience the most consistent pressure because this habitat is permanent and untreatable at the source.",
  },
  {
    question: 'How many treatments does a Tyandaga home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties directly adjacent to Tyandaga Park or the escarpment trails typically benefit from Standard's two-week spacing due to continuous re-pressure from nearby breeding habitat; other Tyandaga lots may be well-served by Basic. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in Tyandaga?',
    answer: "Tyandaga's mosquito season typically runs from early May through September. The escarpment's groundwater seepage and shaded ravines allow earlier spring mosquito emergence compared to open suburban areas. Peak activity is from late May through July, with a secondary peak in August after summer rain events.",
  },
  {
    question: 'Does BuzzSkito serve all of Tyandaga Burlington?',
    answer: "Yes. We serve all Tyandaga streets including those adjacent to Tyandaga Park and the escarpment trail system. We also serve all surrounding Burlington neighbourhoods. Call (289) 216-5030 to confirm service at your specific Tyandaga address.",
  },
]

export default function TyandagaMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/tyandaga-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator treating Tyandaga yards at the foot of the Niagara Escarpment, where Tyandaga Park keeps mosquito pressure up all season. Treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Tyandaga's Escarpment Mosquito Challenge</h2>
          <p>Tyandaga is one of Burlington's most sought-after escarpment neighbourhoods — and one of the most mosquito-affected due to its geography. <strong>Tyandaga Park</strong> and the adjoining <strong>Niagara Escarpment trail system</strong> run along the neighbourhood's western edge, with mature forest canopy, groundwater seepage, and seasonal creek flow that sustain active mosquito populations throughout the warm months. Properties that back onto the park or escarpment woodlands face consistent evening dispersal from these permanent breeding zones.</p>
          <p>The neighbourhood's <strong>established tree canopy</strong> and ravine-influenced topography create the cool, shaded, humid conditions that adult mosquitoes seek for daytime resting. BuzzSkito's barrier spray targets all resting vegetation on your Tyandaga property — shrub interiors, leaf undersides, fence lines, and garden bed perimeters — creating a treated buffer that is renewed at each scheduled visit through the season.</p>

          <h2>Part of Our Burlington Mosquito Control Network</h2>
          <p>We serve all of Tyandaga and surrounding Burlington. See our <Link href="/burlington-mosquito-spray" className="text-brand-700 hover:underline">Burlington mosquito spray</Link> page for city-wide coverage, or our pages for <Link href="/alton-village-mosquito-control" className="text-brand-700 hover:underline">Alton Village</Link> and <Link href="/roseland-mosquito-control" className="text-brand-700 hover:underline">Roseland</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Tyandaga properties from escarpment and park mosquitoes. No contracts." />
    </>
  )
}
