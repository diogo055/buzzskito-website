  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Tyandaga's escarpment setting and proximity to Tyandaga Park create persistent mosquito pressure throughout the season. BuzzSkito's barrier spray gives Tyandaga families 30-day protection per treatment.</>}
