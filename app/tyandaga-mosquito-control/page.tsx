...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Tyandaga | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Tyandaga, Burlington. Barrier spray near Tyandaga Park from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Most Tyandaga properties benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties directly adjacent to Tyandaga Park or the escarpment trails may benefit from the full 5-treatment program due to continuous re-pressure from nearby breeding habitat. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function TyandagaMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/tyandaga-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Tyandaga's escarpment setting and proximity to Tyandaga Park create persistent mosquito pressure throughout the season. BuzzSkito's barrier spray gives Tyandaga families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/tyandaga-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
