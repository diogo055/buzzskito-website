...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Dundas | From $99 · 5★ Rated',
  description:
...
const CITY = 'Hamilton'
const SLUG = '/dundas-mosquito-control'

const FAQS = [
  {
    question: 'Why does Dundas have such intense mosquito pressure?',
    answer: "Dundas is surrounded by some of the most productive mosquito breeding habitat in southern Ontario. Cootes Paradise — a 600-hectare coastal marsh at the western tip of Lake Ontario — sits directly north of Dundas, producing enormous mosquito populations. Spencer Creek runs through the heart of Dundas, creating a permanent breeding corridor. The Dundas Valley Conservation Area adds forested escarpment wetlands to the south. This three-source convergence makes Dundas one of the most mosquito-affected communities in the Hamilton area.",
  },
  {
    question: 'How does Cootes Paradise affect mosquito levels in Dundas?',
    answer: "Cootes Paradise is one of the Great Lakes basin's most significant coastal wetlands, and it produces massive mosquito populations each season. The marsh's cattail beds, emergent vegetation, and shallow water zones are among the most productive breeding habitat in the region. Dundas properties on the north side of town — particularly those near the Desjardins Canal and the Royal Botanical Gardens boundary — face direct dispersal pressure from this enormous source throughout the season.",
  },
  {
  ...
  },
  {
    ...
    answer: "Spencer Creek is one of the primary mosquito breeding corridors in the Dundas area. The creek runs directly through the town centre, with slow-moving sections, backwater pools, and riparian vegetation that sustain breeding habitat from spring through fall. Properties along the Spencer Creek corridor — particularly near the Dundas Driving Park and the creek's passage through the downtown area — experience the most direct creek-related pressure.",
  },
  {
    question: 'Does BuzzSkito serve all of Dundas?',
    answer: "Yes. We serve all Dundas streets including those near Cootes Paradise, Spencer Creek, and the Dundas Valley Conservation Area. We also serve all surrounding Hamilton communities including Ancaster and Westdale. Call (289) 216-5030 to confirm service at your specific Dundas address.",
  },
]

export default function DundasMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/dundas-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Dundas faces mosquito pressure from three major sources: Cootes Paradise marsh, Spencer Creek, and the Dundas Valley. BuzzSkito's barrier spray gives Dundas families 30-day protection per treatment.
          </p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Dundas properties from marsh, creek, and valley mosquitoes. No contracts." />
    </>
  )
}
