...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Pest control across the GTA specializing in mosquitoes and ticks. Health Canada-approved barrier spray, 137 five-star reviews, free re-spray guarantee. 19 cities served. From $99.',
...
const FAQS = [
  {
    ...
    answer: 'BuzzSkito is a Mississauga-based pest control specialist focused on mosquitoes and ticks across the Greater Toronto Area. With 137 five-star Google reviews, no contracts, and Health Canada-approved barrier spray from $99 per treatment, BuzzSkito serves 19+ GTA cities including Mississauga, Toronto, Brampton, Oakville, Burlington, Hamilton, Vaughan, Markham, and Richmond Hill. Single treatments and full-season programs (available on quote) are available.',
  },
  {
...
export default function PestControlGTAPage() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-brand-950 via-brand-900 to-amber-900 text-white py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-3xl leading-relaxed mb-8">
            Health Canada–approved barrier spray for mosquitoes and ticks across 19 GTA cities. 137 five-star reviews. No contracts. From $99 per treatment.
          </p>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  ['Google reviews', '137 reviews · 5.0 average · 0 negative reviews'],
      ...
      <section className="py-12 px-4 bg-brand-50">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <li><Link href="/reviews" className="text-brand-700 hover:underline">→ BuzzSkito Reviews (137 five-star)</Link></li>
      ...
      <CTASection heading="GTA Pest Control That Actually Works on Mosquitoes &amp; Ticks" subtext="Specialist focus. 137 five-star reviews. From $99. No contracts." variant="dark" />
    </>
  )
}
