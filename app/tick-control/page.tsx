    ...
    <>
      ...
      <section aria-labelledby="tick-included" className="py-14 px-4 bg-brand-50">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 id="tick-included" className="h2-display text-brand-900 mb-10 text-center">What's Included in Every Tick Treatment</h2>
      ...
      <section aria-labelledby="tick-cities" className="py-14 px-4 bg-brand-50">
        <div className="max-w-5xl mx-auto">
          ...
          <h2 id="tick-cities" className="h2-display text-brand-900 mb-4 text-center">Tick Control by City</h2>
      ...
      <section aria-labelledby="tick-faq" className="py-14 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 id="tick-faq" className="h2-display text-brand-900 text-center mb-8">Tick Control FAQ</h2>
