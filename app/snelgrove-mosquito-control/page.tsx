...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Snelgrove properties — particularly the larger rural lots common in the area — typically benefit from 4-5 treatments spaced 21-28 days apart from May through September. Larger properties may require extended treatment time due to increased perimeter vegetation. Call (289) 216-5030 for a free property assessment and custom quote for your Snelgrove property.",
  },
  {
...
export default function SnelgroveMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/snelgrove-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Snelgrove's rural character and Etobicoke Creek headwaters create ideal conditions for mosquitoes. BuzzSkito's barrier spray gives Snelgrove families up to 30-day protection per treatment — even on larger lots.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/snelgrove-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
