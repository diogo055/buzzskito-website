...
export default function MosquitoControlPricingPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/mosquito-control-pricing', '2026-07-01')) }} />

      {/* Hero */}
      <CityHero
        breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Mosquito Control', href: '/mosquito-control' }, { label: 'Pricing' }]}
        title={<>Mosquito Control Pricing &mdash; Ontario 2026</>}
        subtitle={<>Transparent pricing. No hidden fees. No contracts. BuzzSkito seasonal packages seasonal programs available on quote. Single treatments from $99. Here&rsquo;s exactly what you&rsquo;ll pay.</>}
