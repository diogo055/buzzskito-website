...
const SLUG = '/pest-control-king-city'
...
const FAQS = [
  ...
  },
  {
    ...
    answer: `General pest control companies offer 10–20 services — ants, mice, wasps, spiders, mosquitoes, ticks, etc. They train technicians on a wide catalogue and rotate between treatment types. A specialist (like BuzzSkito for mosquitoes and ticks) does one thing repeatedly. Our technicians know exactly where mosquitoes and ticks rest in ${CITY} backyards (Oak Ridges Moraine, rural estate properties, agricultural edges) and apply targeted barrier spray to those specific zones. The result: each visit goes where mosquitoes and ticks actually rest in your yard.`,
  },
  {
  ...
  },
  {
    ...
    answer: `BuzzSkito serves all of ${CITY} for mosquito and tick control, with particular expertise in properties exposed to Oak Ridges Moraine, rural estate properties, agricultural edges. Same-week service is typical during the May–September season. Call (289) 216-5030 to confirm your specific address.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Book your first mosquito barrier spray in mid-May for most ${CITY} properties — properties adjacent to Oak Ridges Moraine, rural estate properties, agricultural edges benefit from an early-May start. Tick control is 5 sprays per season, starting in late May (nymph emergence) and running through August/September (adult activity). We'll help schedule your first appointment when you call (289) 216-5030.`,
  },
  {
...
export default function PestControlKingCityPage() {
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator focused only on <strong>mosquitoes and ticks</strong> in {CITY} yards on the Oak Ridges Moraine, from rural estates to agricultural edges. Treatments applied according to label directions.</>}
      />

      {/* QUICK ANSWER */}
      <QuickAnswer question={`Who is the best pest control company for mosquitoes and ticks in ${CITY}?`}>
        <p>
            <strong>BuzzSkito is {CITY}'s specialist pest control company for mosquitoes and ticks — the two outdoor pests that drive backyard misery during the GTA's May-September season.</strong> Unlike general pest control companies that cover 10–20 pests across all categories, BuzzSkito focuses exclusively on barrier spray for mosquitoes and ticks, allowing us to develop deeper expertise in {CITY}-specific pressure zones (Oak Ridges Moraine, rural estate properties, agricultural edges). Single treatments start at <strong>$99</strong> on a standard lot under 10,000 sq ft, with season plans from $549. With <strong>150+ five-star Google reviews</strong> (zero negative), no contracts, the rain-back guarantee on every plan, and the <strong>BuzzSkito Bite-Free Guarantee</strong> on Standard &amp; Exclusive plans, {CITY} families get specialist results without specialist pricing. We don't treat ants, rodents, or other pests — for those, hire a general pest control company. For mosquitoes and ticks in {CITY}, call (289) 216-5030.
        </p>
      </QuickAnswer>
            ...
            <table className="w-full text-sm">
              <tbody>
                {[
                  ...
                  [`${CITY} pressure zones`, "Oak Ridges Moraine, rural estate properties, agricultural edges"],
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Here's what specialization buys you on a {CITY} property exposed to Oak Ridges Moraine, rural estate properties, agricultural edges:</p>
          <ul>
          ...
          <ul>
            <li><strong>Mosquito barrier spray</strong> — residual formula applied according to label directions to vegetation, shrub interiors, and resting sites, re-applied on your plan's schedule (monthly, every 2 weeks or weekly). <Link href="/king-city-mosquito-control">See {CITY} mosquito control →</Link></li>
            <li><strong>Tick barrier spray</strong> — targeted treatment of the 1–3 metre lawn-to-woods transition zone where blacklegged ticks and dog ticks concentrate. <Link href="/king-city-tick-spray">See {CITY} tick control →</Link></li>
          ...
          <p>Most {CITY} backyards in the Oak Ridges Moraine, rural estate properties, agricultural edges exposure zone are squarely in the "call BuzzSkito" category. Mosquitoes and ticks are the dominant pests in residential GTA properties — everything else is rarer or seasonal.</p>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-2">
            <li>→ <Link href="/king-city-mosquito-control" className="text-brand-700 hover:underline font-semibold">{CITY} Mosquito Control</Link> — our specialty barrier spray for mosquitoes</li>
            <li>→ <Link href="/king-city-tick-spray" className="text-brand-700 hover:underline font-semibold">{CITY} Tick Control</Link> — yard tick spray for lawn edges and wooded borders</li>
