...
export default function CastlemoreMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/castlemore-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Castlemore's proximity to Claireville Conservation Area and the Humber River creates consistent season-long mosquito pressure. BuzzSkito provides professional barrier spray so Castlemore families can enjoy their outdoor spaces.</>}
