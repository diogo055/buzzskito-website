...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'We treat the perimeter and surrounding vegetation around ponds, water features, and seasonal wet areas — but not the water itself. For active mosquito breeding in a pond, we use a BTI (Bacillus thuringiensis israelensis) larvicide applied according to its label directions, which targets mosquito larvae in the water. Pairing barrier spray on the surrounding vegetation with BTI in standing water addresses both the adults resting nearby and the larvae, which is why we use both on estate properties with water features.',
  },
  {
    question: 'Do estate properties need tick treatment in addition to mosquito treatment?',
    answer: "Almost always yes. Estate properties typically have higher tick pressure than suburban homes due to four factors: (1) deer access (large properties = larger ranging area for white-tailed deer carrying ticks), (2) mature woodlot edges (prime blacklegged tick questing habitat), (3) leaf litter accumulation in landscape beds and forest edges, (4) proximity to conservation land or rural agricultural fringe. Our standard estate package combines mosquito and tick barrier treatment at the same visit — same vegetation surfaces, same equipment. Tick add-on for estate properties typically runs $497-$997 for the full season (5 treatments).",
  },
  {
    question: "How are treatments timed around horses, livestock, dogs, and kids on a large property?",
    answer: "Products are applied by a licensed technician according to their label directions, and people and animals stay off treated areas until the spray has dried, as the product label directs. We coordinate application timing with our estate clients so horses, livestock, and dogs can be moved or stabled until the treated areas have dried. Around horse paddocks, vegetable gardens, and fish ponds, we maintain documented buffer zones. Treatments are performed under our Ontario Pesticide Operator Licence " + BUSINESS.licenseNumber + ".",
  },
  {
    question: "How far ahead should I book an estate treatment before an event?",
    answer: "For confirmed estate clients, pre-event treatments (weddings, family gatherings, garden parties, charity events) get scheduling priority, and we book a visit window, never an exact arrival time. Pre-event applications cost the same as standard scheduled treatments for existing clients. New clients can typically be onboarded with a same-week site visit and treatment, though 5-10 day advance booking is recommended during peak season (June-August). Call (289) 216-5030 to book.",
  },
  {
    question: 'Do you provide a written treatment record for property management or insurance purposes?',
    answer: "Yes. Estate clients receive a written treatment log after every visit including: date and time of application, technician name and licence number, products applied with batch numbers and PCP registration numbers, treated zones with property map, weather conditions during application, and any property-specific observations (rising tick pressure, new water sources, etc.). This documentation is suitable for property management records, insurance, or for clients who want a defensible record of pest management activity.",
  },
]

export const metadata: Metadata = buildMetadata({
  title: 'Estate & Acreage Mosquito Control GTA · 1-10 Acre Properties · From $200',
  description: "Specialized mosquito and tick barrier spray for estate and acreage properties in the GTA. Caledon, Kleinburg, King City, Oak Ridges Moraine, large Oakville/Mississauga lots. Licensed operator, rain-back guarantee, 150+ five-star reviews. Call (289) 216-5030.",
  canonical: SLUG,
})
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. Commercial-grade equipment, multi-zone application, and seasonal programs designed for 1-10 acre lots in Caledon, Kleinburg, King City, the Oak Ridges Moraine, and beyond.</>}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-amber-50 to-white border-2 border-amber-200 p-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">Estate properties are essentially mini-conservation areas: mature trees, leaf litter, woodland margins, deer access, and proximity to natural corridors. Much of the Oak Ridges Moraine, the Niagara Escarpment edge, and the Caledon hills is the kind of habitat blacklegged ticks need; check Public Health Ontario&rsquo;s Vector-Borne Disease Tool for the current mapped risk area at a specific address. For most estate properties, tick treatment belongs in the plan.</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ol className="space-y-5">
            {[
              ...
              { n: 5, t: 'Scheduled follow-up visits', d: 'Subsequent visits are scheduled at 21-28 day intervals, because new mosquitoes and ticks keep arriving from surrounding habitat. Estate seasonal packages include 5-10 treatments from May through September.' },
              { n: 6, t: 'Rain-back guarantee', d: `${PROMISES.rainBack} The ${BUSINESS.guarantee.short} applies to Standard & Exclusive plans only; ask whether your estate package includes it.` },
            ].map(s => (
      ...
      <CTASection heading="Get your estate property quote" subtext="Free site visit · Written quote · No obligation" />
    </>
  )
}
