...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Joshua Creek, Oakville. Barrier spray near Joshua Creek ravine from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "For properties adjacent to the Joshua Creek ravine, we recommend 4-5 barrier spray treatments from May through September. The ravine's permanent water and dense vegetation mean consistent mosquito production throughout the season. Properties farther from the ravine may be well-served by 3-4 treatments. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'Is BuzzSkito spray safe near the Joshua Creek ravine ecosystem?',
    answer: "Yes. Our Health Canada-approved formula is applied only to vegetation on your private property — not in the ravine itself or near waterways. We target leaf undersides, shrub interiors, and fence lines where mosquitoes rest. The water-based formula dries within 30 minutes and poses no risk to the adjacent ravine ecosystem, children, or pets.",
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>The Joshua Creek ravine system runs directly through this neighbourhood, generating persistent mosquito pressure all season. BuzzSkito's barrier spray gives Joshua Creek families up to 30-day protection per treatment.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/oakville-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
