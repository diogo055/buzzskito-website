...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control The Annex | From $99',
  description:
    'Professional mosquito control in The Annex, Toronto. Barrier spray near Wychwood Park from $99. Ontario-licensed. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Homes near Wychwood Park, Bickford Park, or the northern ravine corridors typically benefit from Standard's two-week spacing. Interior Annex properties with less direct exposure to green space may do well with Basic. Call (289) 216-5030 for a free property assessment.",
  },
  {
...
export default function TheAnnexMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/the-annex-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>The Annex's mature tree canopy, proximity to Wychwood Park, and connection to Toronto's ravine corridors create persistent mosquito pressure. Licensed Ontario pesticide operator; treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>The neighbourhood's own mature tree canopy and dense residential gardens provide abundant resting habitat for arriving mosquitoes. BuzzSkito's barrier spray targets these resting surfaces — leaf undersides, shrub interiors, and fence lines — creating a treated zone that knocks down what is resting there and holds a residual on those surfaces. Mosquitoes keep dispersing in from surrounding blocks, so the treatment is repeated through the season.</p>
