  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>The Annex's mature tree canopy, proximity to Wychwood Park, and connection to Toronto's ravine corridors create persistent mosquito pressure. BuzzSkito's barrier spray gives Annex families 30-day protection per treatment.</>}
