  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Don Mills' planned green corridors and ravine proximity to the Don Valley create ideal conditions for season-long mosquito activity. BuzzSkito delivers professional barrier spray so Don Mills families can reclaim their outdoor spaces.</>}
      />
