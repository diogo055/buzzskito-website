...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Don Valley-adjacent Don Mills properties typically benefit from Standard's two-week spacing; properties further from the ravine may be well-served by Basic. Call (289) 216-5030 for a free property assessment and recommended schedule.",
  },
  {
...
export default function DonMillsMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/don-mills-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator, with treatments applied according to label directions. Don Mills' planned green corridors and ravine proximity to the Don Valley create ideal conditions for season-long mosquito activity.</>}
      />
