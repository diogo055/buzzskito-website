...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Mount Pleasant | From $99 · 5★ Rated',
  description:
...
const CITY = 'Brampton'
const SLUG = '/mount-pleasant-mosquito-control'

const FAQS = [
  {
    question: 'Why does Mount Pleasant have significant mosquito pressure?',
    answer: "Mount Pleasant's mosquito pressure is driven primarily by the Credit River, which flows through the neighbourhood's western edge. The Credit River valley provides one of the most significant mosquito breeding corridors in the Brampton area — permanent water flow, extensive floodplain habitat, dense riparian forest, and standing pools that produce mosquitoes continuously from spring through fall. Mount Pleasant Village's newer landscaping and stormwater features can also accumulate standing water.",
  },
  {
    question: 'How does the Credit River affect mosquitoes in Mount Pleasant?',
    answer: "The Credit River is one of the GTA's largest waterways, and its valley corridor near Mount Pleasant contains permanent water flow, saturated floodplain soils, and dense bankside vegetation. These conditions produce mosquitoes continuously throughout the season. The river's protected valley corridor means this habitat is permanent and untreatable at the source. Mosquitoes disperse up to 3 km from the river, placing all of Mount Pleasant within the primary dispersal zone.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. We serve all Mount Pleasant streets including the established areas near the Credit River and the newer Mount Pleasant Village development. We also serve all surrounding Brampton neighbourhoods. Call (289) 216-5030 to confirm service at your specific address.",
  },
]

export default function MountPleasantMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/mount-pleasant-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Mount Pleasant's proximity to the Credit River valley creates persistent mosquito pressure throughout the season. BuzzSkito's barrier spray gives Mount Pleasant families up to 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/mount-pleasant-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Mount Pleasant properties from Credit River mosquitoes. No contracts." />
    </>
  )
}
