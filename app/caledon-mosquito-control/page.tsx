...
export const metadata: Metadata = buildMetadata({
  title: 'Caledon Mosquito Control 2026 · From $99 · 129 Five-Star Reviews',
  description:
    ...
    <>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Looking at all your Caledon pest control options? See our specialist guide: <Link href="/pest-control-caledon" className="text-brand-700 hover:underline font-semibold">Pest Control in Caledon</Link> — explains why a mosquito and tick specialist beats a generalist for the two pests that actually drive Caledon backyard misery.</p>
