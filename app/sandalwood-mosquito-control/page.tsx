...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Sandalwood | From $99',
  description:
    'Professional mosquito control in Sandalwood, Brampton. Barrier spray near Claireville Conservation Area from $99. Ontario-licensed. Call (289) 216-5030.',
  canonical: '/sandalwood-mosquito-control',
})

const NEIGHBOURHOOD = 'Sandalwood'
const CITY = 'Brampton'
const SLUG = '/sandalwood-mosquito-control'

const FAQS = [
  {
    question: 'Why does Sandalwood have heavy mosquito pressure?',
    answer: "Sandalwood's mosquito pressure is driven by two major natural features. The Claireville Conservation Area — one of the largest protected green spaces in the GTA — borders the neighbourhood's eastern edge, sustaining permanent wetland and creek habitat that produces large mosquito populations throughout the season. The West Humber River also flows through the area, adding a second breeding corridor with standing pools, saturated floodplain soils, and dense riparian vegetation.",
  },
  {
    question: 'How does the Claireville Conservation Area affect mosquito activity in Sandalwood?',
    answer: "The Claireville Conservation Area contains over 800 acres of protected wetland, forest, and meadow habitat. Its permanent wetlands, the West Humber River corridor, and numerous tributary channels produce mosquitoes continuously from spring through fall. Because the conservation area is protected, this breeding habitat is permanent and cannot be treated at the source. Mosquitoes disperse up to 3 km into adjacent residential areas, placing Sandalwood directly in the dispersal zone.",
  },
  {
    question: 'How many treatments does a Sandalwood property need?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Sandalwood properties near the Claireville Conservation Area or the West Humber River typically benefit from Standard's two-week spacing. The conservation area's permanent wetlands make Sandalwood one of the Brampton neighbourhoods where we most commonly recommend the more frequent plans. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in Sandalwood?',
    answer: "Mosquito season in Sandalwood typically begins in late April or early May, as the Claireville Conservation Area's permanent wetlands provide early-season breeding habitat as soon as temperatures consistently reach 10°C. Peak mosquito activity is from late May through July. The season extends into September or early October, with the conservation area sustaining late-season populations longer than areas without permanent water features.",
  },
  {
    question: 'Does BuzzSkito serve all of Sandalwood in Brampton?',
    answer: "Yes. We serve all Sandalwood streets including properties near the Claireville Conservation Area and the West Humber River. We also serve all surrounding Brampton neighbourhoods. Call (289) 216-5030 to confirm service at your specific Sandalwood address.",
  },
]

export default function SandalwoodMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/sandalwood-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Sandalwood borders the Claireville Conservation Area and West Humber River — two of Brampton's largest mosquito breeding zones. Licensed Ontario pesticide operator; treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Sandalwood's Conservation Area Mosquito Challenge</h2>
          <p>Sandalwood is one of northeast Brampton's most established residential communities, bordered by the <strong>Claireville Conservation Area</strong> — over 800 acres of protected wetland, forest, and meadow habitat. This conservation area is one of the GTA's most significant mosquito breeding zones, containing permanent wetlands, the <strong>West Humber River</strong> corridor, and numerous tributary channels that produce mosquitoes continuously from spring through fall.</p>
          <p>Because the conservation area is protected, this breeding habitat is permanent and cannot be treated at the source. Mosquitoes produced in these wetlands disperse into adjacent Sandalwood properties each evening, creating consistent pressure throughout the season. BuzzSkito's barrier spray creates a treated perimeter on your property — targeting leaf undersides, shrub interiors, fence lines, and all resting surfaces — and because dispersal from the conservation area is ongoing, the treatment is repeated through the season.</p>

          <h2>Part of Our Brampton Mosquito Control Network</h2>
          <p>We serve all of Sandalwood and surrounding Brampton. See our <Link href="/brampton-mosquito-control" className="text-brand-700 hover:underline">Brampton mosquito control</Link> page for city-wide coverage.</p>
          ...
          <p>We also offer professional tick control in this area. Blacklegged ticks can carry Lyme disease, and our targeted tick barrier spray runs 5 sprays per season, $597 on its own or $497 with any mosquito plan. See our <Link href="/brampton-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Sandalwood properties from Claireville Conservation Area mosquitoes. No contracts." />
    </>
  )
}
