...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Sandalwood | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Sandalwood, Brampton. Barrier spray near Claireville Conservation Area from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Sandalwood properties near the Claireville Conservation Area or the West Humber River typically benefit from 4-5 treatments spaced 21-28 days apart from May through September. The conservation area's permanent wetlands make Sandalwood one of the Brampton neighbourhoods where we most commonly recommend the full 5-treatment season program. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function SandalwoodMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/sandalwood-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Sandalwood borders the Claireville Conservation Area and West Humber River — two of Brampton's largest mosquito breeding zones. BuzzSkito's barrier spray gives Sandalwood families up to 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/sandalwood-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
