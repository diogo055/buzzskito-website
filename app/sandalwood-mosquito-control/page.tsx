  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Sandalwood borders the Claireville Conservation Area and West Humber River — two of Brampton's largest mosquito breeding zones. BuzzSkito's barrier spray gives Sandalwood families up to 30-day protection per treatment.</>}
      />
