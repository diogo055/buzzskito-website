...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Leaside | From $99',
  description:
    'Mosquito control in Leaside, Toronto. Barrier spray near Don Valley from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). For Don Valley or Taylor Creek-adjacent Leaside properties, we typically recommend Standard's two-week spacing; interior properties with no direct ravine exposure may be well-served by Basic. Call (289) 216-5030 for a free assessment tailored to your specific property.",
  },
  {
  ...
  {
    question: "How is BuzzSkito's spray applied around Leaside's established residential gardens?",
    answer: "Our water-based spray is applied according to label directions by an Ontario-licensed pesticide operator (Licence L-240-2436835197). We apply it to the resting surfaces mosquitoes use — leaf undersides and shrub foliage — not to blooms, bare soil, or tree trunks, and we keep clear of vegetable and herb gardens. Keep children and pets off treated areas until the spray has dried, as the product label directs.",
  },
]
...
export default function LeasideMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/leaside-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Leaside's proximity to the Don Valley and Taylor Creek corridors creates consistent seasonal mosquito pressure. BuzzSkito provides professional barrier spray so Leaside families can reclaim their outdoor spaces.</>}
      />
      ...
      <TypicalPrices service="mosquito" city="Leaside" />
      ...
      <div className="max-w-4xl mx-auto px-4">
        <CityPriceCard city="Leaside" service="mosquito" location="price_card_faq" />
      </div>
