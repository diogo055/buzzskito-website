...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Ajax | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Ajax, Durham Region. Barrier spray near Duffins Creek from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/ajax-mosquito-control',
})

const NEIGHBOURHOOD = 'Ajax'
const CITY = 'Durham Region'
const SLUG = '/ajax-mosquito-control'

const FAQS = [
  {
    question: 'Why does Ajax have significant mosquito pressure?',
    answer: "Ajax faces mosquito pressure from multiple waterway systems converging near the Lake Ontario shoreline. Duffins Creek — one of Durham Region's most significant watercourses — runs through the west side of Ajax with extensive floodplain wetlands and riparian forest. Carruthers Creek flows through the east side, creating a second breeding corridor. The Ajax Waterfront along Lake Ontario adds high-humidity coastal conditions that extend evening mosquito activity. This combination of creek corridors and waterfront makes Ajax one of Durham Region's most mosquito-affected communities.",
  },
  {
    question: 'How does Duffins Creek affect mosquito levels in Ajax?',
    answer: "Duffins Creek is one of the largest creek systems in the eastern GTA, and it runs through Ajax's west side with a wide, forested floodplain valley. The creek's slow-moving sections, backwater pools, and dense riparian vegetation create continuous breeding habitat from spring through fall. The Duffins Creek valley trail system and surrounding conservation land are untreatable at the source, making properties adjacent to the valley some of the most consistently mosquito-affected in Ajax.",
  },
  {
    question: 'How many treatments does an Ajax property need per season?',
    answer: "Most Ajax properties benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties adjacent to Duffins Creek, Carruthers Creek, or the Lake Ontario waterfront typically benefit from the full 5-treatment program. Interior Ajax properties with less direct water exposure may be well-served by 3–4 treatments. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'Does the Ajax Waterfront create mosquito problems?',
    answer: "The Ajax Waterfront park and the Lake Ontario shoreline create a high-humidity coastal zone that sustains mosquito activity later into the evening hours. Shoreline vegetation, the rotary park wetlands, and the natural areas along the waterfront trail provide both breeding and resting habitat. Properties in south Ajax near the waterfront experience a combination of lakefront and creek-corridor pressure that makes professional barrier spray particularly effective.",
  },
  {
    question: 'Does BuzzSkito serve all of Ajax?',
    answer: "Yes. We serve all Ajax neighbourhoods from the waterfront through to north Ajax. This includes properties near Duffins Creek, Carruthers Creek, the Ajax Waterfront, and all residential areas. We also serve adjacent Pickering and Whitby. Call (289) 216-5030 to confirm service at your specific Ajax address.",
  },
]

export default function AjaxMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema([{ name: 'Home', url: '/' }, { name: 'Mosquito Control', url: '/mosquito-control' }, { name: NEIGHBOURHOOD, url: SLUG }])) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema(FAQS)) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howToSchema({ service: 'mosquito', city: 'Ajax' })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/ajax-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Ajax's Duffins Creek, Carruthers Creek, and Lake Ontario waterfront create multi-source mosquito pressure across the community. BuzzSkito's barrier spray gives Ajax families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Ajax's Creek and Waterfront Mosquito Problem</h2>
          <p>Ajax is defined by its waterways — and those waterways drive the community's mosquito pressure. <strong>Duffins Creek</strong>, one of Durham Region's most significant watercourses, runs through Ajax's west side with a wide, forested floodplain valley that creates extensive mosquito breeding habitat. The creek's slow-moving sections, seasonal flooding, and dense riparian vegetation make it a permanent source of mosquito pressure for adjacent residential areas.</p>
          <p><strong>Carruthers Creek</strong> runs through Ajax's east side, creating a second breeding corridor. Between these two creek systems, the <strong>Ajax Waterfront</strong> along Lake Ontario adds high-humidity coastal conditions and shoreline vegetation that sustain additional mosquito activity. BuzzSkito's barrier spray targets all resting vegetation on your Ajax property — shrub interiors, leaf undersides, fence lines, and garden beds — creating a treated buffer that provides up to 30 days of protection between treatments.</p>

          <h2>Serving Ajax and Eastern GTA</h2>
          <p>We serve all of Ajax and surrounding Durham Region communities. See our <Link href="/scarborough-mosquito-control" className="text-brand-700 hover:underline">Scarborough mosquito control</Link> page for western coverage, or our <Link href="/pickering-mosquito-control" className="text-brand-700 hover:underline">Pickering</Link> page for adjacent community coverage.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/ajax-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Ajax properties from creek and waterfront mosquitoes. No contracts." />
    </>
  )
}
