...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Riverdale, Toronto. Barrier spray near Don Valley from $99. Ontario-licensed. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Riverdale properties near the Don Valley or Riverdale Park typically benefit from Standard's two-week spacing. The Don Valley's proximity and the scale of its mosquito population make consistent treatment essential for properties on the west side of the neighbourhood. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function RiverdaleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/riverdale-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Riverdale's position directly on the Don Valley — Toronto's central mosquito corridor — creates some of the city's most intense seasonal pressure. Licensed Ontario pesticide operator; treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>The <strong>Cabbagetown ravine</strong> to the northwest provides a secondary corridor connecting Riverdale to the broader Don Valley system. BuzzSkito's barrier spray creates a treated perimeter around your Riverdale property — targeting all resting vegetation where valley-bred mosquitoes settle — knocking down what is resting there and leaving a residual behind. Valley-bred mosquitoes keep dispersing back in, so the treatment is repeated through the season rather than done once.</p>
