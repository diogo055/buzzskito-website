...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Riverdale | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Riverdale, Toronto. Barrier spray near Don Valley from $99. Safe for kids & pets. Call (289) 216-5030.',
  canonical: '/riverdale-mosquito-control',
})

const NEIGHBOURHOOD = 'Riverdale'
const CITY = 'Toronto'
const SLUG = '/riverdale-mosquito-control'

const FAQS = [
  {
    question: 'Why does Riverdale have such intense mosquito pressure?',
    answer: "Riverdale sits directly on the Don Valley — one of Toronto's largest and most active mosquito corridors. The Don River, its floodplain, and the dense ravine vegetation sustain massive mosquito populations from May through September. Riverdale Park itself, with its sloped terrain draining toward the valley, creates additional moisture zones. The Cabbagetown ravine to the northwest adds a secondary corridor. Properties on Riverdale's west side facing the valley experience some of the most intense seasonal mosquito pressure in all of Toronto.",
  },
  {
    question: 'How does the Don Valley affect mosquito activity in Riverdale homes?',
    answer: "The Don Valley is Toronto's central mosquito corridor — its permanent river flow, floodplain pooling after rainfall, and dense forest canopy create continuous mosquito breeding habitat stretching from the Forks of the Don south to the lake. Riverdale's west-facing slope overlooks this corridor directly. Evening dispersal pushes mosquitoes uphill into Riverdale properties along Broadview Avenue, De Grassi Street, and throughout the neighbourhood. Mosquitoes from the valley can travel up to 3 km, reaching all of Riverdale's residential streets.",
  },
  {
    question: 'How many treatments does a Riverdale property need per season?',
    answer: "Riverdale properties near the Don Valley or Riverdale Park typically benefit from 4–5 treatments spaced 21–28 days apart from May through September. The Don Valley's proximity and the scale of its mosquito population make consistent treatment essential for properties on the west side of the neighbourhood. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in Riverdale?',
    answer: "Riverdale's mosquito season runs from late April through September or early October. The Don Valley's sheltered microclimate retains warmth and moisture, enabling earlier spring emergence than in more exposed parts of Toronto. Peak activity is from late May through July, with a secondary surge following heavy summer rainfall that creates pooling in the Don River floodplain.",
  },
  {
    question: 'Does BuzzSkito serve all of Riverdale Toronto?',
    answer: "Yes. We serve all Riverdale streets including those along Broadview Avenue, the streets east of the Don Valley, and properties adjacent to Riverdale Park. We also serve all surrounding Toronto neighbourhoods including Cabbagetown, Leslieville, and the Danforth. Call (289) 216-5030 to confirm service at your specific Riverdale address.",
  },
]

export default function RiverdaleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/riverdale-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Riverdale's position directly on the Don Valley — Toronto's central mosquito corridor — creates some of the city's most intense seasonal pressure. BuzzSkito's barrier spray gives Riverdale families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Riverdale's Don Valley Mosquito Problem</h2>
          <p>Riverdale sits directly above the <strong>Don Valley</strong> — Toronto's central and most active mosquito corridor. The Don River's permanent flow, its extensive floodplain, and the dense ravine vegetation create continuous mosquito breeding habitat from the Forks of the Don south to the harbour. <strong>Riverdale Park</strong>, with its sloped terrain draining toward the valley, adds further moisture zones that support mosquito activity.</p>
          <p>The <strong>Cabbagetown ravine</strong> to the northwest provides a secondary corridor connecting Riverdale to the broader Don Valley system. BuzzSkito's barrier spray creates a treated perimeter around your Riverdale property — targeting all resting vegetation where valley-bred mosquitoes settle — typically reducing active mosquito presence by 80–95% within 24 hours of treatment.</p>

          <h2>Part of Our Toronto Mosquito Control Network</h2>
          <p>We serve all of Riverdale and surrounding areas. See our <Link href="/toronto-mosquito-control" className="text-brand-700 hover:underline">Toronto mosquito control</Link> page for city-wide coverage, or our page for <Link href="/leslieville-mosquito-control" className="text-brand-700 hover:underline">Leslieville</Link>.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/riverdale-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Riverdale properties from Don Valley mosquitoes. No contracts." />
    </>
  )
}
