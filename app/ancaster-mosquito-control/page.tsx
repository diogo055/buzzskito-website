...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Professional mosquito control in Ancaster, Hamilton. Barrier spray near Dundas Valley from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Many Ancaster properties are well-served by Basic; properties directly adjacent to the Dundas Valley or escarpment edge may benefit from Standard's two-week spacing due to continuous re-pressure from nearby conservation land. Call (289) 216-5030 for a free assessment.",
  },
  {
  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Ancaster's escarpment setting, proximity to Dundas Valley Conservation Area, and Tiffany Falls create one of Hamilton's most intense mosquito environments. Licensed Ontario pesticide operator, with treatments applied according to label directions.</>}
