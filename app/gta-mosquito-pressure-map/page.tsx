...
const PRESSURE: CityPressure[] = [
  ...
  { city: 'Caledon',          slug: '/caledon-mosquito-control',         tier: 'severe',   score: 88, primaryDriver: 'Oak Ridges Moraine + Forks of the Credit', topNeighbourhoods: ['Caledon East', 'Bolton', 'Inglewood', 'Belfountain'], peakWeeks: 'Jun 5 – Aug 14', ticksRelevant: true, notes: 'The Oak Ridges Moraine is mature mixed forest with deer and deep leaf litter — the habitat blacklegged ticks need. Check the PHO Vector-Borne Disease Tool for the current mapped risk area covering a specific address.' },
...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'Public Health Ontario does not designate "Lyme-endemic zones." It maps blacklegged tick risk areas as geographic areas built from field surveillance and publishes them through the Ontario Vector-Borne Disease Tool. Those areas are drawn from where established tick populations have been found, so they do not follow municipal or health-unit boundaries, and the map is redrawn each year. The naturalized corridors most often associated with tick habitat around the GTA are the Oak Ridges Moraine, the Rouge watershed, the Niagara Escarpment and the Hamilton-area conservation lands — which is why the tick scores on this map are higher for cities that contain or border them. That weighting is our own editorial judgement, not a PHO classification; check the Vector-Borne Disease Tool for your own address.',
  },
  {
    ...
    <>
      ...
      <section className="bg-white py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-brand-900 to-brand-950 text-white p-7 sm:p-9 text-center shadow-xl">
            ...
            <p className="text-[11px] text-brand-300 mt-3">🔒 No credit card · Used by 150+ five-star GTA homeowners</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-12 px-4">
        <div className="max-w-3xl mx-auto prose-brand">
          ...
          <p className="text-gray-700 mb-4">PHO runs an annual blacklegged tick (<em>Ixodes scapularis</em>) surveillance program and publishes the results as a <strong>risk-area map</strong> in the <a href="https://www.publichealthontario.ca/en/data-and-analysis/infectious-disease/vbd-tool" target="_blank" rel="noopener noreferrer" className="text-brand-700 underline font-semibold">Ontario Vector-Borne Disease Tool</a> — geographic areas drawn from where populations have actually been found, redrawn each year, and deliberately not aligned to municipal or health-unit boundaries. It does not publish a list of &ldquo;Lyme-endemic zones,&rdquo; and an earlier version of this page wrongly said it did. The corridors most often associated with tick habitat here — the Oak Ridges Moraine, the Rouge watershed, the Niagara Escarpment and the Hamilton-area conservation lands — are why cities containing or bordering them carry elevated tick scores on this map. That weighting is ours, not PHO&rsquo;s.</p>
