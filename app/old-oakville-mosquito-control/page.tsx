...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Old Oakville | From $99',
  description:
    'Mosquito control in Old Oakville. Barrier spray near the lakeshore from $99. Licensed Ontario operator. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Creek-adjacent or waterfront Old Oakville properties typically benefit from Standard's two-week spacing; interior Old Oakville properties may be well-served by Basic. The neighbourhood's mature tree canopy can extend effective mosquito activity later into the season, which is worth factoring into your choice of plan. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: "How is BuzzSkito's treatment applied around Old Oakville's established heritage gardens?",
    answer: "Our licensed technician applies a water-based barrier product according to its label directions, around mature specimen trees, heritage garden features, and ornamental plantings. We apply it to resting surfaces — leaf undersides and shrub foliage — not to open blooms, bare soil, or tree bark. Keep children and pets off treated areas until the spray has dried, as the product label directs.",
  },
  {
...
export default function OldOakvilleMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/old-oakville-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        title={<>Mosquito Control in {NEIGHBOURHOOD}</>}
        subtitle={<>Old Oakville's Sixteen Mile Creek, Lake Ontario waterfront, and exceptional mature canopy create significant seasonal mosquito pressure. Licensed Ontario pesticide operator. Treatments applied according to label directions.</>}
      />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>We also offer professional tick control in this area. Our tick barrier spray treats the lawn edges, leaf litter, and fence lines where ticks wait, with 5 sprays per season. See our <Link href="/oakville-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
