  ...
  return (
    <>
      ...
      <CityHero
        ...
        subtitle={<>Old Oakville's Sixteen Mile Creek, Lake Ontario waterfront, and exceptional mature canopy create significant seasonal mosquito pressure. BuzzSkito's professional barrier spray protects Old Oakville families all season.</>}
      />
