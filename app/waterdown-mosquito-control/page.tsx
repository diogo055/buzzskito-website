...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Waterdown | From $99 · 5★ Rated',
  description:
    'Professional mosquito control in Waterdown, Hamilton. Barrier spray near Grindstone Falls from $99. Safe for kids & pets. Call (289) 216-5030.',
...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Most Waterdown properties benefit from 4–5 treatments spaced 21–28 days apart from May through September. Properties adjacent to Grindstone Falls, Smokey Hollow, or the escarpment ravines typically benefit from the full 5-treatment program due to constant re-pressure from permanent water sources. Call (289) 216-5030 for a free assessment.",
  },
  {
...
export default function WaterdownMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/waterdown-mosquito-control')) }} />
      ...
      <section className="bg-gradient-to-br from-brand-950 to-brand-800 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-brand-100 max-w-2xl mb-8">
            Waterdown's escarpment waterfalls, Grindstone Creek headwaters, and Smokey Hollow ravine create persistent mosquito pressure throughout the season. BuzzSkito's barrier spray gives Waterdown families 30-day protection per treatment.
          </p>
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p><strong>Smokey Hollow Falls</strong> and the surrounding Smokey Hollow conservation area add another permanent water source on Waterdown's east side. The mist, humidity, and dense canopy around both falls create ideal daytime resting habitat for adult mosquitoes, which then disperse into adjacent residential areas in the evening. BuzzSkito's barrier spray targets all resting vegetation on your Waterdown property, creating a treated buffer that provides up to 30 days of protection between treatments.</p>
          ...
          <p>We also offer professional tick control in this area. Protect your family from Lyme disease with our targeted tick barrier spray. See our <Link href="/waterdown-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
