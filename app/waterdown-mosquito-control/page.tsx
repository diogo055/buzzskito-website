...
export const metadata: Metadata = buildMetadata({
  title: 'Mosquito Control Waterdown | From $99',
  description:
    'Professional mosquito control in Waterdown, Hamilton. Barrier spray near Grindstone Falls from $99. Licensed Ontario operator. Call (289) 216-5030.',
  canonical: '/waterdown-mosquito-control',
})

const NEIGHBOURHOOD = 'Waterdown'
const CITY = 'Hamilton'
const SLUG = '/waterdown-mosquito-control'

const FAQS = [
  {
    question: 'Why does Waterdown have significant mosquito pressure?',
    answer: "Waterdown sits at the top of the Niagara Escarpment where multiple waterfalls and creek systems converge. Grindstone Falls, Smokey Hollow Falls, and the surrounding escarpment ravines create permanent moisture zones that sustain mosquito populations from May through September. The Grindstone Creek headwaters flow through the community, and the escarpment's forested slopes provide dense, shaded mosquito resting habitat throughout the neighbourhood.",
  },
  {
    question: 'How do Grindstone Falls and Smokey Hollow affect mosquito activity?',
    answer: "Grindstone Falls and Smokey Hollow Falls are both located within Waterdown's residential area, creating localized zones of permanent moisture, mist, and humidity that are ideal for mosquito breeding and resting. The ravine corridors surrounding these falls contain dense, mature forest with year-round shade — conditions that sustain mosquito populations well into fall. Properties near either falls area experience elevated mosquito activity compared to interior Waterdown streets.",
  },
  {
    question: 'How many treatments does a Waterdown home need per season?',
    answer: "Season plans run May through September: Basic (5 sprays, monthly), Standard (10 sprays, every 2 weeks) or Exclusive (20+ sprays, weekly). Properties adjacent to Grindstone Falls, Smokey Hollow, or the escarpment ravines typically benefit from Standard's two-week spacing due to constant re-pressure from permanent water sources; other Waterdown lots may be well-served by Basic. Call (289) 216-5030 for a free assessment.",
  },
  {
    question: 'When does mosquito season start in Waterdown?',
    answer: "Waterdown's mosquito season typically runs from early May through September. The escarpment's groundwater-fed streams and falls create conditions for earlier spring emergence compared to non-escarpment communities. Peak activity is from late May through July, with the falls and creek areas sustaining pressure throughout the entire season.",
  },
  {
    question: 'Does BuzzSkito serve all of Waterdown?',
    answer: "Yes. We serve all Waterdown streets including those near Grindstone Falls, Smokey Hollow, and the escarpment ravine corridors. We also serve adjacent communities in both Hamilton and Burlington. Call (289) 216-5030 to confirm service at your specific Waterdown address.",
  },
]

export default function WaterdownMosquitoPage() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/waterdown-mosquito-control', '2026-07-01')) }} />
      ...
      <CityHero
        ...
        subtitle={<>Licensed Ontario pesticide operator treating Waterdown yards near Grindstone Falls, the Grindstone Creek headwaters and Smokey Hollow, where mosquito pressure lasts all season. Treatments applied according to label directions.</>}
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Waterdown's Waterfall and Escarpment Mosquito Challenge</h2>
          <p>Waterdown is one of the Hamilton area's fastest-growing communities — and one of its most mosquito-affected, thanks to its dramatic escarpment geography. <strong>Grindstone Falls</strong> drops through the heart of the community, creating a permanent moisture zone with surrounding ravine forest that sustains mosquito populations all season. The <strong>Grindstone Creek</strong> headwaters flow through Waterdown, with seasonal flooding and backwater areas adding breeding habitat after rain events.</p>
          <p><strong>Smokey Hollow Falls</strong> and the surrounding Smokey Hollow conservation area add another permanent water source on Waterdown's east side. The mist, humidity, and dense canopy around both falls create ideal daytime resting habitat for adult mosquitoes, which then disperse into adjacent residential areas in the evening. BuzzSkito's barrier spray targets all resting vegetation on your Waterdown property, creating a treated buffer that is renewed at each scheduled visit through the season.</p>
          ...
          <p>We also offer professional tick control in this area. Our tick barrier spray treats the lawn edges, leaf litter, and fence lines where ticks wait, with 5 sprays per season. See our <Link href="/hamilton-tick-spray" className="text-brand-700 hover:underline">tick spray service</Link> or <Link href="/tick-control" className="text-brand-700 hover:underline">learn about tick control</Link>.</p>
      ...
      <CTASection heading={`Get a Free Mosquito Control Quote in ${NEIGHBOURHOOD}`} subtext="Protecting Waterdown properties from waterfall and escarpment mosquitoes. No contracts." />
    </>
  )
}
