...
const NEIGHBOURHOODS: { name: string; href?: string }[] = [
  ...
  { name: 'Limehouse' },
  { name: 'Silver Creek' },
  { name: 'Halton Hills', href: '/halton-hills-mosquito-control' },
]
const FAQS = [
  {
...
export default function GeorgetownMosquitoPage() {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(howToSchema({ service: 'mosquito', city: 'Georgetown' })) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(speakableSchema('/georgetown-mosquito-control', '2026-07-01')) }} />
      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Looking at all your Georgetown pest control options? See our specialist guide: <Link href="/pest-control-georgetown" className="text-brand-700 hover:underline font-semibold">Pest Control in Georgetown</Link> — explains why a mosquito and tick specialist beats a generalist for the two pests that actually drive Georgetown backyard misery.</p>
