...
const NEIGHBOURHOOD_FEATURES: Record<string, { feature: string; reason: string }> = {
  ...
  'tyandaga': { feature: 'the Niagara Escarpment forests', reason: 'forested habitat sustains tick and mosquito populations' },
  ...
  // Hamilton
  'stoney creek': { feature: 'the Niagara Escarpment and creek systems', reason: 'escarpment forests and water sources drive heavy mosquito and tick pressure' },
  ...
  'ancaster': { feature: 'the Niagara Escarpment forest', reason: 'escarpment habitat drives strong mosquito and tick populations' },
...
const CITY_FEATURES: Record<string, { feature: string; reason: string }> = {
  ...
  'burlington': { feature: 'Cootes Paradise wetlands and the Niagara Escarpment', reason: 'protected wetlands and forest habitat drive heavy mosquito pressure' },
  'hamilton': { feature: 'the Niagara Escarpment and conservation areas', reason: 'escarpment forests and water sources drive mosquito and tick pressure' },
  ...
  'milton': { feature: 'the Niagara Escarpment and conservation greenbelts', reason: 'escarpment habitat sustains heavy mosquito and tick pressure' },
  'georgetown': { feature: 'the Credit River edge and Hungry Hollow', reason: 'river and ravine habitat drive mosquito populations' },
  'halton hills': { feature: 'the Niagara Escarpment and Bruce Trail corridor', reason: 'escarpment and trail habitat sustain heavy tick and mosquito pressure' },
