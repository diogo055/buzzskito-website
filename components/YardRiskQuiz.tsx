      ...
      {step === 0 && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3 text-center text-xs">
            <div className="rounded-xl bg-brand-50 border border-brand-100 p-3"><div className="font-extrabold text-brand-900">150+</div><div className="text-gray-600">5-star reviews</div></div>
