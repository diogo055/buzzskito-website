...
export default function ReviewQuotes({
  ...
  return (
    <section className="py-16 sm:py-20 px-4 bg-brand-50" aria-label="Customer reviews">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-center">

          {/* Left — the 5.0 lockup */}
          <div className="lg:col-span-2 text-center lg:text-left">
            <p className="kicker mb-3">Google Reviews</p>
            <div className="flex items-end justify-center lg:justify-start gap-4">
              <span className="font-display text-7xl sm:text-8xl font-extrabold tracking-tight text-brand-950 leading-none">5.0</span>
              <div className="pb-2">
                <div className="star-shimmer text-amber-500 text-2xl leading-none" aria-label="Five out of five stars">★★★★★</div>
                <div className="mt-1.5 flex items-center gap-1.5 text-sm text-gray-600 font-medium">
                  {/* Google G */}
            ...
            <p className="mt-5 font-display text-2xl font-extrabold tracking-tight text-brand-900 leading-snug">
              Every single review: five stars.<br className="hidden sm:block" /> Zero exceptions.
            </p>
            <p className="mt-3 text-sm text-gray-600 leading-relaxed max-w-sm mx-auto lg:mx-0">
            ...
            <a
              ...
              className="arrow-nudge mt-5 inline-flex items-center gap-2 text-brand-700 font-bold hover:text-brand-900 text-sm"
            >
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3 gap-4">
              {REVIEWS.map((r, i) => (
                <Reveal key={r.name} className={`rd-${i + 1} hover-lift bg-white rounded-2xl border border-brand-100 p-5 shadow-sm flex flex-col`}>
                  <div className="flex items-center justify-between mb-3">
                    <div className="text-amber-500 text-sm" aria-label="Five stars">★★★★★</div>
                    <span className="inline-flex items-center gap-1 rounded-full bg-gray-50 border border-gray-200 px-2 py-0.5 text-[10px] font-semibold text-gray-500">
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-100 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-brand-900 leading-tight">{r.name}</p>
                      <p className="text-xs text-brand-600">{r.city}, ON</p>
                    </div>
                  </div>
                </Reveal>
              ))}
